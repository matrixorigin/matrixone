...
- an additive, MORPC v55-gated remote pipeline representation.
...
v55 peers; v54 and older peers reject it.
...
worker gate coverage, v54/v55 predecessor/current protocol coverage,
