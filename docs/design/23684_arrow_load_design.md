...
to this execution fact before it opens I/O. MORPC v56 remains the receiver
compatibility gate. v56 is `up/main` v55 plus one on the delivery
...
is retained with the MORPC v56 gate.
