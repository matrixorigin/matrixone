...
to this execution fact before it opens I/O. MORPC v49 remains the receiver
compatibility gate.  v49 is `up/main` v48 plus one on the delivery
...
is retained with the MORPC v49 gate.
