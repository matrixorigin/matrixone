...
| --- | --- | --- | --- |
| MatrixOne | [#27599](https://github.com/matrixorigin/matrixone/pull/27599) | `d2f3660187cd013a9d480e3bb7eb309edecef1b1` | exact code-bearing head includes current main; affected Substrait, Flight, vector, output, compile, and frontend tests passed after the merge; full exact-head SCA, UT, BVT, and coverage are delegated to MatrixOne CI; [SF10 five-mode record](https://github.com/matrixorigin/matrixone/pull/27599#issuecomment-5495966844) |
| Sirius | [#10](https://github.com/matrixorigin/sirius/pull/10) | `693629201c84b18ce4d58f77fd4672f917120f0a` | retains input, pending intermediate, processing handles, and reservation attachment through failed quiescence; quarantine bookkeeping terminates rather than unwinding owners if it cannot reserve storage; the deterministic launch-then-throw/fail-synchronize oracle passed 12 assertions, all GPU task cases passed 83 assertions, executor/OOM passed 21 assertions, concurrency gates passed 8 assertions, repository-wide pre-commit passed, full stable/current-26.10-nightly extension builds passed, filtered mark/semi/anti join regressions passed, and nested nightly activation preserves the CI CUDA architecture |
| sidecar | [#19](https://github.com/matrixorigin/mo-sirius-sidecar/pull/19) | `7d6121be59c7740da04da611a6b5d2b8760b1249` | pins the Sirius revision above on top of merged #18; protocol/admission contract suite passed 76 assertions and the linked extension built successfully |
