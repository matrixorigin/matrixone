...
MatrixOne supports most of the major Operation Systems: Windows, Linux, Mac, Unix and Unix-like systems. You can install MatrixOne either by [building from source](#building-from-source) or [using docker](#using-docker).
