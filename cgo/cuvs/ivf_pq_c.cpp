...
struct gpu_ivf_pq_any_t {
    ...
    ~gpu_ivf_pq_any_t() {
        switch (qtype) {
            case Quantization_F32: delete static_cast<gpu_ivf_pq_t<float>*>(ptr); break;
            case Quantization_F16: delete static_cast<gpu_ivf_pq_t<half>*>(ptr); break;
            case Quantization_INT8: delete static_cast<gpu_ivf_pq_t<int8_t>*>(ptr); break;
            case Quantization_UINT8: delete static_cast<gpu_ivf_pq_t<uint8_t>*>(ptr); break;
            default: break;
        }
    }
};
