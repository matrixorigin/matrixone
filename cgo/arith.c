...
{
	if (szof == 1) {
		MO_INT_ARITH_T(ADD_SIGNED_OVFLAG, int8_t);
	} else if (szof == 2) {
		MO_INT_ARITH_T(ADD_SIGNED_OVFLAG, int16_t);
	} else if (szof == 4) {
		MO_INT_ARITH_T(ADD_SIGNED_OVFLAG, int32_t);
	} else if (szof == 8) {
		MO_INT_ARITH_T(ADD_SIGNED_OVFLAG, int64_t);
	} else {
...
{
	if (szof == 1) {
		MO_INT_ARITH_T(ADD_UNSIGNED_OVFLAG, uint8_t);
	} else if (szof == 2) {
		MO_INT_ARITH_T(ADD_UNSIGNED_OVFLAG, uint16_t);
	} else if (szof == 4) {
		MO_INT_ARITH_T(ADD_UNSIGNED_OVFLAG, uint32_t);
	} else if (szof == 8) {
		MO_INT_ARITH_T(ADD_UNSIGNED_OVFLAG, uint64_t);
	} else {
		return RC_INVALID_ARGUMENT;
	}
	return RC_SUCCESS;
...
{
	if (szof == 4) {
		MO_INT_ARITH_T(ADD_FLOAT_OVFLAG, float);
	} else if (szof == 8) {
		MO_INT_ARITH_T(ADD_FLOAT_OVFLAG, double);
	} else {
		return RC_INVALID_ARGUMENT;
	}
	return RC_SUCCESS;
