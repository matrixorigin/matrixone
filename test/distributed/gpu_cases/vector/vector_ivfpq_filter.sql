-- =====================================================================
-- vector_ivfpq_filter.sql — IVFPQ pre-filtered search via INCLUDE columns
--
...
drop database if exists ivfpq_filter;
create database ivfpq_filter;
use ivfpq_filter;
...
select algo, algo_table_type, algo_params from mo_catalog.mo_indexes
    where table_id = (select rel_id from mo_catalog.mo_tables
                      where relname='t' and reldatabase='ivfpq_filter')
