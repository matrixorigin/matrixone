-- =====================================================================
-- vector_cagra_postfilter.sql — CAGRA search filtering on a NON-INCLUDE column
--
...
drop database if exists cagra_postfilter;
create database cagra_postfilter;
use cagra_postfilter;
...
create index ix using cagra on t (v) op_type 'vector_l2_ops' intermediate_graph_degree=16 graph_degree=8 itopk_size=64 INCLUDE (c_inc);
...
drop database cagra_postfilter;
