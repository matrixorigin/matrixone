-- =====================================================================
-- vector_cagra_filter_quant.sql — CAGRA INCLUDE-column pre-filter combined
-- with quantization and a vecf16 base column.
--
-- GPU REQUIRED. vector_cagra_filter.sql already covers the INCLUDE pre-filter
...
--
-- Data/predicates are identical to vector_cagra_filter.sql so the expected
...
-- =====================================================================
drop database if exists cagra_fq_f16;
create database cagra_fq_f16;
use cagra_fq_f16;
...
create index ix using cagra on t (v) op_type 'vector_l2_ops' intermediate_graph_degree=16 graph_degree=8 itopk_size=32 QUANTIZATION 'float16' INCLUDE (c_i32, c_i64, c_f32, c_f64);
...
drop database cagra_fq_f16;

-- =====================================================================
-- f32 base + QUANTIZATION 'int8' + INCLUDE pre-filter
-- =====================================================================
drop database if exists cagra_fq_int8;
create database cagra_fq_int8;
use cagra_fq_int8;
...
create index ix using cagra on t (v) op_type 'vector_l2_ops' intermediate_graph_degree=16 graph_degree=8 itopk_size=32 QUANTIZATION 'int8' INCLUDE (c_i32, c_i64, c_f32, c_f64);
...
drop database cagra_fq_int8;

-- =====================================================================
-- f32 base + QUANTIZATION 'uint8' + INCLUDE pre-filter
-- =====================================================================
drop database if exists cagra_fq_uint8;
create database cagra_fq_uint8;
use cagra_fq_uint8;
...
create index ix using cagra on t (v) op_type 'vector_l2_ops' intermediate_graph_degree=16 graph_degree=8 itopk_size=32 QUANTIZATION 'uint8' INCLUDE (c_i32, c_i64, c_f32, c_f64);
...
-- =====================================================================
drop database if exists cagra_fq_f16base;
create database cagra_fq_f16base;
use cagra_fq_f16base;
...
drop database cagra_fq_f16base;
...
-- =====================================================================
drop database if exists cagra_fq_f16int8;
create database cagra_fq_f16int8;
use cagra_fq_f16int8;
...
drop database cagra_fq_f16int8;

-- =====================================================================
-- vecf16 base + QUANTIZATION 'uint8' + INCLUDE pre-filter (same path as int8)
-- =====================================================================
drop database if exists cagra_fq_f16uint8;
create database cagra_fq_f16uint8;
use cagra_fq_f16uint8;
...
drop database cagra_fq_f16uint8;
