-- =====================================================================
-- vector_ivfpq_sharded_delete.sql — SHARDED soft-delete across shards
--
...
-- ids 1..64, shard 1 = ids 65..128. We delete the EXTREMES id 1 (shard 0) and
-- id 128 (shard 1) so each survivor's nearest is unique (2 and 127 — no
-- equidistant tie). Both shards' delete bitsets must apply.
-- =====================================================================
...
drop database if exists ivfpq_sharded_delete;
create database ivfpq_sharded_delete;
use ivfpq_sharded_delete;
...
drop database ivfpq_sharded_delete;
