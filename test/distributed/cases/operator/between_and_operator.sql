...
SELECT FALSE NOT BETWEEN TRUE AND FALSE;
SELECT NULL BETWEEN FALSE AND TRUE;
SELECT NULL NOT BETWEEN FALSE AND TRUE;
...
CREATE TABLE bool_test(flag_primary BOOL PRIMARY KEY, flag_normal BOOL);

INSERT INTO bool_test VALUES(TRUE, TRUE), (FALSE, FALSE);

SELECT * FROM bool_test WHERE flag_primary BETWEEN FALSE AND TRUE;
SELECT * FROM bool_test WHERE flag_normal BETWEEN FALSE AND TRUE;
SELECT * FROM bool_test WHERE flag_primary NOT BETWEEN FALSE AND TRUE;
SELECT * FROM bool_test WHERE flag_normal NOT BETWEEN FALSE AND TRUE;
