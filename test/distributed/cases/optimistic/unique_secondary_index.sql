...
load data infile  '$resources/load_data/unique_index_file.csv' into table t_code_rule  fields terminated by ',';
select code_id,code_type,code_no,code_rule_no,org_no from t_code_rule;
truncate table t_code_rule;
-- @bvt:issue#3433
load data infile  '$resources/load_data/unique_index_duplicate.csv' into table t_code_rule fields terminated by ',';
select code_id,code_type,code_no,code_rule_no,org_no from t_code_rule;
...
load data infile  '$resources/load_data/unique_index_file.csv' into table index_temp fields terminated by ',';
insert into t_code_rule select * from index_temp;
select code_id,code_type,code_no,code_rule_no,org_no from t_code_rule;
truncate table index_temp;
load data infile  '$resources/load_data/unique_index_duplicate.csv' into table index_temp fields terminated by ',';
-- @pattern
insert into t_code_rule select * from index_temp;
-- @bvt:issue
