-- Verify branch metadata changes for create/delete table and delete database.

-- Case 1: data branch create/delete table.
...
-- Case 2: data branch create/delete database.
