-- Deprecated: experimental_ivf_index is always enabled, kept for compatibility
...
desc vector_ip_01;
select * from vector_ip_01 order by  inner_product(b,  normalize_l2("[1, 0, 1, 6, 6, 17, 47, 39, 2, 0, 1, 25, 27, 10, 56, 130, 18, 5, 2, 6, 15, 2, 19, 130, 42, 28, 1, 1, 2, 1, 0, 5, 0, 2, 4, 4, 31, 34, 44, 35, 9, 3, 8, 11, 33, 12, 61, 130, 130, 17, 0, 1, 6, 2, 9, 130, 111, 36, 0, 0, 11, 9, 1, 12, 2, 100, 130, 28, 7, 2, 6, 7, 9, 27, 130, 83, 5, 0, 1, 18, 130, 130, 84, 9, 0, 0, 2, 24, 111, 24, 0, 1, 37, 24, 2, 10, 12, 62, 33, 3, 0, 0, 0, 1, 3, 16, 106, 28, 0, 0, 0, 0, 17, 46, 85, 10, 0, 0, 1, 4, 11, 4, 2, 2, 9, 14, 8, 8]")) ASC LIMIT 2;

select * from vector_ip_01 order by  inner_product(b, normalize_l2('[41, 0, 0, 7, 1, 1, 20, 67, 9, 0, 0, 0, 0, 31, 120, 61, 25, 0, 0, 0, 0, 10, 120, 90, 32, 0, 0, 1, 13, 11, 22, 50, 4, 0, 2, 93, 40, 15, 37, 18, 12, 2, 2, 19, 8, 44, 120, 25, 120, 5, 0, 0, 0, 2, 48, 97, 102, 14, 3, 3, 11, 9, 34, 41, 0, 0, 4, 120, 56, 3, 4, 5, 6, 15, 37, 116, 28, 0, 0, 3, 120, 120, 24, 6, 2, 0, 1, 28, 53, 90, 51, 11, 11, 2, 12, 14, 8, 6, 4, 30, 9, 1, 4, 22, 25, 79, 120, 66, 5, 0, 0, 6, 42, 120, 91, 43, 15, 2, 4, 39, 12, 9, 9, 12, 15, 5, 24, 36]')) ASC LIMIT 2;


drop table vector_ip_01;
...
-- Test for issue #22612: IVFFlat with WHERE filter correctness
-- https://github.com/matrixorigin/matrixone/issues/22612
...
INSERT INTO test_distance_issue (id, name, score, embedding) VALUES
...
(2, 'Vector B', 4.5, '[0.30424225330352783,0.5247564315795898,0.4319450259208679,0.29122912883758545,0.6118528842926025,0.13949386775493622,0.29214465618133545,0.3663618564605713,0.4560699760913849,0.7851759791374207,0.19967378675937653,0.5142344236373901,0.5924145579338074,0.0464504137635231,0.6075448393821716,0.17052412033081055]'),
(3, 'Vector C', 4.0, '[0.0650515928864479,0.9488855600357056,0.9656320214271545,0.8083973526954651,0.30461376905441284,0.09767211228609085,0.6842330098152161,0.44015249609947205,0.12203823775053024,0.49517691135406494,0.03438851982355118,0.9093204140663147,0.25877997279167175,0.6625222563743591,0.31171107292175293,0.5200680494308472]'),
(4, 'Vector D', 3.5, '[0.5467102527618408,0.18485446274280548,0.9695846438407898,0.7751328349113464,0.9394989609718323,0.8948273658752441,0.5978999733924866,0.9218742251396179,0.0884925052523613,0.19598285853862762,0.0452272891998291,0.32533031702041626,0.38867729902267456,0.2713490426540375,0.8287374973297119,0.35675331950187683]'),
(5, 'Vector E', 3.0, '[0.28093451261520386,0.5426960587501526,0.14092423021793365,0.8021969795227051,0.07455064356327057,0.9868869185447693,0.7722447514533997,0.1987156867980957,0.005522117018699646,0.8154614567756653,0.7068573236465454,0.7290071845054626,0.7712703347206116,0.07404465228319168,0.3584657311439514,0.11586906015872955]');

CREATE INDEX idx_embedding USING ivfflat ON test_distance_issue(embedding) LISTS 2 op_type 'vector_l2_ops';

-- Test 1: Query with WHERE filter (score >= 4.0)
-- Should only return rows with score >= 4.0 (ids: 1, 2, 3)
