...
-- async index update so result found
...
select sleep(20);
select * from vector_index_08 order by  L2_DISTANCE(d,"[2.36,5.021,9.222]") limit 1;
...
select * from vector_index_08 order by  L2_DISTANCE(e,"[2.36,5.021,9.222]") limit 1;
--explain select * from vector_index_08 where a>1 order by  L2_DISTANCE(c,"[1.02,0.2,3.2]") desc;
