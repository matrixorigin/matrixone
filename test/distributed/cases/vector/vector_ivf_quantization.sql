...
select a from tbf16 order by l2_distance(v,'[1,1,1,1]'), a limit 3;
...
select a from tf16 order by l2_distance(v,'[1,1,1,1]'), a limit 3;
...
select a from ti8 order by l2_distance(v,'[1,1,1,1]'), a limit 3;
