...
select a from qc order by l2_distance(v,'[1,1,1,1]'), a limit 3;
select a from qc order by l2_distance(v,'[54,54,54,54]'), a limit 3;
...
select a from ivfqddl2.q order by l2_distance(v,'[1,1,1,1]'), a limit 3;
select a from ivfqddl2.q order by l2_distance(v,'[54,54,54,54]'), a limit 3;
