...
create table vector_index_02(a bigint primary key, b vecf32(128),c int,key c_k(c));
...
create table vector_index_03(a bigint primary key, b vecf32(3));
...
create table vector_index_04(a bigint primary key, b vecf32(3),c vecf32(4));
...
create table vector_index_05(a bigint primary key, b vecf32(3),c vecf32(4));
...
create table vector_index_06(a bigint primary key, b vecf32(3),c vecf32(4));
...
create table vector_index_08(a bigint auto_increment primary key, b vecf32(128),c int,key c_k(c));
...
create table vector_index_10(a bigint primary key, b vecf32(128),c int,key c_k(c));
set autocommit=0;
...
create table vector_ip_01(a bigint primary key, b vecf32(32), c int, key c_k(c));
...
create table vector_cos_01(a bigint primary key, b vecf32(128),c int,key c_k(c));
