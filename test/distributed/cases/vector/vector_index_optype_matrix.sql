...
--   vector_cosine_ops -> cosine_distance (HNSW currently falls back to the
--                        exact SQL path at the zero/subnormal boundary)
--
...
-- @separator:table
-- HNSW cosine deliberately stays on the exact SQL path for #29082.
-- @regex("hnsw_search", false)
