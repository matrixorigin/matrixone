...
-- test build bloomfilter on the fly
...
-- END test build bloomfilter on the fly

-- test preload entries bloomfilter
...
-- END test preload entries bloomfilter
