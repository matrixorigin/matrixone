...
create table join_dup_l(x int);
create table join_pk_r(id int primary key);
insert into join_dup_l values (1),(1),(2);
insert into join_pk_r values (1),(2);
select count(*)
from join_dup_l l
join join_pk_r r force index for join(primary)
  on l.x = r.id;
