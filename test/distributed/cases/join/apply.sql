...
select add_fault_point('fj/cn/generate_series_partial_prepare', ':::', 'echo', 0, 'apply teardown repro');
prepare s_apply_fault from select * from t_apply_prepare_fault cross apply generate_series(t_apply_prepare_fault.a, t_apply_prepare_fault.b) g;
execute s_apply_fault;
deallocate prepare s_apply_fault;
select disable_fault_injection();
drop table t_apply_prepare_fault;
