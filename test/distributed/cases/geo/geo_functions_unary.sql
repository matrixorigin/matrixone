...
select st_astext(st_centroid(st_geomfromtext('GEOMETRYCOLLECTION EMPTY'))) as centroid_empty_collection;
select st_astext(st_envelope(st_geomfromtext('LINESTRING(1 2,3 4,0 5)'))) as envelope;
select st_astext(st_envelope(st_geomfromtext('MULTIPOINT(0 0,1 1)'))) as envelope_mp;
select st_astext(st_envelope(st_geomfromtext('GEOMETRYCOLLECTION EMPTY'))) as envelope_empty_collection;
