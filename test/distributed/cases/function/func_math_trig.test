...
select sin(a), cos(a), tan(a),cot(a),atan(a) from t1;
select sin(b), cos(b), tan(b),cot(b),atan(b) from t1;
select sin(c), cos(c), tan(c),cot(c),atan(c) from t1;
select sin(d), cos(d), tan(d),cot(d),atan(d) from t1;
select sin(e), cos(e), tan(e),cot(e),atan(e) from t1;
select sin(f), cos(f), tan(f),cot(f),atan(f) from t1;
select sin(g), cos(g), tan(g),cot(g),atan(g) from t1;

select sin(h), cos(h), tan(h),cot(h),atan(h) from t1;
