...
drop table c1;
create table c1 (a int primary key, f_a int, f_b int, f_c int, f_d int, constraint ck foreign key(f_a,f_b) REFERENCES f1(a,b) on delete CASCADE on update CASCADE);
insert into c1 values (1,1,2,1,1);
...
create table fk_02(col1 decimal(38,3),col2 char(25),col3 int,col4 date,constraint ck foreign key(col1,col3,col4) REFERENCES fk_01(col1,col3,col4) on delete SET NULL on update SET NULL);
insert into fk_01 values(23.10,'a',20,'2022-10-01'),(23.10,'a',21,'2022-10-01'),(23.10,'a',20,'2022-10-02');
insert into fk_02 values(23.10,'a',20,'2022-10-01'),(23.10,'a',21,'2022-10-01'),(23.10,'a',20,'2022-10-02');
insert into fk_02 values(23.10,'a',20,'2022-10-01'),(0.1,'b',22,'2022-10-01'),(23.10,'c',30,'2022-10-02');
insert into fk_02 values(0.001,'b',20,'2022-10-01'),(4.5,'a',21,'2022-10-01'),(56,'a',20,'2022-10-02');
select * from fk_01;
select * from fk_02;
update fk_02 set col2='b' where col3=20;
select * from fk_02;
delete from fk_01 where col3=20;
select * from fk_01;
select * from fk_02;
...
create table c1(a int primary key, c_a int, c_b int, constraint c1_ck foreign key(c_a,c_b) REFERENCES f1(a,b) on delete CASCADE on update CASCADE);
insert into c1 values (1,2,1),(2,2,2),(3,2,3);
update f1 set a=111 where b=1;
select * from f1;
select * from c1;
delete from c1;
insert into c1 values (1,111,1),(2,2,2),(3,2,3);
...
create table fk_01(col1 decimal(38,3),col2 char(25),col3 int,col4 date,primary key(col1,col2), unique key uk_col3(col3), unique key uk_col1_col3(col1,col3));
...
create table fk_01(col1 decimal(38,3),col2 char(25),col3 int,col4 date, unique key(col1,col2), unique key uk_col1(col1));
