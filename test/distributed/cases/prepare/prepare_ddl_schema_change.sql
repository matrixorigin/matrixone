...
create table stale_view_base (a int);
create view stale_view_dependency as select * from stale_view_base;
select * from stale_view_dependency;
drop view stale_view_dependency;
prepare unrelated_after_view_stmt from 'drop table if exists unrelated_after_view';
...
create view prepared_snapshot_view as select * from prepared_snapshot_base;
create snapshot prepared_view_snapshot for account;
drop view prepared_snapshot_view;
prepare historical_view_stmt from
    'select * from prepared_snapshot_view {snapshot = ''prepared_view_snapshot''}';
execute historical_view_stmt;
deallocate prepare historical_view_stmt;
drop snapshot prepared_view_snapshot;
