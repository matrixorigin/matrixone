-- fulltext2 pushdown: verify correctness of fulltext2 search with additional filter
...
drop database if exists ft2_pushdown_test;
create database ft2_pushdown_test;
use ft2_pushdown_test;
...
create fulltext2 index ftidx_articles on articles (title, body);
...
drop database ft2_pushdown_test;
