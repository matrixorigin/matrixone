...
select id from t where match(txt) against('营养 早餐 视频') order by id;
select id from t where match(txt) against('营养 早餐 视频') limit 1;
select id from t where match(txt) against('营养 早餐 视频') limit 2;
select id from t where match(txt) against('营养 早餐 视频') limit 3;
select id from t where match(txt) against('营养 早餐 视频') limit 10;
select id from t where match(txt) against('营养') order by id;
select id from t where match(txt) against('不存在') limit 5;
