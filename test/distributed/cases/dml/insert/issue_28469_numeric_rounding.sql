...
CREATE TABLE ondup_float_dst(id INT PRIMARY KEY, x BIGINT, i BIGINT);
INSERT INTO ondup_float_dst VALUES
(1,1000000000000000000,0),(2,1000000000000000000,0);
UPDATE ondup_float_dst SET i=((x/1)*x*x+0E0)/1E54 WHERE id=1;
INSERT INTO ondup_float_dst VALUES (2,0,0) ON DUPLICATE KEY UPDATE
i=((x/1)*x*x+0E0)/1E54;
