...
drop user if exists iwgo_u;
drop role if exists iwgo_base,iwgo_mid,iwgo_holder,iwgo_target;
drop database if exists iwgo_db;
create user iwgo_u identified by '111';
create role iwgo_base,iwgo_mid,iwgo_holder,iwgo_target;
...
drop user iwgo_u;
drop role iwgo_base,iwgo_mid,iwgo_holder,iwgo_target;
