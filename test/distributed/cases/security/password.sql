...
SELECT user_name, password_last_changed FROM mo_catalog.mo_user WHERE user_name IN ('user1_group1', 'user2_group1');
...
-- Verify users' password change status
SELECT user_name, password_last_changed FROM mo_catalog.mo_user WHERE user_name IN ('user1_group2', 'user2_group2');
...
-- Verify users' password change status
SELECT user_name, password_last_changed FROM mo_catalog.mo_user WHERE user_name IN ('user1_group4', 'user2_group4');
