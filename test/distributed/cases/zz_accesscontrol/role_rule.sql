...
-- 17. Merging with a no-WHERE rule produces the broader rule
...
select count(*) from mo_catalog.mo_role_rule where rule_name in ('db1.t1','db2.t2','db1.t_rename_legacy','db1.t_dup','db1.t_rename_rule_dependency');
