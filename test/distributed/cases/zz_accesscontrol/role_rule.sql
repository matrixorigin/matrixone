...
-- 3. Rule update case: same rule_name overwrites existing rule
...
-- @session:id=1&user=sys:test_rule_user:test_rule_role&password=111111
select 1;
-- @session
