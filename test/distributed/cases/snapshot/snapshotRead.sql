...
create table snapshot01 (col1 int primary key , col2 decimal(38,0), col3 bigint, col4 double, col5 float);
...
create table acc02_test01 (col1 decimal(38,0), col2 char, col3 varchar(30), col4 float);
...
-- Verify the cluster table itself without coupling the assertion to the catalog table count.
select count(*) from mo_catalog.mo_tables{snapshot = sp06} where reldatabase = 'mo_catalog' and relname = 'cluster01' and relkind = 'cluster';
-- @ignore:0,6,7
...
create database test03;
use test03;
create table pub01 (col1 int primary key , col2 decimal(38,0), col3 bigint, col4 double, col5 float);
