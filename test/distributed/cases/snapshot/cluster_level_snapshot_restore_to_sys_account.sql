...
use mo_catalog;
create cluster table clu01(col1 int, col2 decimal(38,0));
...
use test;
create table clu01(col1 int, col2 decimal(38,0));
...
create table t2(cool1 int primary key , col2 decimal(38,0));
...
insert into t1 values(2,3);
insert into t1 values(3,4);
create table t2(col1 int primary key , col2 decimal(38,0));
insert into t2 select * from t1;
create table t3 like t2;
...
create table table01(col1 int auto_increment , col2 decimal(38,0), col3 char, col4 varchar(20), col5 text, col6 double);
...
use db02;
drop table if exists table01;
create table table01(col1 int primary key , col2 decimal(38,0) unique key, col3 char, col4 varchar(20), col5 text, col6 double);
insert into table01 values (1, 2, 'a', '23eiojf', 'r23v324r23rer', 3923.324);
insert into table01 values (2, 3, 'b', '32r32r', 'database', 1111111);
drop table if exists table02;
create table table02 (col1 int unique key, col2 varchar(20));
