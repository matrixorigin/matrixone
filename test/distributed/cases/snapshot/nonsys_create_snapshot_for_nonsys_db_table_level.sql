...
restore database acc01.sp_test{snapshot="spsp01"};
...
restore database acc01.sp_test01{snapshot="spsp02"};
select * from partition01;
drop table partition01;
restore table acc01.sp_test01.partition01{snapshot="spsp02"};
select * from partition01;
...
drop database sp_Test03;
restore database acc01.sp_Test03{snapshot="SP01"};
show databases;
use sp_Test03;
show tables;
drop database sp_Test03;
...
drop database db10;
restore table acc01.db10.table11{snapshot="spsp05"};
restore database acc01.db11{snapshot="spsp05"};
...
restore database acc01.db06{snapshot="spsp06"};
select * from pri01;
select * from aff01;
drop table aff01;
drop table pri01;

restore table acc01.db06.aff01{snapshot="spsp06"};
restore table acc01.db06.pri01{snapshot="spsp06"};
restore table acc01.db06.aff01{snapshot="spsp06"};
show tables;
select * from aff01;
select * from pri01;
...
drop database db07;
restore database acc01.db07{snapshot="spsp08"};
show databases;
select * from db07.fulltext01;
drop database db07;
restore table acc01.db07.fulltext01{snapshot="spsp08"};
select * from db07.fulltext01;
...
show create table pri01;
restore table acc01.db08.pri01{snapshot="spsp09"};
show create table pri01;
...
drop table test01;
restore table acc01.db10.test01{snapshot="spsp10"};
-- @ignore:1
