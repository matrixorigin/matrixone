...
drop snapshot if exists sys_sp_master;
-- @ignore:1
show snapshots;
create snapshot sys_sp_master for account sys;
-- @ignore:1
show snapshots;

-- restore 
restore account sys database Company from snapshot sys_sp_master;
select * from Departments;
select * from Employees;
select * from Positions;
select * from EmployeePositions;
...
restore account sys database Company table Employees from snapshot sys_sp_master;
restore account sys database Company table Positions from snapshot sys_sp_master;
restore account sys database Company table EmployeePositions from snapshot sys_sp_master;
restore account sys database Company table Salaries from snapshot sys_sp_master;
restore account sys database Company table Benefits from snapshot sys_sp_master;
restore account sys database Company table TimeOff from snapshot sys_sp_master;
restore account sys database Company table PerformanceReviews from snapshot sys_sp_master;
select * from Departments;
select * from Employees;
select * from Positions;
select * from EmployeePositions;
