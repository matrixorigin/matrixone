...
restore account acc01 database snapshot_read table test_snapshot_read from snapshot cluster_sp to account acc02;
restore account acc01 database snapshot_read table users from snapshot cluster_sp to account acc02;
restore account acc01 database snapshot_read table students from snapshot cluster_sp to account acc02;
restore account acc01 database test_snapshot_restore table test_restore from snapshot cluster_sp to account acc02;
restore account acc01 database test_snapshot_restore table test_restore_2 from snapshot cluster_sp to account acc02;
restore account acc01 database test_snapshot_restore table factories from snapshot cluster_sp to account acc02;
...
restore account acc01 database Company table Departments from snapshot cluster_sp to account acc02;
restore account acc01 database Company table Employees from snapshot cluster_sp to account acc02;
restore account acc01 database Company table Positions from snapshot cluster_sp to account acc02;
restore account acc01 database Company table EmployeePositions from snapshot cluster_sp to account acc02;
restore account acc01 database Company table Salaries from snapshot cluster_sp to account acc02;
restore account acc01 database Company table Benefits from snapshot cluster_sp to account acc02;
restore account acc01 database Company table TimeOff from snapshot cluster_sp to account acc02;
restore account acc01 database Company table PerformanceReviews from snapshot cluster_sp to account acc02;
restore account acc01 database Projects table Projects from snapshot cluster_sp to account acc02;
restore account acc01 database Projects table ProjectMembers from snapshot cluster_sp to account acc02;
restore account acc01 database Projects table ProjectManagers from snapshot cluster_sp to account acc02;
restore account acc01 database Payroll table Salaries from snapshot cluster_sp to account acc02;
restore account acc01 database Payroll table ProjectBonuses from snapshot cluster_sp to account acc02;
restore account acc01 database Payroll table DepartmentBudgets from snapshot cluster_sp to account acc02;
...
restore account acc01 database Company table Departments from snapshot account_sp  to account acc02;
restore account acc01 database Company table Employees from snapshot account_sp to account acc02;
restore account acc01 database Company table Positions from snapshot account_sp to account acc02;
restore account acc01 database Company table EmployeePositions from snapshot account_sp to account acc02;
restore account acc01 database Company table Salaries from snapshot account_sp to account acc02;
restore account acc01 database Company table Benefits from snapshot account_sp to account acc02;
restore account acc01 database Company table TimeOff from snapshot account_sp to account acc02;
restore account acc01 database Company table PerformanceReviews from snapshot account_sp to account acc02;
restore account acc01 database Projects table Projects from snapshot account_sp to account acc02;
restore account acc01 database Projects table ProjectMembers from snapshot account_sp to account acc02;
restore account acc01 database Projects table ProjectManagers from snapshot account_sp to account acc02;
restore account acc01 database Payroll table Salaries from snapshot account_sp to account acc02;
restore account acc01 database Payroll table ProjectBonuses from snapshot account_sp to account acc02;
restore account acc01 database Payroll table DepartmentBudgets from snapshot account_sp to account acc02;
...
restore account acc01 database School table Students from snapshot cluster_sp to account acc02;
restore account acc01 database School table Courses from snapshot cluster_sp to account acc02;
restore account acc01 database School table Enrollments from snapshot cluster_sp to account acc02;
restore account acc01 database School table StudentCourses from snapshot cluster_sp to account acc02;
restore account acc01 database School table HighGradeStudents from snapshot cluster_sp to account acc02;
restore account acc01 database School table CourseAverageGrades from snapshot cluster_sp to account acc02;
restore account acc01 database University table Departments from snapshot cluster_sp to account acc02;
restore account acc01 database University table Professors from snapshot cluster_sp to account acc02;
restore account acc01 database University table Students from snapshot cluster_sp to account acc02;
restore account acc01 database University table Courses from snapshot cluster_sp to account acc02;
restore account acc01 database University table Enrollments from snapshot cluster_sp to account acc02;
restore account acc01 database University table ProfessorCourses from snapshot cluster_sp to account acc02;
restore account acc01 database University table StudentCourses from snapshot cluster_sp to account acc02;
restore account acc01 database University table DepartmentAverageGrade from snapshot cluster_sp to account acc02;
restore account acc01 database University table TopStudents from snapshot cluster_sp to account acc02;
restore account acc01 database EducationSystem table ComprehensiveStudentCourseInfo from snapshot cluster_sp to account acc02;
restore account acc01 database EducationSystem table ComprehensiveEducatorInfo from snapshot cluster_sp to account acc02;
restore account acc01 database EducationSystem table StudentOverallPerformance from snapshot cluster_sp to account acc02;
