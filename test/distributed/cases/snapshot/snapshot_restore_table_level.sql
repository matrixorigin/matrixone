...
restore table sys.snapshot_read.test_snapshot_read{snapshot="snapshot_01"};
select count(*) from snapshot_read.test_snapshot_read;
restore table sys.snapshot_read.test_snapshot_read{snapshot="snapshot_02"};
select count(*) from snapshot_read.test_snapshot_read;
...
select count(*) from snapshot_read.test_snapshot_read;
select count(*) from snapshot_read.test_snapshot_read{snapshot = 'snapshot_02'};
restore table test_account.snapshot_read.test_snapshot_read{snapshot="snapshot_01"};
select count(*) from snapshot_read.test_snapshot_read;
restore table test_account.snapshot_read.test_snapshot_read{snapshot="snapshot_02"};
select count(*) from snapshot_read.test_snapshot_read;
drop database snapshot_read;
drop snapshot snapshot_01;
drop snapshot snapshot_02;
...
restore table test_account.snapshot_read.users{snapshot="sp_01"};
select id, username, email from snapshot_read.users where email = 'john@example.com';
select id, username, email from snapshot_read.users where email = 'alice.jones@gmail.com';
