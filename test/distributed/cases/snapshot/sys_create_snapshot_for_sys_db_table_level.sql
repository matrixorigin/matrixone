...
restore table sys.sp_test01.partition01{snapshot="spsp02"};
select * from partition01;
...
create snapshot spsp05 for database db10;
drop database db10;
restore table sys.db10.table11{snapshot="spsp05"};
...
restore table sys.db06.aff01{snapshot="spsp06"};
restore table sys.db06.pri01{snapshot="spsp06"};
restore table sys.db06.aff01{snapshot="spsp06"};
show tables;
select * from aff01;
select * from pri01;
...
drop database db07;
restore table sys.db07.fulltext01{snapshot="spsp08"};
select * from db07.fulltext01;
...
show create table pri01;
restore table sys.db08.pri01{snapshot="spsp09"};
show create table pri01;
...
drop table test01;
restore table sys.db10.test01{snapshot="spsp10"};
-- @ignore:1
