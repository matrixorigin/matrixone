...
create view v3 as select * from test_restore_2;
select count(*) from test_snapshot_restore.test_restore_2;
select count(*) from test_snapshot_restore.v3;
...
INSERT INTO factories (factory_name, address) VALUES ('Factory KKKK', '1271 Maple St, Springfield, IL 62763'), ('Factory L', '1291 Walnut St, Springfield, IL 62764');
...
Create view v4 as select * from test_snapshot_restore.factories;
select count(*) from test_snapshot_restore.factories;
select count(*) from test_snapshot_restore.v4;
