...
create table rs03 (col1 int, col2 float, col3 decimal(38,0), col4 enum('1','2','3','4'));
...
-- sys create snapshot for cluster and acc01 create publication, acc02 subscribes this publication, restore acc02
-- @session:id=1&user=acc01:test_account&password=111
drop database if exists db09;
create database db09;
use db09;
...
restore account acc02{snapshot="sp05"};
...
use test02;
create table t1(col1 int, col2 decimal(38,0) key);
