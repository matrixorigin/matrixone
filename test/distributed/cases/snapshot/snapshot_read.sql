create database if not exists snapshot_read_2024;
use snapshot_read_2024;
...
select count(*) from mo_catalog.mo_tables where reldatabase = 'snapshot_read_2024';
select sleep(1);
create snapshot snapshot_03 for account sys;
drop table if exists test_snapshot_read2;
select count(*) from mo_catalog.mo_tables where reldatabase = 'snapshot_read_2024';
select count(*) from mo_catalog.mo_tables{snapshot = 'snapshot_03'} where reldatabase = 'snapshot_read_2024';
drop table if exists test_snapshot_read;
drop database if exists snapshot_read_2024;
