...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_1.csv'} fields terminated by '|' enclosed by '\"' lines terminated by '\n';
select * from ex_table_4;
create external table ex_table_5(clo1 tinyint,clo2 smallint,clo3 int,clo4 bigint,clo5 tinyint unsigned,clo6 smallint unsigned,clo7 int unsigned,clo8 bigint unsigned,col9 float,col10 double,col11 varchar(255),col12 Date,col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_2.csv'} fields terminated by '||' enclosed by '\"' lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_3.csv'} fields terminated by '*' enclosed by '\"' lines terminated by '\n';
select * from ex_table_6;
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_11.csv'} fields terminated by '\t' enclosed by '\"' lines terminated by '\n';
select * from ex_table_6a;
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_4.csv'} fields terminated by '#' enclosed by '\"' lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_5.csv'} fields terminated by '\n' enclosed by '\"' lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_6.csv'} fields terminated by '\r' enclosed by '\"' lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_7.csv'} fields terminated by ''  lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_8.csv'} fields terminated by ','  lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_9.csv'} fields terminated by ','  enclosed by '/"' ;
select * from ex_table_12;
--换行符为\r
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_10.csv'} fields terminated by ',' enclosed by '/"' lines terminated by '\r';
select * from ex_table_13;
--缺省fields terminated ，terminated，ENCLOSED(默认分隔符，封闭符"")
create external table ex_table_14(clo1 tinyint primary key,clo2 smallint,clo3 int,clo4 bigint,clo5 tinyint unsigned,clo6 smallint unsigned,clo7 int unsigned,clo8 bigint unsigned,col9 float,col10 double,col11 varchar(255),col12 Date,col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_10.csv'}
select * from ex_table_14;

--text
-- @bvt:issue#5442
create external table ex_table_text(char_1 char(20),char_2 varchar(10),date_1 date,date_2 datetime,date_3 timestamp)infile{"filepath"='/Users/heni/test_data/ex_table_char.text'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_text;
--log
create external table ex_table_log(char_1 char(20),char_2 varchar(10),date_1 date,date_2 datetime,date_3 timestamp)infile{"filepath"='/Users/heni/test_data/ex_table_char.log'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_log;
-- @bvt:issue
--gzip
create external table ex_table_gzip(num_col1 tinyint,num_col2 smallint,num_col3 int,num_col4 bigint,num_col5 tinyint unsigned,num_col6 smallint unsigned,num_col7 int unsigned,num_col8 bigint unsigned ,num_col9 float(5,3),num_col10 double(6,5),num_col11 decimal(38,19)) infile{"filepath"='/Users/heni/test_data/ex_table_gzip.gz',"compression"='gzip'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_gzip;

--bzip2
create external table ex_table_bzip2(char_1 char(20),char_2 varchar(10),date_1 date,date_2 datetime,date_3 timestamp)infile{"filepath"='/Users/heni/test_data/ex_table_bzip.bz2',"compression"='bzip2'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_bzip2;

--lz4
create external table ex_table_lz4(num_col1 tinyint,num_col2 smallint,num_col3 int,num_col4 bigint,num_col5 tinyint unsigned,num_col6 smallint unsigned,num_col7 int unsigned,num_col8 bigint unsigned ,num_col9 float(5,3),num_col10 double(6,5),num_col11 decimal(38,19)) infile{"filepath"='/Users/heni/test_data/ex_table_lz4.lz4',"compression"='lz4'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
...
col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255)) infile{"filepath"='/Users/heni/test_data/ex_table_sep_8.csv',"compression"='none'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_none;

--缺省compression
create external table ex_table_nocomp(char_1 char(20),char_2 varchar(10),date_1 timestamp,date_2 datetime,date_3 timestamp)infile{"filepath"='/Users/heni/test_data/ex_table_bzip.bz2'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_nocomp;
--异常：压缩格式不对应，未压缩文件
create external table ex_table_cp1(num_col1 tinyint,num_col2 smallint,num_col3 int,num_col4 bigint,num_col5 tinyint unsigned,num_col6 smallint unsigned,num_col7 int unsigned,num_col8 bigint unsigned ,num_col9 float(5,3),num_col10 double(6,5),num_col11 decimal(38,19)) infile{"filepath"='/Users/heni/test_data/ex_table_gzip.gz',"compression"='lz4'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_cp1;
create external table ex_table_cp2(num_col1 tinyint,num_col2 smallint,num_col3 int,num_col4 bigint,num_col5 tinyint unsigned,num_col6 smallint unsigned,num_col7 int unsigned,num_col8 bigint unsigned ,num_col9 float(5,3),num_col10 double(6,5),num_col11 decimal(38,19)) infile{"filepath"='/Users/heni/test_data/ex_table_number.csv',"compression"='lz4'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
select * from ex_table_cp2;

--insert into internal table select from external table
create external table ex_table_15(clo1 tinyint,clo2 smallint,clo3 int,clo4 bigint,clo5 tinyint unsigned,clo6 smallint unsigned,clo7 int unsigned,clo8 bigint unsigned,col9 float,col10 double,col11 varchar(255),col12 Date,col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_1.csv'} fields terminated by '|' enclosed by '' lines terminated by '\n';
...
create external table ex_table_drop(clo1 tinyint,clo2 smallint,clo3 int,clo4 bigint,clo5 tinyint unsigned,clo6 smallint unsigned,clo7 int unsigned,clo8 bigint unsigned,col9 float,col10 double,col11 varchar(255),col12 Date,col13 DateTime,col14 timestamp,col15 bool,col16 decimal(5,2),col17 text,col18 varchar(255),col19 varchar(255),col20 varchar(255))infile{"filepath"='/Users/heni/test_data/ex_table_sep_1.csv'} fields terminated by '|' enclosed by '' lines terminated by '\n';
select * from ex_table_drop;

--show create table
show create table ex_table_15;

--内部表和外部表关联
select * from ex_table_15,table_15 where ex_table_15.clo1=table_15.clo1;

--异常测试:insert/update/delete
create external table ex_table_yccs(char_1 char(20),char_2 varchar(10),date_1 date,date_2 datetime,date_3 timestamp)infile{"filepath"='/Users/heni/test_data/ex_table_char.csv'} fields terminated by ',' enclosed by '\"' lines terminated by '\n';
