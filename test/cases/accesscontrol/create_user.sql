...
drop user if exists test_user,test_user0,test_user1,test_user2,user1,user2,user3,user4,user5,user6,user7,user8,user9,user10,tester1,tester2,tester001,tester002,tester003,daisy@192.168.1.10;
drop account if exists test5555;
drop role if exists low_level,mid_level,high_level;
