...
require (
	...
	github.com/dolthub/go-mysql-server v0.0.0-20221019203727-b99ff94e4329
...
replace github.com/dolthub/go-mysql-server => github.com/zhangxu19830126/go-mysql-server v0.0.0-20221020142514-bc2567ee3b37
