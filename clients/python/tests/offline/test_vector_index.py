...
from matrixone.sqlalchemy_ext import (
    ...
    create_vector_column, Vectorf32
)
...
class TestVectorIndexOffline:
    ...
    def test_vector_index_builder_chain(self):
        ...
        result = builder \
            .l2_index("idx1", lists=100) \
            .cosine_index("idx2", lists=200) \
            .ip_index("idx3", lists=300)
