...
class TestSQLAlchemyCompatibility:
    """Test SQLAlchemy compatibility wrappers."""
    
    def test_fulltext_and_wrapper(self):
        """Test fulltext_and wrapper."""
        filter1 = boolean_match("title", "content").must("python")
        filter2 = boolean_match("title", "content").must("java")
        
        # This should not raise an error
        combined = fulltext_and(filter1, filter2)
        assert combined is not None
    
    def test_fulltext_or_wrapper(self):
        """Test fulltext_or wrapper."""
        filter1 = boolean_match("title", "content").must("python")
        filter2 = boolean_match("title", "content").must("java")
        
        # This should not raise an error
        combined = fulltext_or(filter1, filter2)
        assert combined is not None
...
class TestComplexScenarios:
    ...
    def test_product_search_with_weights(self):
        ...
        filter_obj = (boolean_match("name", "description")
                     .must("laptop")
    ...
    def test_news_article_filtering(self):
        ...
        filter_obj = (boolean_match("headline", "content")
                     .must("technology")
    ...
    def test_academic_paper_search(self):
        ...
        filter_obj = (boolean_match("title", "abstract", "keywords")
