...
class TestAdvancedFeatures:
    ...
    def test_pubsub_operations(self, test_client):
        ...
        test_client.execute("CREATE TABLE IF NOT EXISTS pubsub_test (id INT PRIMARY KEY, message VARCHAR(200), timestamp TIMESTAMP)")
    ...
    def test_pitr_operations(self, test_client):
        ...
        try:
            pitr = test_client.pitr.create_cluster_pitr(
                name=pitr_name,
                range_value=1,
                range_unit="d"
            )
