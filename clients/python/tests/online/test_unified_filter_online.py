...
class TestUnifiedFilterOnline(unittest.TestCase):
    ...
    def test_multiple_filter_calls(self):
        ...
        results = (self.client.query(Product)
    ...
    def test_complex_nested_condition(self):
        ...
        results = self.client.query(Product).filter(or_(
    ...
    def test_mixed_condition_types(self):
        ...
        results = (self.client.query(User)
                  .filter("age > 25")
                  .filter(User.city != "深圳")
    ...
    def test_complex_and_or_combination(self):
        ...
        results = self.client.query(User).filter(and_(
    ...
    def test_multiple_or_conditions(self):
        ...
        results = self.client.query(User).filter(or_(
            User.city == "北京",
            User.city == "上海",
            User.age > 35
        )).all()
