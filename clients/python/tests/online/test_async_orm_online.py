...
class TestAsyncORMOnline:
    ...
    async def test_async_orm_query_filtering(self, test_async_client):
        ...
        expensive_electronics = (await test_async_client.query(AsyncProduct)
    ...
    async def test_async_orm_query_ordering_and_limiting(self, test_async_client):
        ...
        top_products = (await test_async_client.query(AsyncProduct)
                       .order_by("price DESC")
                       .limit(2)
                       .all())
    ...
    async def test_async_orm_query_parameter_handling(self, test_async_client):
        ...
        user = (await test_async_client.query(AsyncUser)
               .filter("name = ? AND age > ?", "Diana Prince", 25)
               .first())
        assert user is not None
    ...
    async def test_async_orm_query_snapshot_support(self, test_async_client):
        ...
        query = (test_async_client.query(AsyncUser)
