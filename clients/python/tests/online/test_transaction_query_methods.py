...
class TestTransactionQueryMethods:
    ...
    def test_sync_transaction_query_with_simple_select(self, sync_client_setup):
        ...
        with client.transaction() as tx:
            ...
            tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Transaction Test', 40, 'tx@example.com')")
    ...
    async def test_async_transaction_query_with_simple_select(self, async_client_setup):
        ...
        async with client.transaction() as tx:
            ...
            # Test that we can insert and query within the same transaction
            await tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Async Transaction Test', 42, 'async_tx@example.com')")
    ...
    def test_sync_transaction_query_rollback(self, sync_client_setup):
        ...
        try:
            with client.transaction() as tx:
                # Insert data
                tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Rollback Test', 50, 'rollback@example.com')")
    ...
    async def test_async_transaction_query_rollback(self, async_client_setup):
        ...
        try:
            async with client.transaction() as tx:
                # Insert data
                await tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Async Rollback Test', 52, 'async_rollback@example.com')")
    ...
    def test_sync_transaction_mixed_operations(self, sync_client_setup):
        ...
        with client.transaction() as tx:
            ...
            tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Mixed Test 1', 45, 'mixed1@example.com')")
    ...
    async def test_async_transaction_mixed_operations(self, async_client_setup):
        ...
        async with client.transaction() as tx:
            ...
            # Insert single record
            await tx.execute(f"INSERT INTO {test_db}.test_table (name, age, email) VALUES ('Async Mixed Test 1', 48, 'async_mixed1@example.com')")
