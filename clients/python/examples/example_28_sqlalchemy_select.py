...
class Article(Base):
    ...
    __table_args__ = (
        FulltextIndex('ftidx_article_search', ['title', 'content'], algorithm=FulltextAlgorithmType.BM25),
    )
...
class SQLAlchemySelectDemo:
    ...
    def test_basic_select(self):
        ...
        articles = [
            ...
            Article(title="Web Development", content="Build web applications with Python", category="Programming", author="Bob"),
    ...
    def test_fulltext_search_select(self):
        ...
        stmt = (select(Article.category, func.count(Article.id).label('count'))
    ...
    def test_vector_search_select(self):
        ...
        stmt = (select(Document, Document.embedding.cosine_distance(query_vector).label('distance'))
        ...
        stmt = (select(Document, Document.embedding.inner_product(query_vector).label('score'))
    ...
    def test_complex_queries(self):
        ...
        print("\n3. Having clause:")
        stmt = (select(Article.author, func.count(Article.id).label('count'))
