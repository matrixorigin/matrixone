    ...
    def test_sync_snapshot_orm(self):
        ...
        try:
            ...
            try:
                ...
                # Insert test data
                client.execute("INSERT INTO users (name, email, age, department) VALUES ('Alice', 'alice@example.com', 25, 'Engineering')")
                client.execute("INSERT INTO users (name, email, age, department) VALUES ('Bob', 'bob@example.com', 30, 'Marketing')")
                client.execute("INSERT INTO users (name, email, age, department) VALUES ('Charlie', 'charlie@example.com', 35, 'Engineering')")
