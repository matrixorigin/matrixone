...
class Publication:
    ...
    def __repr__(self):
        return (f"<Publication(name='{self.name}', database='{self.database}', "
...
class Subscription:
    ...
    def __repr__(self):
        return (f"<Subscription(pub_name='{self.pub_name}', sub_name='{self.sub_name}', "
...
class PubSubManager:
    ...
    def create_subscription(self, 
        ...
        """
        try:
            sql = (f"CREATE DATABASE {self._client._escape_identifier(subscription_name)} "
...
class TransactionPubSubManager(PubSubManager):
    ...
    def _create_publication_with_executor(self, 
                                        level: str,
                                        name: str, 
                                        database: str, 
                                        account: str,
