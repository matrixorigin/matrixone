...
class RestoreManager:
    ...
    def restore_tenant(self, 
        ...
        try:
            if to_account:
                ...
                sql = (f"RESTORE ACCOUNT {self._client._escape_identifier(account_name)} "
    ...
    def restore_with_executor(self, 
                             restore_type: str,
                             snapshot_name: str,
...
class TransactionRestoreManager(RestoreManager):
    ...
    def restore_tenant(self, 
        ...
        return self.restore_with_executor('tenant', snapshot_name, account_name, to_account=to_account, executor=self._transaction_wrapper)
    ...
    def restore_database(self, 
        ...
        return self.restore_with_executor('database', snapshot_name, account_name, database_name, to_account=to_account, executor=self._transaction_wrapper)
    ...
    def restore_table(self, 
        ...
        return self.restore_with_executor('table', snapshot_name, account_name, database_name, table_name, to_account=to_account, executor=self._transaction_wrapper)
