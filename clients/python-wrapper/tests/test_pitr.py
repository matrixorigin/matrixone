...
class TestPitrManager(unittest.TestCase):
    ...
    def test_get_pitr_success(self):
        ...
        self.client.execute.assert_called_with(
            "SHOW PITR WHERE pitr_name = 'cluster_pitr1'"
        )
    ...
    def test_list_pitrs_with_filters(self):
        ...
        self.client.execute.assert_called_with(
            "SHOW PITR WHERE pitr_level = 'account' AND account_name = 'acc1'"
        )
    ...
    def test_alter_pitr_success(self):
        ...
        self.assertEqual(self.client.execute.call_count, 2)
        self.client.execute.assert_any_call(
            "ALTER PITR `cluster_pitr1` RANGE 2 'h'"
        )
