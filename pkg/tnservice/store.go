...
// by explicitly owned, co-located TAE recovery. Passing nil leaves ordinary
// storage unchanged. This process-local option does not establish exclusive
// ownership of a shared journal namespace. Production activation must supply
// that ownership before any TN can open it; no launcher enables this option yet.
