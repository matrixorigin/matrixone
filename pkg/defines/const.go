...
const (
	...
	MORPCVersion74     int64 = 74 // NaN-ordered and direction-aware aggregate states
	MORPCVersion75     int64 = 75 // complete typed SQL equivalence keys in HLL states
	...
	MORPCLatestVersion       = MORPCVersion77
)
