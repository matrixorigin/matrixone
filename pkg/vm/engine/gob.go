...
func init() {
	...
	gob.Register(new(UniqueIndexDef))
	gob.Register(new(SecondaryIndexDef))
	...
	gob.Register(&plan.Const_I8Val{})
	gob.Register(&plan.Const_I16Val{})
	gob.Register(&plan.Const_I32Val{})
	gob.Register(&plan.Const_I64Val{})
	gob.Register(&plan.Const_Dval{})
	gob.Register(&plan.Const_Sval{})
	gob.Register(&plan.Const_Bval{})
	gob.Register(&plan.Const_U8Val{})
	gob.Register(&plan.Const_U16Val{})
	gob.Register(&plan.Const_U32Val{})
	gob.Register(&plan.Const_U64Val{})
