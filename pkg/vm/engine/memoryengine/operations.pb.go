...
import (
	...
	github_com_matrixorigin_matrixone_pkg_container_batch "github.com/matrixorigin/matrixone/pkg/container/batch"
	github_com_matrixorigin_matrixone_pkg_container_vector "github.com/matrixorigin/matrixone/pkg/container/vector"
...
type OpenDatabaseReq struct {
	AccessInfo AccessInfo `protobuf:"bytes,1,opt,name=AccessInfo,proto3" json:"AccessInfo"`
...
type CreateDatabaseReq struct {
	ID         ID         `protobuf:"varint,1,opt,name=ID,proto3,casttype=ID" json:"ID,omitempty"`
	AccessInfo AccessInfo `protobuf:"bytes,2,opt,name=access_info,json=accessInfo,proto3" json:"access_info"`
...
type OpenRelationReq struct {
	DatabaseID   ID     `protobuf:"varint,1,opt,name=DatabaseID,proto3,casttype=ID" json:"DatabaseID,omitempty"`
...
type OpenRelationResp struct {
	ID           ID           `protobuf:"varint,1,opt,name=ID,proto3,casttype=ID" json:"ID,omitempty"`
	Type         RelationType `protobuf:"varint,2,opt,name=type,proto3,casttype=RelationType" json:"type,omitempty"`
...
type CreateRelationReq struct {
	ID           ID                                                           `protobuf:"varint,1,opt,name=ID,proto3,casttype=ID" json:"ID,omitempty"`
	DatabaseID   ID                                                           `protobuf:"varint,2,opt,name=DatabaseID,proto3,casttype=ID" json:"DatabaseID,omitempty"`
	...
	Type         RelationType                                                 `protobuf:"varint,5,opt,name=type,proto3,casttype=RelationType" json:"type,omitempty"`
	Defs         []github_com_matrixorigin_matrixone_pkg_vm_engine.TableDefPB `protobuf:"bytes,6,rep,name=Defs,proto3,customtype=github.com/matrixorigin/matrixone/pkg/vm/engine.TableDefPB" json:"Defs,omitempty"`
}
...
type GetTableDefsReq struct {
	TableID ID `protobuf:"varint,1,opt,name=TableID,proto3,casttype=ID" json:"TableID,omitempty"`
}
...
type GetTableDefsResp struct {
	Defs []github_com_matrixorigin_matrixone_pkg_vm_engine.TableDefPB `protobuf:"bytes,1,rep,name=Defs,proto3,customtype=github.com/matrixorigin/matrixone/pkg/vm/engine.TableDefPB" json:"Defs,omitempty"`
}
...
type WriteReq struct {
	...
	Batch        *github_com_matrixorigin_matrixone_pkg_container_batch.Batch `protobuf:"bytes,4,opt,name=Batch,proto3,customtype=github.com/matrixorigin/matrixone/pkg/container/batch.Batch" json:"Batch,omitempty"`
}
...
func (m *WriteReq) GetDatabaseName() string {
	if m != nil {
		return m.DatabaseName
	}
	return ""
...
func (m *WriteReq) GetTableName() string {
	if m != nil {
		return m.TableName
	}
	return ""
...
type NewTableIterResp struct {
	IterID ID `protobuf:"varint,1,opt,name=IterID,proto3,casttype=ID" json:"IterID,omitempty"`
}
...
type DeleteReq struct {
	...
	Vector       *github_com_matrixorigin_matrixone_pkg_container_vector.Vector `protobuf:"bytes,5,opt,name=Vector,proto3,customtype=github.com/matrixorigin/matrixone/pkg/container/vector.Vector" json:"Vector,omitempty"`
}
...
func (m *DeleteReq) GetTableID() ID {
	if m != nil {
		return m.TableID
	}
	return 0
...
func (m *DeleteReq) GetDatabaseName() string {
	if m != nil {
		return m.DatabaseName
	}
	return ""
...
func (m *DeleteReq) GetColumnName() string {
	if m != nil {
		return m.ColumnName
	}
	return ""
...
type GetPrimaryKeysResp struct {
	Attrs []github_com_matrixorigin_matrixone_pkg_vm_engine.Attribute `protobuf:"bytes,1,rep,name=Attrs,proto3,customtype=github.com/matrixorigin/matrixone/pkg/vm/engine.Attribute" json:"Attrs,omitempty"`
}
...
type TableStatsResp struct {
	Rows int `protobuf:"varint,1,opt,name=Rows,proto3,casttype=int" json:"Rows,omitempty"`
}
...
type TruncateRelationReq struct {
	NewTableID   ID     `protobuf:"varint,1,opt,name=NewTableID,proto3,casttype=ID" json:"NewTableID,omitempty"`
	OldTableID   ID     `protobuf:"varint,2,opt,name=OldTableID,proto3,casttype=ID" json:"OldTableID,omitempty"`
	DatabaseID   ID     `protobuf:"varint,3,opt,name=DatabaseID,proto3,casttype=ID" json:"DatabaseID,omitempty"`
...
type AddTableDefReq struct {
	...
	DatabaseName string                                                     `protobuf:"bytes,2,opt,name=DatabaseName,proto3" json:"DatabaseName,omitempty"`
	TableName    string                                                     `protobuf:"bytes,3,opt,name=TableName,proto3" json:"TableName,omitempty"`
	Def          github_com_matrixorigin_matrixone_pkg_vm_engine.TableDefPB `protobuf:"bytes,4,opt,name=Def,proto3,customtype=github.com/matrixorigin/matrixone/pkg/vm/engine.TableDefPB" json:"Def"`
}
...
func (*DelTableDefReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b4a5877375e491e, []int{41}
}
...
func (*DelTableDefResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b4a5877375e491e, []int{42}
}
...
func (*UpdateReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b4a5877375e491e, []int{43}
}
...
func (m *UpdateReq) GetTableID() ID {
	if m != nil {
		return m.TableID
	}
	return 0
...
func (m *UpdateReq) GetDatabaseName() string {
	if m != nil {
		return m.DatabaseName
	}
	return ""
...
func (*UpdateResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b4a5877375e491e, []int{44}
}
...
func init() {
	...
	proto.RegisterType((*WriteReq)(nil), "memoryengine.WriteReq")
	...
	proto.RegisterType((*ReadResp)(nil), "memoryengine.ReadResp")
	proto.RegisterType((*DeleteReq)(nil), "memoryengine.DeleteReq")
	...
	proto.RegisterType((*UpdateReq)(nil), "memoryengine.UpdateReq")
...
var fileDescriptor_1b4a5877375e491e = []byte{
	...
	,
}
...
func (m *WriteReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Batch != nil {
		{
			size := m.Batch.ProtoSize()
			i -= size
			if _, err := m.Batch.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintOperations(dAtA, i, uint64(size))
		}
...
func (m *DeleteReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Vector != nil {
		{
			size := m.Vector.ProtoSize()
			i -= size
			if _, err := m.Vector.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintOperations(dAtA, i, uint64(size))
		}
	...
	if len(m.ColumnName) > 0 {
		...
		i = encodeVarintOperations(dAtA, i, uint64(len(m.ColumnName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TableName) > 0 {
...
func (m *WriteReq) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadResp) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeleteReq) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateReq) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WriteReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			var v github_com_matrixorigin_matrixone_pkg_container_batch.Batch
			m.Batch = &v
...
func (m *DeleteReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			var v github_com_matrixorigin_matrixone_pkg_container_vector.Vector
			m.Vector = &v
