...
func (m *CheckConstraintsDef) Reset()         { *m = CheckConstraintsDef{} }
func (m *CheckConstraintsDef) String() string { return proto.CompactTextString(m) }
func (*CheckConstraintsDef) ProtoMessage()    {}
func (*CheckConstraintsDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_d938547f84707355, []int{10}
}
func (m *CheckConstraintsDef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckConstraintsDef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckConstraintsDef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckConstraintsDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckConstraintsDef.Merge(m, src)
}
func (m *CheckConstraintsDef) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CheckConstraintsDef) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckConstraintsDef.DiscardUnknown(m)
}

var xxx_messageInfo_CheckConstraintsDef proto.InternalMessageInfo

func (m *CheckConstraintsDef) GetChecks() []*plan.CheckDef {
	if m != nil {
		return m.Checks
	}
	return nil
...
type ConstraintPB struct {
	...
	//	*ConstraintPB_CheckConstraintsDef
...
type ConstraintPB_CheckConstraintsDef struct {
	CheckConstraintsDef *CheckConstraintsDef `protobuf:"bytes,6,opt,name=CheckConstraintsDef,proto3,oneof" json:"CheckConstraintsDef,omitempty"`
}
...
func (*ConstraintPB_CheckConstraintsDef) isConstraintPB_Ct() {}
...
func (m *ConstraintPB) GetCheckConstraintsDef() *CheckConstraintsDef {
	if x, ok := m.GetCt().(*ConstraintPB_CheckConstraintsDef); ok {
		return x.CheckConstraintsDef
	}
	return nil
}
...
func (*ConstraintPB) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ConstraintPB_CheckConstraintsDef)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*CheckConstraintsDef)(nil), "engine.CheckConstraintsDef")
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
...
func (m *CheckConstraintsDef) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckConstraintsDef) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckConstraintsDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConstraintPB_CheckConstraintsDef) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConstraintPB_CheckConstraintsDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CheckConstraintsDef != nil {
		{
			size, err := m.CheckConstraintsDef.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CheckConstraintsDef) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConstraintPB_CheckConstraintsDef) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CheckConstraintsDef != nil {
		l = m.CheckConstraintsDef.ProtoSize()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *CheckConstraintsDef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckConstraintsDef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckConstraintsDef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ConstraintPB) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckConstraintsDef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &CheckConstraintsDef{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Ct = &ConstraintPB_CheckConstraintsDef{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
