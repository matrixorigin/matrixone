...
type AttributeDef struct {
	Attr Attribute `protobuf:"bytes,1,opt,name=Attr,proto3" json:"Attr"`
}
...
type IndexTableDef struct {
	Typ      IndexT   `protobuf:"varint,1,opt,name=Typ,proto3,casttype=IndexT" json:"Typ,omitempty"`
...
type ForeignKeyDef struct {
	Fkeys []*plan.ForeignKeyDef `protobuf:"bytes,1,rep,name=Fkeys,proto3" json:"Fkeys,omitempty"`
}
...
type PrimaryKeyDef struct {
	Pkey *plan.PrimaryKeyDef `protobuf:"bytes,1,opt,name=Pkey,proto3" json:"Pkey,omitempty"`
}
...
type RefChildTableDef struct {
	Tables []uint64 `protobuf:"varint,1,rep,packed,name=Tables,proto3" json:"Tables,omitempty"`
}
...
type IndexDef struct {
	Indexes []*plan.IndexDef `protobuf:"bytes,1,rep,name=Indexes,proto3" json:"Indexes,omitempty"`
}
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
