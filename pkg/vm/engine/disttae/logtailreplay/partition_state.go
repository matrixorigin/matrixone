...
func (p *PartitionState) Copy() *PartitionState {
	state := PartitionState{
		...
		objectsCreatedByCn: p.objectsCreatedByCn,
...
func (p *PartitionState) HandleObjectInsert(
	...
	//for cdc, when all delete ts in the same batch are empty,
	//the objects are created by the cn
	p.objectsCreatedByCn = allDelTsAreEmptry
