...
func MergeAObj(
	...
	if typ.IsVarlen() {
		...
		case types.T_date:
			...
			merger = newAObjMerger(vpool, batches, func(a, b types.Date) bool { return types.DateAscCompare(a, b) < 0 }, sortKeyPos, df, toLayout)
		...
		case types.T_datetime:
			...
			merger = newAObjMerger(vpool, batches, func(a, b types.Datetime) bool { return types.DatetimeAscCompare(a, b) < 0 }, sortKeyPos, df, toLayout)
		case types.T_time:
