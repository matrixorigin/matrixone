...
func NewLogtailServer(
	address string, cfg *options.LogtailServerCfg, logtail taelogtail.Logtailer, rt runtime.Runtime, nowFn func() (timestamp.Timestamp, timestamp.Timestamp), opts ...ServerOption,
) (*LogtailServer, error) {
	s := &LogtailServer{
		rt:         rt,
		logger:     rt.Logger(),
