...
func TestHandleInspectPolicy(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "(*) maxMergeObjN: 16, maxOsizeObj: 90MB, minOsizeQualified: 90MB, hints: [Auto]", resp.Message)
	...
	require.NoError(t, err)
	require.Equal(t, "(1000-test1) maxMergeObjN: 0, maxOsizeObj: 90MB, minOsizeQualified: 0MB, hints: [Auto]", resp.Message)
	...
	require.NoError(t, err)
	require.Equal(t, "(1000-test1) maxMergeObjN: 16, maxOsizeObj: 90MB, minOsizeQualified: 90MB, hints: [Auto]", resp.Message)
