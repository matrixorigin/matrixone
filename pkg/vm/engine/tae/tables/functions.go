...
var getDuplicatedRowIDNABlkFunctions = map[types.T]any{
	...
	types.T_date:       getDuplicateRowIDNABlkFuncFactory(types.DateAscCompare),
	types.T_time:       getDuplicatedRowIDNABlkOrderedFunc[types.Time],
	types.T_datetime:   getDuplicateRowIDNABlkFuncFactory(types.DatetimeAscCompare),
...
var getRowIDAlkFunctions = map[types.T]any{
	...
	types.T_date:       getDuplicatedRowIDABlkFuncFactory(types.DateAscCompare),
	types.T_time:       getDuplicatedRowIDABlkFuncFactory(compute.CompareOrdered[types.Time]),
	types.T_datetime:   getDuplicatedRowIDABlkFuncFactory(types.DatetimeAscCompare),
