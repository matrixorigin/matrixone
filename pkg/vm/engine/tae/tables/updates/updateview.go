...
type ColumnView struct {
	links map[uint32]*common.SortedDLink
	mask  *roaring.Bitmap
}
...
func NewColumnView() *ColumnView {
	...
	return &ColumnView{
		links: make(map[uint32]*common.SortedDLink),
		mask:  roaring.New(),
	}
}
...
func (view *ColumnView) RowStringLocked(row uint32, link *common.SortedDLink) string {
