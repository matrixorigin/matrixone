...
func TestTree(t *testing.T) {
	...
	tree := NewTree()
	seg1 := objectio.NewObjectid()
	seg2 := objectio.NewObjectid()
	blk0 := objectio.NewBlockidWithObjectID(seg1, 0)
	blk1 := objectio.NewBlockidWithObjectID(seg1, 1)
	blk2 := objectio.NewBlockidWithObjectID(seg1, 2)
	tree.AddObject(1, 2, seg2)
