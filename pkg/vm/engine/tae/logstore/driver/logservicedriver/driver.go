...
func NewLogServiceDriver(cfg *Config) *LogServiceDriver {
	...
	d.preAppendLoop = sm.NewSafeQueue(sm.LogDriverPreAppendQueue, 10000, 10000, d.onPreAppend)
	...
	d.truncateQueue = sm.NewSafeQueue(sm.LogDriverTruncateQueue, 10000, 10000, d.onTruncate)
