...
// SetAutoIncrEpoch records the CN allocator dependency for this relation.
func (h *txnRelation) SetAutoIncrEpoch(epoch uint32) error {
	return h.table.setExpectedAutoIncrEpoch(epoch)
}
