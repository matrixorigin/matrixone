...
type BlockReader interface {
	...
	GetColumnDataByNames(attrs []string, buffers []*bytes.Buffer) ([]*model.ColumnView, error)
	GetColumnDataByIds(colIdxes []int, buffers []*bytes.Buffer) ([]*model.ColumnView, error)
