...
type Block interface {
	...
	Rows() int
	GetColumnDataByNames(txn txnif.AsyncTxn, attrs []string, buffers []*bytes.Buffer) ([]*model.ColumnView, error)
	GetColumnDataByIds(txn txnif.AsyncTxn, colIdxes []int, buffers []*bytes.Buffer) ([]*model.ColumnView, error)
