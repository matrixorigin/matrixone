...
func (c *TableDefPB) FromPBVersion() TableDef {
	if r := c.GetCommentDef(); r != nil {
		return r
	}
	if r := c.GetPartitionDef(); r != nil {
		return r
	}
	if r := c.GetViewDef(); r != nil {
		return r
	}
	if r := c.GetAttributeDef(); r != nil {
		return r
	}
	if r := c.GetIndexTableDef(); r != nil {
		return r
	}
	if r := c.GetPropertiesDef(); r != nil {
		return r
	}
	if r := c.GetClusterByDef(); r != nil {
		return r
	}
	if r := c.GetConstraintDefPB(); r != nil {
