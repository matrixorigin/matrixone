...
func TestRebuildIndices(t *testing.T) {
	...
	os.Remove(filepath.Join(inst.Dir, "data/index/1_1_7_1.bsi"))

	// manually create useless index files, and during replaying the file
	// would be GCed automatically.
	os.Create(filepath.Join(inst.Dir, "data/index/1_1_11_1.bsi"))
	...
	// be GCed as well.
	os.Rename(filepath.Join(inst.Dir, "data/index/1_1_6_1.bsi"), filepath.Join(inst.Dir, "data/index/2_1_6_1.bsi"))
	os.Create(filepath.Join(inst.Dir, "data/index/1_1_6_1.bsi"))
