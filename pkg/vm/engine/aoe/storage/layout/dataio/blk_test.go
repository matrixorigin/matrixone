...
//	dir := initTestEnv(t)
//	rowCnt, blkCnt := uint64(1000), uint64(40)
//	catalog := metadata.MockCatalog(dir, rowCnt, blkCnt, nil, nil)
//	defer catalog.Close()
//
//	schema := metadata.MockSchema(2000)
//	segCnt, blkCnt := uint64(2), uint64(40)
//
//}
