...
type TxnEventCallback struct {
	Func  func(TxnOperator, TxnEvent, any)
	Value any
}

func NewTxnEventCallback(f func(TxnOperator, TxnEvent, any)) TxnEventCallback {
	return TxnEventCallback{
		Func: f,
	}
}
func NewTxnEventCallbackWithValue(f func(TxnOperator, TxnEvent, any), v any) TxnEventCallback {
	return TxnEventCallback{
		Func:  f,
		Value: v,
	}
