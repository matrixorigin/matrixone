...
func (*StorageTxnClient) NewWithSnapshot(context.Context, txn.CNTxnSnapshot) (client.TxnOperator, error) {
	panic("unimplemented")
}
...
func (s *StorageTxnOperator) AppendEventCallback(event client.EventType, callbacks ...client.TxnEventCallback) {
	panic("unimplemented")
}
