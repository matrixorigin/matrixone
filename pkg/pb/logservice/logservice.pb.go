...
const (
	...
	UPDATE_GLOBAL_SYS_VAR_COMMIT_TS MethodType = 30
	UPDATE_GLOBAL_SYS_VAR_STATE     MethodType = 31
)
...
var MethodType_name = map[int32]string{
	...
	30: "UPDATE_GLOBAL_SYS_VAR_COMMIT_TS",
	31: "UPDATE_GLOBAL_SYS_VAR_STATE",
}
...
var MethodType_value = map[string]int32{
	...
	"UPDATE_GLOBAL_SYS_VAR_COMMIT_TS": 30,
	"UPDATE_GLOBAL_SYS_VAR_STATE":     31,
}
...
type GlobalSysVarUpdateType int32

const (
	BeginGlobalSysVarUpdate    GlobalSysVarUpdateType = 0
	CompleteGlobalSysVarUpdate GlobalSysVarUpdateType = 1
)

var GlobalSysVarUpdateType_name = map[int32]string{
	0: "BeginGlobalSysVarUpdate",
	1: "CompleteGlobalSysVarUpdate",
}

var GlobalSysVarUpdateType_value = map[string]int32{
	"BeginGlobalSysVarUpdate":    0,
	"CompleteGlobalSysVarUpdate": 1,
}

func (x GlobalSysVarUpdateType) String() string {
	return proto.EnumName(GlobalSysVarUpdateType_name, int32(x))
}

func (GlobalSysVarUpdateType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	UpdateGlobalSysVarCommitTS       HAKeeperUpdateType = 21
	UpdateGlobalSysVarState          HAKeeperUpdateType = 22
)
...
var HAKeeperUpdateType_name = map[int32]string{
	...
	21: "UpdateGlobalSysVarCommitTS",
	22: "UpdateGlobalSysVarState",
}
...
var HAKeeperUpdateType_value = map[string]int32{
	...
	"UpdateGlobalSysVarCommitTS":       21,
	"UpdateGlobalSysVarState":          22,
}
...
type CNStore struct {
	...
	GlobalSysVarCommitTS             timestamp.Timestamp           `protobuf:"bytes,17,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarGeneration           string                        `protobuf:"bytes,18,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	ProtocolVersion                  int64                         `protobuf:"varint,19,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	GlobalSysVarProgressTimeoutNanos int64                         `protobuf:"varint,20,opt,name=GlobalSysVarProgressTimeoutNanos,proto3" json:"GlobalSysVarProgressTimeoutNanos,omitempty"`
...
func (m *CNStore) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
}

func (m *CNStore) GetGlobalSysVarGeneration() string {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return ""
}

func (m *CNStore) GetProtocolVersion() int64 {
	if m != nil {
...
func (m *CNStore) GetGlobalSysVarProgressTimeoutNanos() int64 {
	if m != nil {
		return m.GlobalSysVarProgressTimeoutNanos
	}
	return 0
}
...
type LogStore struct {
	...
	ProtocolVersion      int64            `protobuf:"varint,8,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *LogStore) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
type CNStoreHeartbeat struct {
	...
	// GlobalSysVarCommitTS is the latest global-system-variable watermark whose
	// logtail has been applied locally.
	GlobalSysVarCommitTS             timestamp.Timestamp `protobuf:"bytes,18,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarGeneration           string              `protobuf:"bytes,19,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	ProtocolVersion                  int64               `protobuf:"varint,20,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	GlobalSysVarProgressTimeoutNanos int64               `protobuf:"varint,21,opt,name=GlobalSysVarProgressTimeoutNanos,proto3" json:"GlobalSysVarProgressTimeoutNanos,omitempty"`
	XXX_NoUnkeyedLiteral             struct{}            `json:"-"`
	XXX_unrecognized                 []byte              `json:"-"`
	XXX_sizecache                    int32               `json:"-"`
}
...
func (m *CNStoreHeartbeat) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *CNStoreHeartbeat) GetGlobalSysVarGeneration() string {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return ""
...
func (m *CNStoreHeartbeat) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
func (m *CNStoreHeartbeat) GetGlobalSysVarProgressTimeoutNanos() int64 {
	if m != nil {
		return m.GlobalSysVarProgressTimeoutNanos
	}
	return 0
...
type LogStoreHeartbeat struct {
	...
	ProtocolVersion          int64    `protobuf:"varint,10,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *LogStoreHeartbeat) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
type Request struct {
	...
	GlobalSysVarCommitTS timestamp.Timestamp   `protobuf:"bytes,18,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarUpdate   *GlobalSysVarUpdate   `protobuf:"bytes,19,opt,name=GlobalSysVarUpdate,proto3" json:"GlobalSysVarUpdate,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *Request) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *Request) GetGlobalSysVarUpdate() *GlobalSysVarUpdate {
	if m != nil {
		return m.GlobalSysVarUpdate
	}
	return nil
}
...
type Response struct {
	...
	GlobalSysVarGeneration uint64                `protobuf:"varint,13,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}              `json:"-"`
	XXX_unrecognized       []byte                `json:"-"`
	XXX_sizecache          int32                 `json:"-"`
}
...
func (m *Response) GetGlobalSysVarGeneration() uint64 {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return 0
...
type GlobalSysVarUpdate struct {
	Type                 GlobalSysVarUpdateType `protobuf:"varint,1,opt,name=Type,proto3,enum=logservice.GlobalSysVarUpdateType" json:"Type,omitempty"`
	MembershipRevision   uint64                 `protobuf:"varint,2,opt,name=MembershipRevision,proto3" json:"MembershipRevision,omitempty"`
	Generation           uint64                 `protobuf:"varint,3,opt,name=Generation,proto3" json:"Generation,omitempty"`
	CommitTS             timestamp.Timestamp    `protobuf:"bytes,4,opt,name=CommitTS,proto3" json:"CommitTS"`
	MinProtocolVersion   int64                  `protobuf:"varint,5,opt,name=MinProtocolVersion,proto3" json:"MinProtocolVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}

func (m *GlobalSysVarUpdate) Reset()         { *m = GlobalSysVarUpdate{} }
func (m *GlobalSysVarUpdate) String() string { return proto.CompactTextString(m) }
func (*GlobalSysVarUpdate) ProtoMessage()    {}
func (*GlobalSysVarUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{22}
}
func (m *GlobalSysVarUpdate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GlobalSysVarUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GlobalSysVarUpdate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GlobalSysVarUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GlobalSysVarUpdate.Merge(m, src)
}
func (m *GlobalSysVarUpdate) XXX_Size() int {
	return m.ProtoSize()
}
func (m *GlobalSysVarUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_GlobalSysVarUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_GlobalSysVarUpdate proto.InternalMessageInfo

func (m *GlobalSysVarUpdate) GetType() GlobalSysVarUpdateType {
	if m != nil {
		return m.Type
	}
	return BeginGlobalSysVarUpdate
}

func (m *GlobalSysVarUpdate) GetMembershipRevision() uint64 {
	if m != nil {
		return m.MembershipRevision
	}
	return 0
}

func (m *GlobalSysVarUpdate) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
func (m *GlobalSysVarUpdate) GetCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.CommitTS
	}
	return timestamp.Timestamp{}
...
func (m *GlobalSysVarUpdate) GetMinProtocolVersion() int64 {
	if m != nil {
...
type CommandBatch struct {
	...
	// GlobalSysVarCommitTS is the desired cluster-wide visibility watermark.
	GlobalSysVarCommitTS           timestamp.Timestamp `protobuf:"bytes,5,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarMinProtocolVersion int64               `protobuf:"varint,6,opt,name=GlobalSysVarMinProtocolVersion,proto3" json:"GlobalSysVarMinProtocolVersion,omitempty"`
	XXX_NoUnkeyedLiteral           struct{}            `json:"-"`
	XXX_unrecognized               []byte              `json:"-"`
	XXX_sizecache                  int32               `json:"-"`
}
...
func (m *CommandBatch) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *CommandBatch) GetGlobalSysVarMinProtocolVersion() int64 {
	if m != nil {
		return m.GlobalSysVarMinProtocolVersion
	}
	return 0
}
...
type CNStoreInfo struct {
	...
	GlobalSysVarCommitTS             timestamp.Timestamp `protobuf:"bytes,19,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarGeneration           string              `protobuf:"bytes,20,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	ProtocolVersion                  int64               `protobuf:"varint,21,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	GlobalSysVarProgressTimeoutNanos int64               `protobuf:"varint,22,opt,name=GlobalSysVarProgressTimeoutNanos,proto3" json:"GlobalSysVarProgressTimeoutNanos,omitempty"`
	XXX_NoUnkeyedLiteral             struct{}            `json:"-"`
	XXX_unrecognized                 []byte              `json:"-"`
	XXX_sizecache                    int32               `json:"-"`
}
...
func (m *CNStoreInfo) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *CNStoreInfo) GetGlobalSysVarGeneration() string {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return ""
...
func (m *CNStoreInfo) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
func (m *CNStoreInfo) GetGlobalSysVarProgressTimeoutNanos() int64 {
	if m != nil {
		return m.GlobalSysVarProgressTimeoutNanos
	}
	return 0
...
type CNState struct {
	...
	// GlobalSysVarCommitTS is the durable admission watermark for routable CNs.
	GlobalSysVarCommitTS            timestamp.Timestamp `protobuf:"bytes,2,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarMinProtocolVersion  int64               `protobuf:"varint,3,opt,name=GlobalSysVarMinProtocolVersion,proto3" json:"GlobalSysVarMinProtocolVersion,omitempty"`
	GlobalSysVarMembershipRevision  uint64              `protobuf:"varint,4,opt,name=GlobalSysVarMembershipRevision,proto3" json:"GlobalSysVarMembershipRevision,omitempty"`
	GlobalSysVarPendingGeneration   uint64              `protobuf:"varint,5,opt,name=GlobalSysVarPendingGeneration,proto3" json:"GlobalSysVarPendingGeneration,omitempty"`
	GlobalSysVarCompletedGeneration uint64              `protobuf:"varint,6,opt,name=GlobalSysVarCompletedGeneration,proto3" json:"GlobalSysVarCompletedGeneration,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}            `json:"-"`
	XXX_unrecognized                []byte              `json:"-"`
	XXX_sizecache                   int32               `json:"-"`
}
...
func (m *CNState) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *CNState) GetGlobalSysVarMinProtocolVersion() int64 {
	if m != nil {
		return m.GlobalSysVarMinProtocolVersion
	}
	return 0
...
func (m *CNState) GetGlobalSysVarMembershipRevision() uint64 {
	if m != nil {
		return m.GlobalSysVarMembershipRevision
	}
	return 0
}

func (m *CNState) GetGlobalSysVarPendingGeneration() uint64 {
	if m != nil {
		return m.GlobalSysVarPendingGeneration
	}
	return 0
}

func (m *CNState) GetGlobalSysVarCompletedGeneration() uint64 {
	if m != nil {
		return m.GlobalSysVarCompletedGeneration
	}
	return 0
}
...
type ProxyStore struct {
	...
	GlobalSysVarCommitTS             timestamp.Timestamp `protobuf:"bytes,5,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarGeneration           string              `protobuf:"bytes,6,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	State                            NodeState           `protobuf:"varint,7,opt,name=State,proto3,enum=logservice.NodeState" json:"State,omitempty"`
	ProtocolVersion                  int64               `protobuf:"varint,8,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	GlobalSysVarProgressTimeoutNanos int64               `protobuf:"varint,9,opt,name=GlobalSysVarProgressTimeoutNanos,proto3" json:"GlobalSysVarProgressTimeoutNanos,omitempty"`
	XXX_NoUnkeyedLiteral             struct{}            `json:"-"`
	XXX_unrecognized                 []byte              `json:"-"`
	XXX_sizecache                    int32               `json:"-"`
}
...
func (m *ProxyStore) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *ProxyStore) GetGlobalSysVarGeneration() string {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return ""
...
func (m *ProxyStore) GetState() NodeState {
	if m != nil {
		return m.State
	}
	return NormalState
...
func (m *ProxyStore) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
func (m *ProxyStore) GetGlobalSysVarProgressTimeoutNanos() int64 {
	if m != nil {
		return m.GlobalSysVarProgressTimeoutNanos
	}
	return 0
...
type ProxyHeartbeat struct {
	...
	GlobalSysVarCommitTS             timestamp.Timestamp `protobuf:"bytes,4,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarGeneration           string              `protobuf:"bytes,5,opt,name=GlobalSysVarGeneration,proto3" json:"GlobalSysVarGeneration,omitempty"`
	ProtocolVersion                  int64               `protobuf:"varint,6,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
	GlobalSysVarProgressTimeoutNanos int64               `protobuf:"varint,7,opt,name=GlobalSysVarProgressTimeoutNanos,proto3" json:"GlobalSysVarProgressTimeoutNanos,omitempty"`
	XXX_NoUnkeyedLiteral             struct{}            `json:"-"`
	XXX_unrecognized                 []byte              `json:"-"`
	XXX_sizecache                    int32               `json:"-"`
}
...
func (m *ProxyHeartbeat) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *ProxyHeartbeat) GetGlobalSysVarGeneration() string {
	if m != nil {
		return m.GlobalSysVarGeneration
	}
	return ""
...
func (m *ProxyHeartbeat) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
func (m *ProxyHeartbeat) GetGlobalSysVarProgressTimeoutNanos() int64 {
	if m != nil {
		return m.GlobalSysVarProgressTimeoutNanos
	}
	return 0
...
type ClusterDetails struct {
	...
	GlobalSysVarCommitTS            timestamp.Timestamp `protobuf:"bytes,6,opt,name=GlobalSysVarCommitTS,proto3" json:"GlobalSysVarCommitTS"`
	GlobalSysVarMinProtocolVersion  int64               `protobuf:"varint,7,opt,name=GlobalSysVarMinProtocolVersion,proto3" json:"GlobalSysVarMinProtocolVersion,omitempty"`
	GlobalSysVarMembershipRevision  uint64              `protobuf:"varint,8,opt,name=GlobalSysVarMembershipRevision,proto3" json:"GlobalSysVarMembershipRevision,omitempty"`
	GlobalSysVarPendingGeneration   uint64              `protobuf:"varint,9,opt,name=GlobalSysVarPendingGeneration,proto3" json:"GlobalSysVarPendingGeneration,omitempty"`
	GlobalSysVarCompletedGeneration uint64              `protobuf:"varint,10,opt,name=GlobalSysVarCompletedGeneration,proto3" json:"GlobalSysVarCompletedGeneration,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}            `json:"-"`
	XXX_unrecognized                []byte              `json:"-"`
	XXX_sizecache                   int32               `json:"-"`
}
...
func (m *ClusterDetails) GetGlobalSysVarCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.GlobalSysVarCommitTS
	}
	return timestamp.Timestamp{}
...
func (m *ClusterDetails) GetGlobalSysVarMinProtocolVersion() int64 {
	if m != nil {
		return m.GlobalSysVarMinProtocolVersion
	}
	return 0
...
func (m *ClusterDetails) GetGlobalSysVarMembershipRevision() uint64 {
	if m != nil {
		return m.GlobalSysVarMembershipRevision
	}
	return 0
...
func (m *ClusterDetails) GetGlobalSysVarPendingGeneration() uint64 {
	if m != nil {
		return m.GlobalSysVarPendingGeneration
	}
	return 0
...
func (m *ClusterDetails) GetGlobalSysVarCompletedGeneration() uint64 {
	if m != nil {
		return m.GlobalSysVarCompletedGeneration
	}
	return 0
...
func (m *LogStoreInfo) GetProtocolVersion() int64 {
	if m != nil {
		return m.ProtocolVersion
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("logservice.GlobalSysVarUpdateType", GlobalSysVarUpdateType_name, GlobalSysVarUpdateType_value)
	...
	proto.RegisterType((*GlobalSysVarUpdate)(nil), "logservice.GlobalSysVarUpdate")
...
var fileDescriptor_fd1040c5381ab5a7 = []byte{
	...
	,
}
...
func (m *CNStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GlobalSysVarProgressTimeoutNanos != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarProgressTimeoutNanos))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if m.ProtocolVersion != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.ProtocolVersion))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	}
	if len(m.GlobalSysVarGeneration) > 0 {
		i -= len(m.GlobalSysVarGeneration)
		copy(dAtA[i:], m.GlobalSysVarGeneration)
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.GlobalSysVarGeneration)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	{
		size, err := m.GlobalSysVarCommitTS.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GlobalSysVarUpdate != nil {
		{
			size, err := m.GlobalSysVarUpdate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GlobalSysVarGeneration != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarGeneration))
		i--
		dAtA[i] = 0x68
	}
...
func (m *GlobalSysVarUpdate) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GlobalSysVarUpdate) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSysVarUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MinProtocolVersion != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.MinProtocolVersion))
		i--
		dAtA[i] = 0x28
	}
	{
	...
	if m.MembershipRevision != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.MembershipRevision))
		i--
		dAtA[i] = 0x10
	}
	if m.Type != 0 {
...
func (m *CommandBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GlobalSysVarMinProtocolVersion != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarMinProtocolVersion))
		i--
		dAtA[i] = 0x30
	}
	{
...
func (m *CNState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GlobalSysVarCompletedGeneration != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarCompletedGeneration))
		i--
		dAtA[i] = 0x30
	}
	if m.GlobalSysVarPendingGeneration != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarPendingGeneration))
		i--
		dAtA[i] = 0x28
	}
	if m.GlobalSysVarMembershipRevision != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.GlobalSysVarMembershipRevision))
		i--
		dAtA[i] = 0x20
	}
	if m.GlobalSysVarMinProtocolVersion != 0 {
...
func (m *CNStore) ProtoSize() (n int) {
	...
	l = m.GlobalSysVarCommitTS.ProtoSize()
	n += 2 + l + sovLogservice(uint64(l))
	l = len(m.GlobalSysVarGeneration)
	if l > 0 {
		n += 2 + l + sovLogservice(uint64(l))
	}
	if m.ProtocolVersion != 0 {
		n += 2 + sovLogservice(uint64(m.ProtocolVersion))
	}
	if m.GlobalSysVarProgressTimeoutNanos != 0 {
		n += 2 + sovLogservice(uint64(m.GlobalSysVarProgressTimeoutNanos))
	}
	if m.XXX_unrecognized != nil {
...
func (m *LogStore) ProtoSize() (n int) {
	...
	n += 1 + l + sovLogservice(uint64(l))
	if m.ProtocolVersion != 0 {
		n += 1 + sovLogservice(uint64(m.ProtocolVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Request) ProtoSize() (n int) {
	...
	n += 2 + l + sovLogservice(uint64(l))
	if m.GlobalSysVarUpdate != nil {
		l = m.GlobalSysVarUpdate.ProtoSize()
		n += 2 + l + sovLogservice(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *Response) ProtoSize() (n int) {
	...
	if m.GlobalSysVarGeneration != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarGeneration))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *GlobalSysVarUpdate) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MembershipRevision != 0 {
		n += 1 + sovLogservice(uint64(m.MembershipRevision))
	}
	if m.Generation != 0 {
	...
	n += 1 + l + sovLogservice(uint64(l))
	if m.MinProtocolVersion != 0 {
		n += 1 + sovLogservice(uint64(m.MinProtocolVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CommandBatch) ProtoSize() (n int) {
	...
	n += 1 + l + sovLogservice(uint64(l))
	if m.GlobalSysVarMinProtocolVersion != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarMinProtocolVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CNState) ProtoSize() (n int) {
	...
	if m.GlobalSysVarMembershipRevision != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarMembershipRevision))
	}
	if m.GlobalSysVarPendingGeneration != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarPendingGeneration))
	}
	if m.GlobalSysVarCompletedGeneration != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarCompletedGeneration))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ProxyStore) ProtoSize() (n int) {
	...
	if m.GlobalSysVarProgressTimeoutNanos != 0 {
		n += 1 + sovLogservice(uint64(m.GlobalSysVarProgressTimeoutNanos))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CNStore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarCommitTS", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GlobalSysVarCommitTS.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarGeneration", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.GlobalSysVarGeneration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 19:
			if wireType != 0 {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarProgressTimeoutNanos", wireType)
			}
			m.GlobalSysVarProgressTimeoutNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarProgressTimeoutNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GlobalSysVarUpdate == nil {
				m.GlobalSysVarUpdate = &GlobalSysVarUpdate{}
			}
			if err := m.GlobalSysVarUpdate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarGeneration |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GlobalSysVarUpdate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GlobalSysVarUpdate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GlobalSysVarUpdate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= GlobalSysVarUpdateType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MembershipRevision", wireType)
			}
			m.MembershipRevision = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MembershipRevision |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinProtocolVersion |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CommandBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarMinProtocolVersion", wireType)
			}
			m.GlobalSysVarMinProtocolVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarMinProtocolVersion |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CNState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarMembershipRevision", wireType)
			}
			m.GlobalSysVarMembershipRevision = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarMembershipRevision |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarPendingGeneration", wireType)
			}
			m.GlobalSysVarPendingGeneration = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarPendingGeneration |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSysVarCompletedGeneration", wireType)
			}
			m.GlobalSysVarCompletedGeneration = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSysVarCompletedGeneration |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
