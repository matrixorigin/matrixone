...
type CNStore struct {
	...
	// DDLVisibilityBarrierReady means QueryService can accept the versioned DDL
	// visibility fence even when public SQL ingress is not admitted yet.
	DDLVisibilityBarrierReady bool `protobuf:"varint,21,opt,name=DDLVisibilityBarrierReady,proto3" json:"DDLVisibilityBarrierReady,omitempty"`
	// ViewMetadataIngressReady is retained for raw control-plane inventory.
	ViewMetadataIngressReady        bool                `protobuf:"varint,22,opt,name=ViewMetadataIngressReady,proto3" json:"ViewMetadataIngressReady,omitempty"`
	DDLVisibilityDeployedProtocol   int64               `protobuf:"varint,23,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	DDLVisibilityActivationPrepared bool                `protobuf:"varint,24,opt,name=DDLVisibilityActivationPrepared,proto3" json:"DDLVisibilityActivationPrepared,omitempty"`
	DDLVisibilityActivationFenced   bool                `protobuf:"varint,25,opt,name=DDLVisibilityActivationFenced,proto3" json:"DDLVisibilityActivationFenced,omitempty"`
	DDLVisibilityFrontier           timestamp.Timestamp `protobuf:"bytes,26,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier"`
...
func (m *CNStore) GetDDLVisibilityBarrierReady() bool {
	if m != nil {
...
func (m *CNStore) GetViewMetadataIngressReady() bool {
	if m != nil {
...
func (m *CNStore) GetDDLVisibilityActivationPrepared() bool {
	if m != nil {
...
func (m *CNStore) GetDDLVisibilityActivationFenced() bool {
	if m != nil {
...
func (m *CNStore) GetDDLVisibilityFrontier() timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
...
type LogStore struct {
	...
	// DDLVisibilityDeployedProtocolSupported proves the hosted HAKeeper RSM can
	// persist and return the cluster-wide DDL deployment epoch.
	DDLVisibilityDeployedProtocolSupported bool     `protobuf:"varint,8,opt,name=DDLVisibilityDeployedProtocolSupported,proto3" json:"DDLVisibilityDeployedProtocolSupported,omitempty"`
	XXX_NoUnkeyedLiteral                   struct{} `json:"-"`
	XXX_unrecognized                       []byte   `json:"-"`
	XXX_sizecache                          int32    `json:"-"`
}
...
func (m *LogStore) GetDDLVisibilityDeployedProtocolSupported() bool {
	if m != nil {
		return m.DDLVisibilityDeployedProtocolSupported
	}
	return false
}
...
type DDLVisibilityActivationTarget struct {
	ServiceID            string   `protobuf:"bytes,1,opt,name=ServiceID,proto3" json:"ServiceID,omitempty"`
	Generation           uint64   `protobuf:"varint,2,opt,name=Generation,proto3" json:"Generation,omitempty"`
	QueryAddress         string   `protobuf:"bytes,3,opt,name=QueryAddress,proto3" json:"QueryAddress,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DDLVisibilityActivationTarget) Reset()         { *m = DDLVisibilityActivationTarget{} }
func (m *DDLVisibilityActivationTarget) String() string { return proto.CompactTextString(m) }
func (*DDLVisibilityActivationTarget) ProtoMessage()    {}
func (*DDLVisibilityActivationTarget) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{6}
}
func (m *DDLVisibilityActivationTarget) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DDLVisibilityActivationTarget) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DDLVisibilityActivationTarget.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DDLVisibilityActivationTarget) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DDLVisibilityActivationTarget.Merge(m, src)
}
func (m *DDLVisibilityActivationTarget) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DDLVisibilityActivationTarget) XXX_DiscardUnknown() {
	xxx_messageInfo_DDLVisibilityActivationTarget.DiscardUnknown(m)
}

var xxx_messageInfo_DDLVisibilityActivationTarget proto.InternalMessageInfo

func (m *DDLVisibilityActivationTarget) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *DDLVisibilityActivationTarget) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
func (m *DDLVisibilityActivationTarget) GetQueryAddress() string {
	if m != nil {
		return m.QueryAddress
	}
	return ""
...
type CNStoreHeartbeat struct {
	...
	DDLVisibilityBarrierReady bool `protobuf:"varint,25,opt,name=DDLVisibilityBarrierReady,proto3" json:"DDLVisibilityBarrierReady,omitempty"`
	// DDLVisibilityDeployedProtocol reports only a locally committed deployment
	// marker. Provisional activation must never advance the cluster-wide epoch.
	DDLVisibilityDeployedProtocol int64 `protobuf:"varint,26,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	// Non-empty only for the transition that atomically validates the complete
	// CN membership tuple set and commits DDLVisibilityDeployedProtocol.
	DDLVisibilityEpochCommitTargets []DDLVisibilityActivationTarget `protobuf:"bytes,27,rep,name=DDLVisibilityEpochCommitTargets,proto3" json:"DDLVisibilityEpochCommitTargets"`
	DDLVisibilityActivationPrepared bool                            `protobuf:"varint,28,opt,name=DDLVisibilityActivationPrepared,proto3" json:"DDLVisibilityActivationPrepared,omitempty"`
	DDLVisibilityActivationFenced   bool                            `protobuf:"varint,29,opt,name=DDLVisibilityActivationFenced,proto3" json:"DDLVisibilityActivationFenced,omitempty"`
	DDLVisibilityFrontier           timestamp.Timestamp             `protobuf:"bytes,30,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier"`
	XXX_NoUnkeyedLiteral            struct{}                        `json:"-"`
	XXX_unrecognized                []byte                          `json:"-"`
	XXX_sizecache                   int32                           `json:"-"`
}
...
func (m *CNStoreHeartbeat) GetDDLVisibilityBarrierReady() bool {
	if m != nil {
		return m.DDLVisibilityBarrierReady
	}
	return false
...
func (m *CNStoreHeartbeat) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
...
func (m *CNStoreHeartbeat) GetDDLVisibilityEpochCommitTargets() []DDLVisibilityActivationTarget {
	if m != nil {
...
func (m *CNStoreHeartbeat) GetDDLVisibilityActivationPrepared() bool {
	if m != nil {
		return m.DDLVisibilityActivationPrepared
	}
	return false
...
func (m *CNStoreHeartbeat) GetDDLVisibilityActivationFenced() bool {
	if m != nil {
		return m.DDLVisibilityActivationFenced
	}
	return false
...
func (m *CNStoreHeartbeat) GetDDLVisibilityFrontier() timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
	return timestamp.Timestamp{}
...
type LogStoreHeartbeat struct {
	...
	// This gates the HAKeeper RSM schema used by the durable DDL deployment
	// epoch across both voting and non-voting replicas.
	DDLVisibilityDeployedProtocolSupported bool     `protobuf:"varint,12,opt,name=DDLVisibilityDeployedProtocolSupported,proto3" json:"DDLVisibilityDeployedProtocolSupported,omitempty"`
	XXX_NoUnkeyedLiteral                   struct{} `json:"-"`
	XXX_unrecognized                       []byte   `json:"-"`
	XXX_sizecache                          int32    `json:"-"`
}
...
func (m *LogStoreHeartbeat) GetDDLVisibilityDeployedProtocolSupported() bool {
	if m != nil {
		return m.DDLVisibilityDeployedProtocolSupported
	}
	return false
...
type CommandBatch struct {
	...
	// DDLVisibilityDeployedProtocol is returned from the same replicated
	// heartbeat transition that conditionally publishes CN ingress.
	DDLVisibilityDeployedProtocol int64 `protobuf:"varint,6,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	// DDLVisibilityFrontier is the durable cluster maximum after applying this
	// heartbeat transition. New CNs require it as publication acknowledgement.
	DDLVisibilityFrontier *timestamp.Timestamp `protobuf:"bytes,7,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}             `json:"-"`
	XXX_unrecognized      []byte               `json:"-"`
	XXX_sizecache         int32                `json:"-"`
}
...
func (m *CommandBatch) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
...
func (m *CommandBatch) GetDDLVisibilityFrontier() *timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
	return nil
...
type CNStoreInfo struct {
	...
	DDLVisibilityBarrierReady       bool                `protobuf:"varint,27,opt,name=DDLVisibilityBarrierReady,proto3" json:"DDLVisibilityBarrierReady,omitempty"`
	DDLVisibilityDeployedProtocol   int64               `protobuf:"varint,28,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	DDLVisibilityActivationPrepared bool                `protobuf:"varint,29,opt,name=DDLVisibilityActivationPrepared,proto3" json:"DDLVisibilityActivationPrepared,omitempty"`
	DDLVisibilityActivationFenced   bool                `protobuf:"varint,30,opt,name=DDLVisibilityActivationFenced,proto3" json:"DDLVisibilityActivationFenced,omitempty"`
	DDLVisibilityFrontier           timestamp.Timestamp `protobuf:"bytes,31,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier"`
	XXX_NoUnkeyedLiteral            struct{}            `json:"-"`
	XXX_unrecognized                []byte              `json:"-"`
	XXX_sizecache                   int32               `json:"-"`
}
...
func (m *CNStoreInfo) GetDDLVisibilityBarrierReady() bool {
	if m != nil {
		return m.DDLVisibilityBarrierReady
	}
	return false
...
func (m *CNStoreInfo) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
...
func (m *CNStoreInfo) GetDDLVisibilityActivationPrepared() bool {
	if m != nil {
		return m.DDLVisibilityActivationPrepared
	}
	return false
...
func (m *CNStoreInfo) GetDDLVisibilityActivationFenced() bool {
	if m != nil {
		return m.DDLVisibilityActivationFenced
	}
	return false
...
func (m *CNStoreInfo) GetDDLVisibilityFrontier() timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
	return timestamp.Timestamp{}
...
type CNState struct {
	...
	// DDLVisibilityDeployedProtocol is a monotonic cluster deployment epoch.
	// Once a complete-target cut commits, markerless replacement/scale-out CNs
	// must join that fence instead of reopening on an older protocol.
	DDLVisibilityDeployedProtocol int64 `protobuf:"varint,2,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	// DDLVisibilityFrontier is the monotonic cluster-lifetime maximum committed
	// DDL timestamp. It survives CN restart, replacement, and store removal.
	DDLVisibilityFrontier timestamp.Timestamp `protobuf:"bytes,3,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier"`
	XXX_NoUnkeyedLiteral  struct{}            `json:"-"`
	XXX_unrecognized      []byte              `json:"-"`
	XXX_sizecache         int32               `json:"-"`
}
...
func (m *CNState) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
...
func (m *CNState) GetDDLVisibilityFrontier() timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
	return timestamp.Timestamp{}
...
type ClusterDetails struct {
	...
	DDLVisibilityDeployedProtocol int64                  `protobuf:"varint,7,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	DDLVisibilityFrontier         timestamp.Timestamp    `protobuf:"bytes,8,opt,name=DDLVisibilityFrontier,proto3" json:"DDLVisibilityFrontier"`
	XXX_NoUnkeyedLiteral          struct{}               `json:"-"`
	XXX_unrecognized              []byte                 `json:"-"`
	XXX_sizecache                 int32                  `json:"-"`
}
...
func (m *ClusterDetails) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
...
func (m *ClusterDetails) GetDDLVisibilityFrontier() timestamp.Timestamp {
	if m != nil {
		return m.DDLVisibilityFrontier
	}
	return timestamp.Timestamp{}
...
func (m *LogStoreInfo) GetDDLVisibilityDeployedProtocolSupported() bool {
	if m != nil {
		return m.DDLVisibilityDeployedProtocolSupported
	}
	return false
...
func init() {
	...
	proto.RegisterType((*DDLVisibilityActivationTarget)(nil), "logservice.DDLVisibilityActivationTarget")
...
var fileDescriptor_fd1040c5381ab5a7 = []byte{
	...
	,
}
...
func (m *CNStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.DDLVisibilityFrontier.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.DDLVisibilityDeployedProtocol != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.DDLVisibilityDeployedProtocol))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
...
func (m *LogStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DDLVisibilityDeployedProtocolSupported {
		i--
		if m.DDLVisibilityDeployedProtocolSupported {
			dAtA[i] = 1
		} else {
...
func (m *DDLVisibilityActivationTarget) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DDLVisibilityActivationTarget) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DDLVisibilityActivationTarget) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ServiceID) > 0 {
		...
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.ServiceID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CNStoreHeartbeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DDLVisibilityEpochCommitTargets) > 0 {
		for iNdEx := len(m.DDLVisibilityEpochCommitTargets) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DDLVisibilityEpochCommitTargets[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CommandBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DDLVisibilityFrontier != nil {
		{
			size, err := m.DDLVisibilityFrontier.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
...
func (m *CNStore) ProtoSize() (n int) {
	...
	if m.DDLVisibilityDeployedProtocol != 0 {
		n += 2 + sovLogservice(uint64(m.DDLVisibilityDeployedProtocol))
	}
	if m.DDLVisibilityActivationPrepared {
		n += 3
	}
	...
	l = m.DDLVisibilityFrontier.ProtoSize()
	n += 2 + l + sovLogservice(uint64(l))
	if m.XXX_unrecognized != nil {
...
func (m *DDLVisibilityActivationTarget) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CNStoreHeartbeat) ProtoSize() (n int) {
	...
	if len(m.DDLVisibilityEpochCommitTargets) > 0 {
		for _, e := range m.DDLVisibilityEpochCommitTargets {
			l = e.ProtoSize()
			n += 2 + l + sovLogservice(uint64(l))
		}
	}
...
func (m *CommandBatch) ProtoSize() (n int) {
	...
	if m.DDLVisibilityDeployedProtocol != 0 {
		n += 1 + sovLogservice(uint64(m.DDLVisibilityDeployedProtocol))
	}
	if m.DDLVisibilityFrontier != nil {
		l = m.DDLVisibilityFrontier.ProtoSize()
		n += 1 + l + sovLogservice(uint64(l))
...
func (m *CNStore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DDLVisibilityFrontier", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DDLVisibilityFrontier.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LogStore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DDLVisibilityDeployedProtocolSupported", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DDLVisibilityDeployedProtocolSupported = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipLogservice(dAtA[iNdEx:])
			if err != nil {
...
func (m *DDLVisibilityActivationTarget) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DDLVisibilityActivationTarget: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DDLVisibilityActivationTarget: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CNStoreHeartbeat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DDLVisibilityEpochCommitTargets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DDLVisibilityEpochCommitTargets = append(m.DDLVisibilityEpochCommitTargets, DDLVisibilityActivationTarget{})
			if err := m.DDLVisibilityEpochCommitTargets[len(m.DDLVisibilityEpochCommitTargets)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 28:
...
func (m *CommandBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.DDLVisibilityFrontier == nil {
				m.DDLVisibilityFrontier = &timestamp.Timestamp{}
			}
			if err := m.DDLVisibilityFrontier.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
