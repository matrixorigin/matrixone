...
type LogStoreHeartbeat struct {
	...
	// ViewMetadataRefreshSupported proves that every HAKeeper RSM hosted by this
	// LogStore understands refresh activation and its persistent state.
	ViewMetadataRefreshSupported bool     `protobuf:"varint,12,opt,name=ViewMetadataRefreshSupported,proto3" json:"ViewMetadataRefreshSupported,omitempty"`
	XXX_NoUnkeyedLiteral         struct{} `json:"-"`
	XXX_unrecognized             []byte   `json:"-"`
	XXX_sizecache                int32    `json:"-"`
}
...
func (m *LogStoreHeartbeat) GetViewMetadataRefreshSupported() bool {
	if m != nil {
		return m.ViewMetadataRefreshSupported
	}
	return false
...
type ViewMetadataAdmission struct {
	...
	// RefreshReady allows current-epoch workers to run only after every known CN
	// advertises lifecycle support. It does not authorize public metadata reads.
	RefreshReady bool `protobuf:"varint,9,opt,name=RefreshReady,proto3" json:"RefreshReady,omitempty"`
	// RefreshEnabled authorizes lifecycle maintenance and public metadata reads
	// after a durable revalidation completion for Epoch.
	RefreshEnabled bool `protobuf:"varint,10,opt,name=RefreshEnabled,proto3" json:"RefreshEnabled,omitempty"`
	// OwnerExpiryRemainingTicks is non-zero when this sender replaced a captured
	// same-UUID generation that must expire before admission. TickPerSecond
	// converts the replicated deadline into a local startup wait budget.
	OwnerExpiryRemainingTicks uint64 `protobuf:"varint,11,opt,name=OwnerExpiryRemainingTicks,proto3" json:"OwnerExpiryRemainingTicks,omitempty"`
	TickPerSecond             uint64 `protobuf:"varint,12,opt,name=TickPerSecond,proto3" json:"TickPerSecond,omitempty"`
	// AuthorityLeaseTicks is the replicated CN-store expiry basis. A supported
	// CN renews a local fail-closed timer from each successful heartbeat response.
	AuthorityLeaseTicks  uint64   `protobuf:"varint,13,opt,name=AuthorityLeaseTicks,proto3" json:"AuthorityLeaseTicks,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ViewMetadataAdmission) GetRefreshReady() bool {
	if m != nil {
		return m.RefreshReady
	}
	return false
}

func (m *ViewMetadataAdmission) GetRefreshEnabled() bool {
	if m != nil {
...
func (m *ViewMetadataAdmission) GetOwnerExpiryRemainingTicks() uint64 {
	if m != nil {
		return m.OwnerExpiryRemainingTicks
	}
	return 0
}

func (m *ViewMetadataAdmission) GetTickPerSecond() uint64 {
	if m != nil {
		return m.TickPerSecond
	}
	return 0
}

func (m *ViewMetadataAdmission) GetAuthorityLeaseTicks() uint64 {
	if m != nil {
		return m.AuthorityLeaseTicks
	}
	return 0
}
...
type ViewMetadataAdmissionTargets struct {
	...
	TickPerSecond          uint64   `protobuf:"varint,5,opt,name=TickPerSecond,proto3" json:"TickPerSecond,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (m *ViewMetadataAdmissionTargets) GetTickPerSecond() uint64 {
	if m != nil {
		return m.TickPerSecond
	}
	return 0
...
func (m *LogStoreInfo) GetViewMetadataRefreshSupported() bool {
	if m != nil {
		return m.ViewMetadataRefreshSupported
	}
	return false
...
type HAKeeperRSMState struct {
	...
	// ViewMetadataRefreshActivated is durable history. Once true, a later
	// lifecycle-unaware CN cannot be admitted during a required epoch.
	ViewMetadataRefreshActivated bool `protobuf:"varint,43,opt,name=ViewMetadataRefreshActivated,proto3" json:"ViewMetadataRefreshActivated,omitempty"`
	// Persist the timeout basis used by the replicated target-expiry decision so
	// heartbeat snapshots can expose the same authoritative replacement wait.
	ViewMetadataAdmissionCNStoreTimeoutTicks uint64   `protobuf:"varint,44,opt,name=ViewMetadataAdmissionCNStoreTimeoutTicks,proto3" json:"ViewMetadataAdmissionCNStoreTimeoutTicks,omitempty"`
	ViewMetadataAdmissionTickPerSecond       uint64   `protobuf:"varint,45,opt,name=ViewMetadataAdmissionTickPerSecond,proto3" json:"ViewMetadataAdmissionTickPerSecond,omitempty"`
	XXX_NoUnkeyedLiteral                     struct{} `json:"-"`
	XXX_unrecognized                         []byte   `json:"-"`
	XXX_sizecache                            int32    `json:"-"`
}
...
func (m *HAKeeperRSMState) GetViewMetadataRefreshActivated() bool {
	if m != nil {
		return m.ViewMetadataRefreshActivated
	}
	return false
}

func (m *HAKeeperRSMState) GetViewMetadataAdmissionCNStoreTimeoutTicks() uint64 {
	if m != nil {
		return m.ViewMetadataAdmissionCNStoreTimeoutTicks
	}
	return 0
}

func (m *HAKeeperRSMState) GetViewMetadataAdmissionTickPerSecond() uint64 {
	if m != nil {
		return m.ViewMetadataAdmissionTickPerSecond
	}
	return 0
}
...
var fileDescriptor_fd1040c5381ab5a7 = []byte{
	...
	,
}
...
func (m *ViewMetadataAdmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AuthorityLeaseTicks != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.AuthorityLeaseTicks))
		i--
		dAtA[i] = 0x68
	}
	if m.TickPerSecond != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.TickPerSecond))
		i--
		dAtA[i] = 0x60
	}
	if m.OwnerExpiryRemainingTicks != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.OwnerExpiryRemainingTicks))
		i--
		dAtA[i] = 0x58
	}
	if m.RefreshEnabled {
...
func (m *HAKeeperRSMState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ViewMetadataAdmissionTickPerSecond != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.ViewMetadataAdmissionTickPerSecond))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xe8
	}
	if m.ViewMetadataAdmissionCNStoreTimeoutTicks != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.ViewMetadataAdmissionCNStoreTimeoutTicks))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xe0
	}
	if m.ViewMetadataRefreshActivated {
		i--
		if m.ViewMetadataRefreshActivated {
			dAtA[i] = 1
		} else {
...
func (m *ViewMetadataAdmission) ProtoSize() (n int) {
	...
	if m.OwnerExpiryRemainingTicks != 0 {
		n += 1 + sovLogservice(uint64(m.OwnerExpiryRemainingTicks))
	}
	if m.TickPerSecond != 0 {
		n += 1 + sovLogservice(uint64(m.TickPerSecond))
	}
	if m.AuthorityLeaseTicks != 0 {
		n += 1 + sovLogservice(uint64(m.AuthorityLeaseTicks))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *HAKeeperRSMState) ProtoSize() (n int) {
	...
	if m.ViewMetadataAdmissionCNStoreTimeoutTicks != 0 {
		n += 2 + sovLogservice(uint64(m.ViewMetadataAdmissionCNStoreTimeoutTicks))
	}
	if m.ViewMetadataAdmissionTickPerSecond != 0 {
		n += 2 + sovLogservice(uint64(m.ViewMetadataAdmissionTickPerSecond))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ViewMetadataAdmission) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RefreshReady", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RefreshReady = bool(v != 0)
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RefreshEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RefreshEnabled = bool(v != 0)
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OwnerExpiryRemainingTicks", wireType)
			}
			m.OwnerExpiryRemainingTicks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OwnerExpiryRemainingTicks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TickPerSecond", wireType)
			}
			m.TickPerSecond = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TickPerSecond |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthorityLeaseTicks", wireType)
			}
			m.AuthorityLeaseTicks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AuthorityLeaseTicks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *HAKeeperRSMState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 43:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViewMetadataRefreshActivated", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ViewMetadataRefreshActivated = bool(v != 0)
		case 44:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViewMetadataAdmissionCNStoreTimeoutTicks", wireType)
			}
			m.ViewMetadataAdmissionCNStoreTimeoutTicks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ViewMetadataAdmissionCNStoreTimeoutTicks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 45:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViewMetadataAdmissionTickPerSecond", wireType)
			}
			m.ViewMetadataAdmissionTickPerSecond = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ViewMetadataAdmissionTickPerSecond |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
