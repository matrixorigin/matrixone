...
const (
	...
	// Internal replicated fence for the versioned unique-key codec. The
	// payload is a UniqueKeyCodecActivation and is never exposed as SQL.
	SetUniqueKeyCodecActivationUpdate HAKeeperUpdateType = 22
)
...
var HAKeeperUpdateType_name = map[int32]string{
	...
	22: "SetUniqueKeyCodecActivationUpdate",
}
...
var HAKeeperUpdateType_value = map[string]int32{
	...
	"SetUniqueKeyCodecActivationUpdate": 22,
}
...
type UniqueKeyCodecActivation_Phase int32

const (
	DISABLED  UniqueKeyCodecActivation_Phase = 0
	PREPARING UniqueKeyCodecActivation_Phase = 1
	ENABLED   UniqueKeyCodecActivation_Phase = 2
	ABORTED   UniqueKeyCodecActivation_Phase = 3
)

var UniqueKeyCodecActivation_Phase_name = map[int32]string{
	0: "DISABLED",
	1: "PREPARING",
	2: "ENABLED",
	3: "ABORTED",
...
var UniqueKeyCodecActivation_Phase_value = map[string]int32{
	"DISABLED":  0,
	"PREPARING": 1,
	"ENABLED":   2,
	"ABORTED":   3,
...
func (x UniqueKeyCodecActivation_Phase) String() string {
	return proto.EnumName(UniqueKeyCodecActivation_Phase_name, int32(x))
}

func (UniqueKeyCodecActivation_Phase) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{65, 0}
}

type UniqueKeyMigrationGate_Phase int32

const (
	MIGRATION_OPEN      UniqueKeyMigrationGate_Phase = 0
	MIGRATION_DRAINING  UniqueKeyMigrationGate_Phase = 1
	MIGRATION_EXCLUSIVE UniqueKeyMigrationGate_Phase = 2
	MIGRATION_PUBLISHED UniqueKeyMigrationGate_Phase = 3
	MIGRATION_ABORTED   UniqueKeyMigrationGate_Phase = 4
)

var UniqueKeyMigrationGate_Phase_name = map[int32]string{
	0: "MIGRATION_OPEN",
	1: "MIGRATION_DRAINING",
	2: "MIGRATION_EXCLUSIVE",
	3: "MIGRATION_PUBLISHED",
	4: "MIGRATION_ABORTED",
}

var UniqueKeyMigrationGate_Phase_value = map[string]int32{
	"MIGRATION_OPEN":      0,
	"MIGRATION_DRAINING":  1,
	"MIGRATION_EXCLUSIVE": 2,
	"MIGRATION_PUBLISHED": 3,
	"MIGRATION_ABORTED":   4,
}

func (x UniqueKeyMigrationGate_Phase) String() string {
	return proto.EnumName(UniqueKeyMigrationGate_Phase_name, int32(x))
}

func (UniqueKeyMigrationGate_Phase) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{66, 0}
}
...
type CNStoreHeartbeat struct {
	...
	UniqueKeyCodecCapability *UniqueKeyCodecCapability `protobuf:"bytes,25,opt,name=unique_key_codec_capability,json=uniqueKeyCodecCapability,proto3" json:"unique_key_codec_capability,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}                  `json:"-"`
	XXX_unrecognized         []byte                    `json:"-"`
	XXX_sizecache            int32                     `json:"-"`
}
...
func (m *CNStoreHeartbeat) GetUniqueKeyCodecCapability() *UniqueKeyCodecCapability {
	if m != nil {
		return m.UniqueKeyCodecCapability
	}
	return nil
}
...
type TNStoreHeartbeat struct {
	...
	UniqueKeyCodecCapability    *UniqueKeyCodecCapability `protobuf:"bytes,15,opt,name=unique_key_codec_capability,json=uniqueKeyCodecCapability,proto3" json:"unique_key_codec_capability,omitempty"`
	XXX_NoUnkeyedLiteral        struct{}                  `json:"-"`
	XXX_unrecognized            []byte                    `json:"-"`
	XXX_sizecache               int32                     `json:"-"`
}
...
func (m *TNStoreHeartbeat) GetUniqueKeyCodecCapability() *UniqueKeyCodecCapability {
	if m != nil {
		return m.UniqueKeyCodecCapability
	}
	return nil
...
type LogRequest struct {
	...
	ExcludeHardDownReplicaAddresses bool      `protobuf:"varint,9,opt,name=ExcludeHardDownReplicaAddresses,proto3" json:"ExcludeHardDownReplicaAddresses,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}  `json:"-"`
	XXX_unrecognized                []byte    `json:"-"`
	XXX_sizecache                   int32     `json:"-"`
}
...
func (m *LogRequest) GetExcludeHardDownReplicaAddresses() bool {
	if m != nil {
		return m.ExcludeHardDownReplicaAddresses
	}
	return false
}
...
type CNStoreInfo struct {
	...
	UniqueKeyCodecCapability        *UniqueKeyCodecCapability `protobuf:"bytes,27,opt,name=unique_key_codec_capability,json=uniqueKeyCodecCapability,proto3" json:"unique_key_codec_capability,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}                  `json:"-"`
	XXX_unrecognized                []byte                    `json:"-"`
	XXX_sizecache                   int32                     `json:"-"`
}
...
func (m *CNStoreInfo) GetUniqueKeyCodecCapability() *UniqueKeyCodecCapability {
	if m != nil {
		return m.UniqueKeyCodecCapability
	}
	return nil
...
type TNStoreInfo struct {
	...
	UniqueKeyCodecCapability    *UniqueKeyCodecCapability `protobuf:"bytes,14,opt,name=unique_key_codec_capability,json=uniqueKeyCodecCapability,proto3" json:"unique_key_codec_capability,omitempty"`
	XXX_NoUnkeyedLiteral        struct{}                  `json:"-"`
	XXX_unrecognized            []byte                    `json:"-"`
	XXX_sizecache               int32                     `json:"-"`
}
...
func (m *TNStoreInfo) GetUniqueKeyCodecCapability() *UniqueKeyCodecCapability {
	if m != nil {
		return m.UniqueKeyCodecCapability
	}
	return nil
...
type CheckerState struct {
	...
	UniqueKeyCodecActivation     *UniqueKeyCodecActivation         `protobuf:"bytes,19,opt,name=unique_key_codec_activation,json=uniqueKeyCodecActivation,proto3" json:"unique_key_codec_activation,omitempty"`
	UniqueKeyMigrationGates      map[uint64]UniqueKeyMigrationGate `protobuf:"bytes,20,rep,name=unique_key_migration_gates,json=uniqueKeyMigrationGates,proto3" json:"unique_key_migration_gates" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral         struct{}                          `json:"-"`
	XXX_unrecognized             []byte                            `json:"-"`
	XXX_sizecache                int32                             `json:"-"`
}
...
func (m *CheckerState) GetUniqueKeyCodecActivation() *UniqueKeyCodecActivation {
	if m != nil {
		return m.UniqueKeyCodecActivation
	}
	return nil
}

func (m *CheckerState) GetUniqueKeyMigrationGates() map[uint64]UniqueKeyMigrationGate {
	if m != nil {
		return m.UniqueKeyMigrationGates
	}
	return nil
}
...
type HAKeeperRSMState struct {
	...
	// UniqueKeyCodecActivation is the durable cluster-level fence for the
	// versioned unique-key codec.  It is kept in the RSM state so snapshots,
	// replay, backup and restore cannot lose an enabled generation.
	UniqueKeyCodecActivation *UniqueKeyCodecActivation `protobuf:"bytes,43,opt,name=UniqueKeyCodecActivation,proto3" json:"UniqueKeyCodecActivation,omitempty"`
	// UniqueKeyMigrationGates stores one durable stop-write/atomic-publication
	// gate per physical relation. It is intentionally separate from the
	// cluster codec activation: an enabled codec does not imply that a table
	// migration is in progress or that a published gate may be rolled back.
	UniqueKeyMigrationGates map[uint64]UniqueKeyMigrationGate `protobuf:"bytes,44,rep,name=UniqueKeyMigrationGates,proto3" json:"UniqueKeyMigrationGates" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral    struct{}                          `json:"-"`
	XXX_unrecognized        []byte                            `json:"-"`
	XXX_sizecache           int32                             `json:"-"`
}
...
func (m *HAKeeperRSMState) GetUniqueKeyCodecActivation() *UniqueKeyCodecActivation {
	if m != nil {
		return m.UniqueKeyCodecActivation
	}
	return nil
...
func (m *HAKeeperRSMState) GetUniqueKeyMigrationGates() map[uint64]UniqueKeyMigrationGate {
	if m != nil {
		return m.UniqueKeyMigrationGates
	}
	return nil
...
// UniqueKeyCodecCapability is a node-level capability, distinct from the
// relation-local UniqueKeyCodecVersion. Bit n in readable/writable_versions
// means that codec version n is supported by this node.
type UniqueKeyCodecCapability struct {
	ReadableVersions   uint32 `protobuf:"varint,1,opt,name=readable_versions,json=readableVersions,proto3" json:"readable_versions,omitempty"`
	WritableVersions   uint32 `protobuf:"varint,2,opt,name=writable_versions,json=writableVersions,proto3" json:"writable_versions,omitempty"`
	RegistryVersion    uint32 `protobuf:"varint,3,opt,name=registry_version,json=registryVersion,proto3" json:"registry_version,omitempty"`
	RegistryDigest     []byte `protobuf:"bytes,4,opt,name=registry_digest,json=registryDigest,proto3" json:"registry_digest,omitempty"`
	MaxEncodedKeyBytes uint32 `protobuf:"varint,5,opt,name=max_encoded_key_bytes,json=maxEncodedKeyBytes,proto3" json:"max_encoded_key_bytes,omitempty"`
	// Incarnation changes whenever a CN/TN process is replaced. It is matched
	// against the activation target map and is not part of the key codec.
...
func (m *UniqueKeyCodecCapability) Reset()         { *m = UniqueKeyCodecCapability{} }
func (m *UniqueKeyCodecCapability) String() string { return proto.CompactTextString(m) }
func (*UniqueKeyCodecCapability) ProtoMessage()    {}
func (*UniqueKeyCodecCapability) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{64}
}
func (m *UniqueKeyCodecCapability) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UniqueKeyCodecCapability) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UniqueKeyCodecCapability.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UniqueKeyCodecCapability) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UniqueKeyCodecCapability.Merge(m, src)
}
func (m *UniqueKeyCodecCapability) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UniqueKeyCodecCapability) XXX_DiscardUnknown() {
	xxx_messageInfo_UniqueKeyCodecCapability.DiscardUnknown(m)
}

var xxx_messageInfo_UniqueKeyCodecCapability proto.InternalMessageInfo

func (m *UniqueKeyCodecCapability) GetReadableVersions() uint32 {
	if m != nil {
		return m.ReadableVersions
	}
	return 0
}

func (m *UniqueKeyCodecCapability) GetWritableVersions() uint32 {
	if m != nil {
		return m.WritableVersions
	}
	return 0
}

func (m *UniqueKeyCodecCapability) GetRegistryVersion() uint32 {
	if m != nil {
...
func (m *UniqueKeyCodecCapability) GetRegistryDigest() []byte {
	if m != nil {
		return m.RegistryDigest
	}
	return nil
}

func (m *UniqueKeyCodecCapability) GetMaxEncodedKeyBytes() uint32 {
	if m != nil {
		return m.MaxEncodedKeyBytes
	}
	return 0
}

func (m *UniqueKeyCodecCapability) GetIncarnation() uint64 {
	if m != nil {
...
// UniqueKeyCodecActivation is the replicated cluster fence for enabling a
// codec. It is persisted by the HAKeeper and acknowledged by CN/TN heartbeats.
type UniqueKeyCodecActivation struct {
	RequestedVersion     uint32                         `protobuf:"varint,1,opt,name=requested_version,json=requestedVersion,proto3" json:"requested_version,omitempty"`
	RegistryVersion      uint32                         `protobuf:"varint,2,opt,name=registry_version,json=registryVersion,proto3" json:"registry_version,omitempty"`
	RegistryDigest       []byte                         `protobuf:"bytes,3,opt,name=registry_digest,json=registryDigest,proto3" json:"registry_digest,omitempty"`
	Generation           uint64                         `protobuf:"varint,4,opt,name=generation,proto3" json:"generation,omitempty"`
	Phase                UniqueKeyCodecActivation_Phase `protobuf:"varint,5,opt,name=phase,proto3,enum=logservice.UniqueKeyCodecActivation_Phase" json:"phase,omitempty"`
	CnTargets            map[string]uint64              `protobuf:"bytes,6,rep,name=cn_targets,json=cnTargets,proto3" json:"cn_targets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	TnTargets            map[string]uint64              `protobuf:"bytes,7,rep,name=tn_targets,json=tnTargets,proto3" json:"tn_targets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}

func (m *UniqueKeyCodecActivation) Reset()         { *m = UniqueKeyCodecActivation{} }
func (m *UniqueKeyCodecActivation) String() string { return proto.CompactTextString(m) }
func (*UniqueKeyCodecActivation) ProtoMessage()    {}
func (*UniqueKeyCodecActivation) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{65}
}
func (m *UniqueKeyCodecActivation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UniqueKeyCodecActivation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UniqueKeyCodecActivation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UniqueKeyCodecActivation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UniqueKeyCodecActivation.Merge(m, src)
}
func (m *UniqueKeyCodecActivation) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UniqueKeyCodecActivation) XXX_DiscardUnknown() {
	xxx_messageInfo_UniqueKeyCodecActivation.DiscardUnknown(m)
}

var xxx_messageInfo_UniqueKeyCodecActivation proto.InternalMessageInfo

func (m *UniqueKeyCodecActivation) GetRequestedVersion() uint32 {
	if m != nil {
...
func (m *UniqueKeyCodecActivation) GetRegistryVersion() uint32 {
	if m != nil {
		return m.RegistryVersion
	}
	return 0
...
func (m *UniqueKeyCodecActivation) GetRegistryDigest() []byte {
	if m != nil {
		return m.RegistryDigest
	}
	return nil
...
func (m *UniqueKeyCodecActivation) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
func (m *UniqueKeyCodecActivation) GetPhase() UniqueKeyCodecActivation_Phase {
	if m != nil {
		return m.Phase
	}
	return DISABLED
...
func (m *UniqueKeyCodecActivation) GetCnTargets() map[string]uint64 {
	if m != nil {
		return m.CnTargets
	}
	return nil
...
func (m *UniqueKeyCodecActivation) GetTnTargets() map[string]uint64 {
	if m != nil {
		return m.TnTargets
	}
	return nil
...
// UniqueKeyMigrationGate is the typed replicated form of the common
// collationkey.MigrationGate contract.  The gate is persisted before any
// catalog relation switch so recovery can distinguish an old live relation,
// an in-flight temporary relation, and an already-published irreversible
// generation. Map values are node/permit incarnations or admission epochs;
// they are not wall-clock timestamps.
type UniqueKeyMigrationGate struct {
	RelationId           uint64                       `protobuf:"varint,1,opt,name=relation_id,json=relationId,proto3" json:"relation_id,omitempty"`
	MigrationEpoch       uint64                       `protobuf:"varint,2,opt,name=migration_epoch,json=migrationEpoch,proto3" json:"migration_epoch,omitempty"`
	OwnerId              string                       `protobuf:"bytes,3,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`
	OwnerIncarnation     uint64                       `protobuf:"varint,4,opt,name=owner_incarnation,json=ownerIncarnation,proto3" json:"owner_incarnation,omitempty"`
	ClaimToken           []byte                       `protobuf:"bytes,5,opt,name=claim_token,json=claimToken,proto3" json:"claim_token,omitempty"`
	Phase                UniqueKeyMigrationGate_Phase `protobuf:"varint,6,opt,name=phase,proto3,enum=logservice.UniqueKeyMigrationGate_Phase" json:"phase,omitempty"`
	PhaseDeadlineNanos   int64                        `protobuf:"varint,7,opt,name=phase_deadline_nanos,json=phaseDeadlineNanos,proto3" json:"phase_deadline_nanos,omitempty"`
	SourceSchemaEpoch    uint64                       `protobuf:"varint,8,opt,name=source_schema_epoch,json=sourceSchemaEpoch,proto3" json:"source_schema_epoch,omitempty"`
	SourceSnapshotId     uint64                       `protobuf:"varint,9,opt,name=source_snapshot_id,json=sourceSnapshotId,proto3" json:"source_snapshot_id,omitempty"`
	TempRelationId       uint64                       `protobuf:"varint,10,opt,name=temp_relation_id,json=tempRelationId,proto3" json:"temp_relation_id,omitempty"`
	PublicationTxnId     uint64                       `protobuf:"varint,11,opt,name=publication_txn_id,json=publicationTxnId,proto3" json:"publication_txn_id,omitempty"`
	ReplayGeneration     uint64                       `protobuf:"varint,12,opt,name=replay_generation,json=replayGeneration,proto3" json:"replay_generation,omitempty"`
	WritePermits         map[string]uint64            `protobuf:"bytes,13,rep,name=write_permits,json=writePermits,proto3" json:"write_permits,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ReplayTargets        map[string]uint64            `protobuf:"bytes,14,rep,name=replay_targets,json=replayTargets,proto3" json:"replay_targets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ReplayAcknowledged   map[string]uint64            `protobuf:"bytes,15,rep,name=replay_acknowledged,json=replayAcknowledged,proto3" json:"replay_acknowledged,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	RetiredReplayTarget  map[string]uint64            `protobuf:"bytes,16,rep,name=retired_replay_target,json=retiredReplayTarget,proto3" json:"retired_replay_target,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}

func (m *UniqueKeyMigrationGate) Reset()         { *m = UniqueKeyMigrationGate{} }
func (m *UniqueKeyMigrationGate) String() string { return proto.CompactTextString(m) }
func (*UniqueKeyMigrationGate) ProtoMessage()    {}
func (*UniqueKeyMigrationGate) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{66}
}
func (m *UniqueKeyMigrationGate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UniqueKeyMigrationGate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UniqueKeyMigrationGate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UniqueKeyMigrationGate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UniqueKeyMigrationGate.Merge(m, src)
}
func (m *UniqueKeyMigrationGate) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UniqueKeyMigrationGate) XXX_DiscardUnknown() {
	xxx_messageInfo_UniqueKeyMigrationGate.DiscardUnknown(m)
}

var xxx_messageInfo_UniqueKeyMigrationGate proto.InternalMessageInfo

func (m *UniqueKeyMigrationGate) GetRelationId() uint64 {
	if m != nil {
		return m.RelationId
	}
	return 0
...
func (m *UniqueKeyMigrationGate) GetMigrationEpoch() uint64 {
	if m != nil {
		return m.MigrationEpoch
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetOwnerId() string {
	if m != nil {
		return m.OwnerId
	}
	return ""
...
func (m *UniqueKeyMigrationGate) GetOwnerIncarnation() uint64 {
	if m != nil {
		return m.OwnerIncarnation
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetClaimToken() []byte {
	if m != nil {
		return m.ClaimToken
	}
	return nil
...
func (m *UniqueKeyMigrationGate) GetPhase() UniqueKeyMigrationGate_Phase {
	if m != nil {
		return m.Phase
	}
	return MIGRATION_OPEN
}

func (m *UniqueKeyMigrationGate) GetPhaseDeadlineNanos() int64 {
	if m != nil {
		return m.PhaseDeadlineNanos
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetSourceSchemaEpoch() uint64 {
	if m != nil {
		return m.SourceSchemaEpoch
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetSourceSnapshotId() uint64 {
	if m != nil {
...
func (m *UniqueKeyMigrationGate) GetTempRelationId() uint64 {
	if m != nil {
		return m.TempRelationId
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetPublicationTxnId() uint64 {
	if m != nil {
		return m.PublicationTxnId
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetReplayGeneration() uint64 {
	if m != nil {
		return m.ReplayGeneration
	}
	return 0
}

func (m *UniqueKeyMigrationGate) GetWritePermits() map[string]uint64 {
	if m != nil {
		return m.WritePermits
	}
	return nil
}

func (m *UniqueKeyMigrationGate) GetReplayTargets() map[string]uint64 {
	if m != nil {
		return m.ReplayTargets
	}
	return nil
}

func (m *UniqueKeyMigrationGate) GetReplayAcknowledged() map[string]uint64 {
	if m != nil {
		return m.ReplayAcknowledged
	}
	return nil
}

func (m *UniqueKeyMigrationGate) GetRetiredReplayTarget() map[string]uint64 {
	if m != nil {
		return m.RetiredReplayTarget
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("logservice.UniqueKeyCodecActivation_Phase", UniqueKeyCodecActivation_Phase_name, UniqueKeyCodecActivation_Phase_value)
	proto.RegisterEnum("logservice.UniqueKeyMigrationGate_Phase", UniqueKeyMigrationGate_Phase_name, UniqueKeyMigrationGate_Phase_value)
	...
	proto.RegisterMapType((map[uint64]UniqueKeyMigrationGate)(nil), "logservice.CheckerState.UniqueKeyMigrationGatesEntry")
	...
	proto.RegisterMapType((map[uint64]UniqueKeyMigrationGate)(nil), "logservice.HAKeeperRSMState.UniqueKeyMigrationGatesEntry")
	...
	proto.RegisterType((*UniqueKeyCodecCapability)(nil), "logservice.UniqueKeyCodecCapability")
	proto.RegisterType((*UniqueKeyCodecActivation)(nil), "logservice.UniqueKeyCodecActivation")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyCodecActivation.CnTargetsEntry")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyCodecActivation.TnTargetsEntry")
	proto.RegisterType((*UniqueKeyMigrationGate)(nil), "logservice.UniqueKeyMigrationGate")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyMigrationGate.ReplayAcknowledgedEntry")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyMigrationGate.ReplayTargetsEntry")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyMigrationGate.RetiredReplayTargetEntry")
	proto.RegisterMapType((map[string]uint64)(nil), "logservice.UniqueKeyMigrationGate.WritePermitsEntry")
}
...
var fileDescriptor_fd1040c5381ab5a7 = []byte{
	...
	,
}
...
func (m *CNStoreHeartbeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UniqueKeyCodecCapability != nil {
		{
			size, err := m.UniqueKeyCodecCapability.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LogRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExcludeHardDownReplicaAddresses {
		i--
		if m.ExcludeHardDownReplicaAddresses {
			dAtA[i] = 1
		} else {
	...
	n15, err15 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.TS, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.TS):])
	if err15 != nil {
		return 0, err15
	}
	i -= n15
	i = encodeVarintLogservice(dAtA, i, uint64(n15))
	i--
	dAtA[i] = 0x3a
	if m.TNID != 0 {
...
func (m *CheckerState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UniqueKeyMigrationGates) > 0 {
		for k := range m.UniqueKeyMigrationGates {
			v := m.UniqueKeyMigrationGates[k]
			baseI := i
			{
				size, err := (&v).MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
	...
	if m.UniqueKeyCodecActivation != nil {
		{
			size, err := m.UniqueKeyCodecActivation.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *UniqueKeyCodecCapability) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UniqueKeyCodecCapability) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UniqueKeyCodecCapability) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Incarnation != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.Incarnation))
		i--
		dAtA[i] = 0x30
	}
	if m.MaxEncodedKeyBytes != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.MaxEncodedKeyBytes))
		i--
		dAtA[i] = 0x28
	}
	if len(m.RegistryDigest) > 0 {
		i -= len(m.RegistryDigest)
		copy(dAtA[i:], m.RegistryDigest)
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.RegistryDigest)))
		i--
		dAtA[i] = 0x22
	}
	if m.RegistryVersion != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.RegistryVersion))
		i--
		dAtA[i] = 0x18
	}
	if m.WritableVersions != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.WritableVersions))
		i--
		dAtA[i] = 0x10
	}
	if m.ReadableVersions != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.ReadableVersions))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *UniqueKeyCodecActivation) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UniqueKeyCodecActivation) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UniqueKeyCodecActivation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.TnTargets) > 0 {
		for k := range m.TnTargets {
			v := m.TnTargets[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
	...
	if len(m.CnTargets) > 0 {
		for k := range m.CnTargets {
			v := m.CnTargets[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
	...
	if m.RequestedVersion != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.RequestedVersion))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *UniqueKeyMigrationGate) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UniqueKeyMigrationGate) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UniqueKeyMigrationGate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.RetiredReplayTarget) > 0 {
		for k := range m.RetiredReplayTarget {
			v := m.RetiredReplayTarget[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
	...
	if len(m.ReplayAcknowledged) > 0 {
		for k := range m.ReplayAcknowledged {
			v := m.ReplayAcknowledged[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
	...
	if len(m.ReplayTargets) > 0 {
		for k := range m.ReplayTargets {
			v := m.ReplayTargets[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
	...
	if len(m.WritePermits) > 0 {
		for k := range m.WritePermits {
			v := m.WritePermits[k]
			baseI := i
			i = encodeVarintLogservice(dAtA, i, uint64(v))
			i--
	...
	if m.ReplayGeneration != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.ReplayGeneration))
		i--
		dAtA[i] = 0x60
	}
	if m.PublicationTxnId != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.PublicationTxnId))
		i--
		dAtA[i] = 0x58
	}
	if m.TempRelationId != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.TempRelationId))
		i--
		dAtA[i] = 0x50
	}
	if m.SourceSnapshotId != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.SourceSnapshotId))
		i--
		dAtA[i] = 0x48
	}
	if m.SourceSchemaEpoch != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.SourceSchemaEpoch))
		i--
		dAtA[i] = 0x40
	}
	if m.PhaseDeadlineNanos != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.PhaseDeadlineNanos))
		i--
		dAtA[i] = 0x38
	}
	if m.Phase != 0 {
	...
	if len(m.ClaimToken) > 0 {
		i -= len(m.ClaimToken)
		copy(dAtA[i:], m.ClaimToken)
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.ClaimToken)))
		i--
		dAtA[i] = 0x2a
	}
	if m.OwnerIncarnation != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.OwnerIncarnation))
		i--
		dAtA[i] = 0x20
	}
	if len(m.OwnerId) > 0 {
		...
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.OwnerId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.MigrationEpoch != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.MigrationEpoch))
		i--
		dAtA[i] = 0x10
	}
	if m.RelationId != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.RelationId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CNStoreHeartbeat) ProtoSize() (n int) {
	...
	if m.UniqueKeyCodecCapability != nil {
		l = m.UniqueKeyCodecCapability.ProtoSize()
		n += 2 + l + sovLogservice(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *CheckerState) ProtoSize() (n int) {
	...
	if m.UniqueKeyCodecActivation != nil {
		l = m.UniqueKeyCodecActivation.ProtoSize()
		n += 2 + l + sovLogservice(uint64(l))
	}
	if len(m.UniqueKeyMigrationGates) > 0 {
		for k, v := range m.UniqueKeyMigrationGates {
			_ = k
			_ = v
			l = v.ProtoSize()
			mapEntrySize := 1 + sovLogservice(uint64(k)) + 1 + l + sovLogservice(uint64(l))
...
func (m *UniqueKeyCodecCapability) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ReadableVersions != 0 {
		n += 1 + sovLogservice(uint64(m.ReadableVersions))
	}
	if m.WritableVersions != 0 {
		n += 1 + sovLogservice(uint64(m.WritableVersions))
	}
	if m.RegistryVersion != 0 {
		n += 1 + sovLogservice(uint64(m.RegistryVersion))
	}
	l = len(m.RegistryDigest)
	if l > 0 {
		n += 1 + l + sovLogservice(uint64(l))
	}
	if m.MaxEncodedKeyBytes != 0 {
		n += 1 + sovLogservice(uint64(m.MaxEncodedKeyBytes))
	}
	if m.Incarnation != 0 {
		n += 1 + sovLogservice(uint64(m.Incarnation))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *UniqueKeyCodecActivation) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RequestedVersion != 0 {
		n += 1 + sovLogservice(uint64(m.RequestedVersion))
	}
	if m.RegistryVersion != 0 {
		n += 1 + sovLogservice(uint64(m.RegistryVersion))
	}
...
func (m *UniqueKeyMigrationGate) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RelationId != 0 {
		n += 1 + sovLogservice(uint64(m.RelationId))
	}
	if m.MigrationEpoch != 0 {
		n += 1 + sovLogservice(uint64(m.MigrationEpoch))
	}
	l = len(m.OwnerId)
	if l > 0 {
		n += 1 + l + sovLogservice(uint64(l))
	...
	if m.OwnerIncarnation != 0 {
		n += 1 + sovLogservice(uint64(m.OwnerIncarnation))
	}
	l = len(m.ClaimToken)
	if l > 0 {
		n += 1 + l + sovLogservice(uint64(l))
	...
	if m.PhaseDeadlineNanos != 0 {
		n += 1 + sovLogservice(uint64(m.PhaseDeadlineNanos))
	}
	if m.SourceSchemaEpoch != 0 {
		n += 1 + sovLogservice(uint64(m.SourceSchemaEpoch))
	}
	if m.SourceSnapshotId != 0 {
		n += 1 + sovLogservice(uint64(m.SourceSnapshotId))
	}
	if m.TempRelationId != 0 {
		n += 1 + sovLogservice(uint64(m.TempRelationId))
	}
	if m.PublicationTxnId != 0 {
		n += 1 + sovLogservice(uint64(m.PublicationTxnId))
	}
	if m.ReplayGeneration != 0 {
		n += 1 + sovLogservice(uint64(m.ReplayGeneration))
	}
	if len(m.WritePermits) > 0 {
		for k, v := range m.WritePermits {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovLogservice(uint64(len(k))) + 1 + sovLogservice(uint64(v))
			n += mapEntrySize + 1 + sovLogservice(uint64(mapEntrySize))
	...
	if len(m.ReplayAcknowledged) > 0 {
		for k, v := range m.ReplayAcknowledged {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovLogservice(uint64(len(k))) + 1 + sovLogservice(uint64(v))
			n += mapEntrySize + 1 + sovLogservice(uint64(mapEntrySize))
	...
	if len(m.RetiredReplayTarget) > 0 {
		for k, v := range m.RetiredReplayTarget {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovLogservice(uint64(len(k))) + 1 + sovLogservice(uint64(v))
			n += mapEntrySize + 2 + sovLogservice(uint64(mapEntrySize))
...
func (m *CNStoreHeartbeat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UniqueKeyCodecCapability", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UniqueKeyCodecCapability == nil {
				m.UniqueKeyCodecCapability = &UniqueKeyCodecCapability{}
			}
			if err := m.UniqueKeyCodecCapability.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LogRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeExpiredReplicaAddresses", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludeHardDownReplicaAddresses", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExcludeHardDownReplicaAddresses = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipLogservice(dAtA[iNdEx:])
			if err != nil {
...
func (m *CheckerState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UniqueKeyCodecActivation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UniqueKeyCodecActivation == nil {
				m.UniqueKeyCodecActivation = &UniqueKeyCodecActivation{}
			}
			if err := m.UniqueKeyCodecActivation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UniqueKeyMigrationGates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UniqueKeyMigrationGates == nil {
				m.UniqueKeyMigrationGates = make(map[uint64]UniqueKeyMigrationGate)
			}
			var mapkey uint64
			mapvalue := &UniqueKeyMigrationGate{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.UniqueKeyMigrationGates[mapkey] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLogservice(dAtA[iNdEx:])
...
func (m *UniqueKeyCodecCapability) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UniqueKeyCodecCapability: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UniqueKeyCodecCapability: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadableVersions", wireType)
			}
			m.ReadableVersions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadableVersions |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WritableVersions", wireType)
			}
			m.WritableVersions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WritableVersions |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RegistryVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegistryDigest", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RegistryDigest = append(m.RegistryDigest[:0], dAtA[iNdEx:postIndex]...)
			if m.RegistryDigest == nil {
				m.RegistryDigest = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxEncodedKeyBytes", wireType)
			}
			m.MaxEncodedKeyBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxEncodedKeyBytes |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *UniqueKeyCodecActivation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UniqueKeyCodecActivation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UniqueKeyCodecActivation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Phase |= UniqueKeyCodecActivation_Phase(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CnTargets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CnTargets == nil {
				m.CnTargets = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.CnTargets[mapkey] = mapvalue
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TnTargets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TnTargets == nil {
				m.TnTargets = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
...
func (m *UniqueKeyMigrationGate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UniqueKeyMigrationGate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UniqueKeyMigrationGate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RelationId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MigrationEpoch", wireType)
			}
			m.MigrationEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MigrationEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OwnerIncarnation", wireType)
			}
			m.OwnerIncarnation = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OwnerIncarnation |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClaimToken", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ClaimToken = append(m.ClaimToken[:0], dAtA[iNdEx:postIndex]...)
			if m.ClaimToken == nil {
				m.ClaimToken = []byte{}
			}
			iNdEx = postIndex
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Phase |= UniqueKeyMigrationGate_Phase(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PhaseDeadlineNanos", wireType)
			}
			m.PhaseDeadlineNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PhaseDeadlineNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceSchemaEpoch", wireType)
			}
			m.SourceSchemaEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceSchemaEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceSnapshotId", wireType)
			}
			m.SourceSnapshotId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceSnapshotId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TempRelationId", wireType)
			}
			m.TempRelationId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TempRelationId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PublicationTxnId", wireType)
			}
			m.PublicationTxnId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PublicationTxnId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplayGeneration", wireType)
			}
			m.ReplayGeneration = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLogservice
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplayGeneration |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WritePermits", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WritePermits == nil {
				m.WritePermits = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.WritePermits[mapkey] = mapvalue
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplayTargets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReplayTargets == nil {
				m.ReplayTargets = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.ReplayTargets[mapkey] = mapvalue
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplayAcknowledged", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReplayAcknowledged == nil {
				m.ReplayAcknowledged = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.ReplayAcknowledged[mapkey] = mapvalue
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RetiredReplayTarget", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RetiredReplayTarget == nil {
				m.RetiredReplayTarget = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
			...
			m.RetiredReplayTarget[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLogservice(dAtA[iNdEx:])
