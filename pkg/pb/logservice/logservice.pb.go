...
const (
	...
	REPAIR_LOG_SHARD              MethodType = 29
	UNBLOCK_LOG_SHARD_STORES      MethodType = 30
)
...
const (
	...
	RepairLogShardUpdate        HAKeeperUpdateType = 18
	UnblockLogShardStoresUpdate HAKeeperUpdateType = 19
)
...
var HAKeeperUpdateType_name = map[int32]string{
	...
	17: "LogShardUpdate",
	18: "RepairLogShardUpdate",
	19: "UnblockLogShardStoresUpdate",
}
...
var HAKeeperUpdateType_value = map[string]int32{
	...
	"LogShardUpdate":              17,
	"RepairLogShardUpdate":        18,
	"UnblockLogShardStoresUpdate": 19,
}
...
type Request struct {
	...
	RepairLogShard        *RepairLogShard        `protobuf:"bytes,17,opt,name=RepairLogShard,proto3" json:"RepairLogShard,omitempty"`
	UnblockLogShardStores *UnblockLogShardStores `protobuf:"bytes,18,opt,name=UnblockLogShardStores,proto3" json:"UnblockLogShardStores,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}               `json:"-"`
	XXX_unrecognized      []byte                 `json:"-"`
	XXX_sizecache         int32                  `json:"-"`
}
...
func (m *Request) GetRepairLogShard() *RepairLogShard {
	if m != nil {
		return m.RepairLogShard
	}
	return nil
}

func (m *Request) GetUnblockLogShardStores() *UnblockLogShardStores {
	if m != nil {
		return m.UnblockLogShardStores
	}
	return nil
}
...
type RepairLogShard struct {
	Shard                LogShardInfo `protobuf:"bytes,1,opt,name=Shard,proto3" json:"Shard"`
	BlockedStores        []string     `protobuf:"bytes,2,rep,name=BlockedStores,proto3" json:"BlockedStores,omitempty"`
...
func (m *RepairLogShard) Reset()         { *m = RepairLogShard{} }
func (m *RepairLogShard) String() string { return proto.CompactTextString(m) }
func (*RepairLogShard) ProtoMessage()    {}
func (*RepairLogShard) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{47}
}
func (m *RepairLogShard) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RepairLogShard) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RepairLogShard.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RepairLogShard) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RepairLogShard.Merge(m, src)
}
func (m *RepairLogShard) XXX_Size() int {
	return m.ProtoSize()
}
func (m *RepairLogShard) XXX_DiscardUnknown() {
	xxx_messageInfo_RepairLogShard.DiscardUnknown(m)
}

var xxx_messageInfo_RepairLogShard proto.InternalMessageInfo

func (m *RepairLogShard) GetShard() LogShardInfo {
	if m != nil {
		return m.Shard
	}
	return LogShardInfo{}
...
func (m *RepairLogShard) GetBlockedStores() []string {
	if m != nil {
		return m.BlockedStores
	}
	return nil
}

func (m *RepairLogShard) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *RepairLogShard) GetForce() bool {
	if m != nil {
		return m.Force
	}
	return false
...
type UnblockLogShardStores struct {
	ShardID              uint64   `protobuf:"varint,1,opt,name=ShardID,proto3" json:"ShardID,omitempty"`
...
func (m *UnblockLogShardStores) Reset()         { *m = UnblockLogShardStores{} }
func (m *UnblockLogShardStores) String() string { return proto.CompactTextString(m) }
func (*UnblockLogShardStores) ProtoMessage()    {}
func (*UnblockLogShardStores) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{48}
}
func (m *UnblockLogShardStores) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnblockLogShardStores) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UnblockLogShardStores.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UnblockLogShardStores) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnblockLogShardStores.Merge(m, src)
}
func (m *UnblockLogShardStores) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UnblockLogShardStores) XXX_DiscardUnknown() {
	xxx_messageInfo_UnblockLogShardStores.DiscardUnknown(m)
}

var xxx_messageInfo_UnblockLogShardStores proto.InternalMessageInfo

func (m *UnblockLogShardStores) GetShardID() uint64 {
	if m != nil {
		return m.ShardID
	}
	return 0
...
func (m *UnblockLogShardStores) GetStores() []string {
	if m != nil {
		return m.Stores
	}
	return nil
...
func (m *UnblockLogShardStores) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
type LogShardRepairState struct {
	Shard                LogShardInfo    `protobuf:"bytes,1,opt,name=Shard,proto3" json:"Shard"`
	BlockedStores        map[string]bool `protobuf:"bytes,2,rep,name=BlockedStores,proto3" json:"BlockedStores" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Reason               string          `protobuf:"bytes,3,opt,name=Reason,proto3" json:"Reason,omitempty"`
	CreatedTick          uint64          `protobuf:"varint,4,opt,name=CreatedTick,proto3" json:"CreatedTick,omitempty"`
	UpdatedTick          uint64          `protobuf:"varint,5,opt,name=UpdatedTick,proto3" json:"UpdatedTick,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *LogShardRepairState) Reset()         { *m = LogShardRepairState{} }
func (m *LogShardRepairState) String() string { return proto.CompactTextString(m) }
func (*LogShardRepairState) ProtoMessage()    {}
func (*LogShardRepairState) Descriptor() ([]byte, []int) {
	return fileDescriptor_fd1040c5381ab5a7, []int{49}
}
func (m *LogShardRepairState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LogShardRepairState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LogShardRepairState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LogShardRepairState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LogShardRepairState.Merge(m, src)
}
func (m *LogShardRepairState) XXX_Size() int {
	return m.ProtoSize()
}
func (m *LogShardRepairState) XXX_DiscardUnknown() {
	xxx_messageInfo_LogShardRepairState.DiscardUnknown(m)
}

var xxx_messageInfo_LogShardRepairState proto.InternalMessageInfo

func (m *LogShardRepairState) GetShard() LogShardInfo {
	if m != nil {
		return m.Shard
	}
	return LogShardInfo{}
...
func (m *LogShardRepairState) GetBlockedStores() map[string]bool {
	if m != nil {
		return m.BlockedStores
	}
	return nil
...
func (m *LogShardRepairState) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *LogShardRepairState) GetCreatedTick() uint64 {
	if m != nil {
		return m.CreatedTick
	}
	return 0
}

func (m *LogShardRepairState) GetUpdatedTick() uint64 {
	if m != nil {
		return m.UpdatedTick
	}
	return 0
}
...
type CheckerState struct {
	...
	LogShardRepairs      map[uint64]LogShardRepairState `protobuf:"bytes,15,rep,name=LogShardRepairs,proto3" json:"LogShardRepairs" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
func (m *CheckerState) GetLogShardRepairs() map[uint64]LogShardRepairState {
	if m != nil {
		return m.LogShardRepairs
	}
	return nil
}
...
type HAKeeperRSMState struct {
	...
	LogShardRepairs      map[uint64]LogShardRepairState `protobuf:"bytes,19,rep,name=LogShardRepairs,proto3" json:"LogShardRepairs" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
func (m *HAKeeperRSMState) GetLogShardRepairs() map[uint64]LogShardRepairState {
	if m != nil {
		return m.LogShardRepairs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RepairLogShard)(nil), "logservice.RepairLogShard")
	proto.RegisterType((*UnblockLogShardStores)(nil), "logservice.UnblockLogShardStores")
	proto.RegisterType((*LogShardRepairState)(nil), "logservice.LogShardRepairState")
	proto.RegisterMapType((map[string]bool)(nil), "logservice.LogShardRepairState.BlockedStoresEntry")
	...
	proto.RegisterMapType((map[uint64]LogShardRepairState)(nil), "logservice.CheckerState.LogShardRepairsEntry")
	...
	proto.RegisterMapType((map[uint64]LogShardRepairState)(nil), "logservice.HAKeeperRSMState.LogShardRepairsEntry")
...
var fileDescriptor_fd1040c5381ab5a7 = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UnblockLogShardStores != nil {
		{
			size, err := m.UnblockLogShardStores.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RepairLogShard != nil {
		{
			size, err := m.RepairLogShard.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RepairLogShard) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RepairLogShard) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RepairLogShard) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Reason) > 0 {
		...
		i = encodeVarintLogservice(dAtA, i, uint64(len(m.Reason)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BlockedStores) > 0 {
		for iNdEx := len(m.BlockedStores) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BlockedStores[iNdEx])
			copy(dAtA[i:], m.BlockedStores[iNdEx])
			i = encodeVarintLogservice(dAtA, i, uint64(len(m.BlockedStores[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *UnblockLogShardStores) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UnblockLogShardStores) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UnblockLogShardStores) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Stores) > 0 {
		for iNdEx := len(m.Stores) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintLogservice(dAtA, i, uint64(len(m.Stores[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *LogShardRepairState) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LogShardRepairState) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LogShardRepairState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.UpdatedTick != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.UpdatedTick))
		i--
		dAtA[i] = 0x28
	}
	if m.CreatedTick != 0 {
		i = encodeVarintLogservice(dAtA, i, uint64(m.CreatedTick))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Reason) > 0 {
...
func (m *CheckerState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LogShardRepairs) > 0 {
		for k := range m.LogShardRepairs {
			v := m.LogShardRepairs[k]
			baseI := i
			{
				size, err := (&v).MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
...
func (m *Request) ProtoSize() (n int) {
	...
	if m.RepairLogShard != nil {
		l = m.RepairLogShard.ProtoSize()
		n += 2 + l + sovLogservice(uint64(l))
	}
	if m.UnblockLogShardStores != nil {
		l = m.UnblockLogShardStores.ProtoSize()
		n += 2 + l + sovLogservice(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *RepairLogShard) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UnblockLogShardStores) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LogShardRepairState) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.CreatedTick != 0 {
		n += 1 + sovLogservice(uint64(m.CreatedTick))
	}
	if m.UpdatedTick != 0 {
		n += 1 + sovLogservice(uint64(m.UpdatedTick))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CheckerState) ProtoSize() (n int) {
	...
	n += 1 + l + sovLogservice(uint64(l))
	if len(m.LogShardRepairs) > 0 {
		for k, v := range m.LogShardRepairs {
			_ = k
			_ = v
			l = v.ProtoSize()
			mapEntrySize := 1 + sovLogservice(uint64(k)) + 1 + l + sovLogservice(uint64(l))
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RepairLogShard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RepairLogShard == nil {
				m.RepairLogShard = &RepairLogShard{}
			}
			if err := m.RepairLogShard.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnblockLogShardStores", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnblockLogShardStores == nil {
				m.UnblockLogShardStores = &UnblockLogShardStores{}
			}
			if err := m.UnblockLogShardStores.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RepairLogShard) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RepairLogShard: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RepairLogShard: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockedStores", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlockedStores = append(m.BlockedStores, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *UnblockLogShardStores) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnblockLogShardStores: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnblockLogShardStores: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *LogShardRepairState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LogShardRepairState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LogShardRepairState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.BlockedStores == nil {
				m.BlockedStores = make(map[string]bool)
			}
			var mapkey string
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.BlockedStores[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Reason", wireType)
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreatedTick", wireType)
			}
			m.CreatedTick = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CreatedTick |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatedTick", wireType)
			}
			m.UpdatedTick = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UpdatedTick |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CheckerState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LogShardRepairs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LogShardRepairs == nil {
				m.LogShardRepairs = make(map[uint64]LogShardRepairState)
			}
			var mapkey uint64
			mapvalue := &LogShardRepairState{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.LogShardRepairs[mapkey] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLogservice(dAtA[iNdEx:])
