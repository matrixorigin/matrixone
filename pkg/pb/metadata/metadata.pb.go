...
type CNService struct {
	...
	Labels map[string]LabelList `protobuf:"bytes,5,rep,name=Labels,proto3" json:"Labels" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// WorkState is the work state of CN service.
	...
	QueryAddress         string   `protobuf:"bytes,7,opt,name=QueryAddress,proto3" json:"QueryAddress,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type TNService struct {
	...
	Shards []TNShard `protobuf:"bytes,5,rep,name=Shards,proto3" json:"Shards"`
...
var fileDescriptor_56d9f74966f40d04 = []byte{
	...
	,
}
