...
type CNStore struct {
	...
	// DDLVisibilityDeployedProtocol is the durable activation level restored
	// before this CN admits SQL after an ordinary restart.
	DDLVisibilityDeployedProtocol int64    `protobuf:"varint,3,opt,name=DDLVisibilityDeployedProtocol,proto3" json:"DDLVisibilityDeployedProtocol,omitempty"`
	XXX_NoUnkeyedLiteral          struct{} `json:"-"`
	XXX_unrecognized              []byte   `json:"-"`
	XXX_sizecache                 int32    `json:"-"`
}
...
func (m *CNStore) GetDDLVisibilityDeployedProtocol() int64 {
	if m != nil {
		return m.DDLVisibilityDeployedProtocol
	}
	return 0
}
...
type CNService struct {
	...
	// DDLVisibilityBarrierReady is published after QueryService is listening.
	// A CN is not publicly routable until its startup DDL frontier fence completes.
	DDLVisibilityBarrierReady bool `protobuf:"varint,16,opt,name=DDLVisibilityBarrierReady,proto3" json:"DDLVisibilityBarrierReady,omitempty"`
	// ViewMetadataIngressReady is retained in raw control-plane inventory so
	// protocol activation can verify withdrawal/publication without routing it.
	ViewMetadataIngressReady bool     `protobuf:"varint,17,opt,name=ViewMetadataIngressReady,proto3" json:"ViewMetadataIngressReady,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *CNService) GetDDLVisibilityBarrierReady() bool {
	if m != nil {
		return m.DDLVisibilityBarrierReady
	}
	return false
}

func (m *CNService) GetViewMetadataIngressReady() bool {
	if m != nil {
...
var fileDescriptor_56d9f74966f40d04 = []byte{
	...
	,
}
...
func (m *CNStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DDLVisibilityDeployedProtocol != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.DDLVisibilityDeployedProtocol))
		i--
		dAtA[i] = 0x18
	}
	if m.Role != 0 {
...
func (m *CNService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DDLVisibilityBarrierReady {
		i--
		if m.DDLVisibilityBarrierReady {
			dAtA[i] = 1
		} else {
...
func (m *CNStore) ProtoSize() (n int) {
	...
	if m.DDLVisibilityDeployedProtocol != 0 {
		n += 1 + sovMetadata(uint64(m.DDLVisibilityDeployedProtocol))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CNStore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DDLVisibilityDeployedProtocol", wireType)
			}
			m.DDLVisibilityDeployedProtocol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DDLVisibilityDeployedProtocol |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CNService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DDLVisibilityBarrierReady", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DDLVisibilityBarrierReady = bool(v != 0)
		case 17:
			if wireType != 0 {
