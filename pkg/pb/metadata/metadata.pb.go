...
type TNService struct {
	...
	// AutoIncrEpochFenceGeneration identifies the TN process generation that
	// advertised AutoIncrEpochFenceSupported.
	AutoIncrEpochFenceGeneration string   `protobuf:"bytes,11,opt,name=AutoIncrEpochFenceGeneration,proto3" json:"AutoIncrEpochFenceGeneration,omitempty"`
	XXX_NoUnkeyedLiteral         struct{} `json:"-"`
	XXX_unrecognized             []byte   `json:"-"`
	XXX_sizecache                int32    `json:"-"`
}
...
func (m *TNService) GetAutoIncrEpochFenceGeneration() string {
	if m != nil {
		return m.AutoIncrEpochFenceGeneration
	}
	return ""
}
...
var fileDescriptor_56d9f74966f40d04 = []byte{
	...
	,
}
...
func (m *TNService) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AutoIncrEpochFenceGeneration) > 0 {
		i -= len(m.AutoIncrEpochFenceGeneration)
		copy(dAtA[i:], m.AutoIncrEpochFenceGeneration)
		i = encodeVarintMetadata(dAtA, i, uint64(len(m.AutoIncrEpochFenceGeneration)))
		i--
		dAtA[i] = 0x5a
	}
...
func (m *TNService) ProtoSize() (n int) {
	...
	l = len(m.AutoIncrEpochFenceGeneration)
	if l > 0 {
		n += 1 + l + sovMetadata(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *TNService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoIncrEpochFenceGeneration", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoIncrEpochFenceGeneration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(dAtA[iNdEx:])
