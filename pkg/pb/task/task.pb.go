...
const (
	...
	TaskCode_Async_Index_CDC TaskCode = 9
)
...
const (
	...
	TaskType_TypeAsyncIndexCdc      TaskType = 4
)
...
type AsyncIndexCdcDetails struct {
	// async index cdc task uuid
	TaskId string `protobuf:"bytes,1,opt,name=TaskId,proto3" json:"TaskId,omitempty"`
	// async index cdc task name
	TaskName             string   `protobuf:"bytes,2,opt,name=TaskName,proto3" json:"TaskName,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *AsyncIndexCdcDetails) Reset()         { *m = AsyncIndexCdcDetails{} }
func (m *AsyncIndexCdcDetails) String() string { return proto.CompactTextString(m) }
func (*AsyncIndexCdcDetails) ProtoMessage()    {}
func (*AsyncIndexCdcDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce5d8dd45b4a91ff, []int{10}
}
func (m *AsyncIndexCdcDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AsyncIndexCdcDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AsyncIndexCdcDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AsyncIndexCdcDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AsyncIndexCdcDetails.Merge(m, src)
}
func (m *AsyncIndexCdcDetails) XXX_Size() int {
	return m.ProtoSize()
}
func (m *AsyncIndexCdcDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_AsyncIndexCdcDetails.DiscardUnknown(m)
}

var xxx_messageInfo_AsyncIndexCdcDetails proto.InternalMessageInfo

func (m *AsyncIndexCdcDetails) GetTaskId() string {
	if m != nil {
		return m.TaskId
	}
	return ""
...
func (m *AsyncIndexCdcDetails) GetTaskName() string {
	if m != nil {
		return m.TaskName
	}
	return ""
...
type Details_AsyncIndexCdc struct {
	AsyncIndexCdc *AsyncIndexCdcDetails `protobuf:"bytes,13,opt,name=AsyncIndexCdc,proto3,oneof" json:"AsyncIndexCdc,omitempty"`
}

func (*Details_Connector) isDetails_Details()     {}
func (*Details_Retention) isDetails_Details()     {}
func (*Details_CreateCdc) isDetails_Details()     {}
func (*Details_AsyncIndexCdc) isDetails_Details() {}
...
func (m *Details) GetAsyncIndexCdc() *AsyncIndexCdcDetails {
	if x, ok := m.GetDetails().(*Details_AsyncIndexCdc); ok {
		return x.AsyncIndexCdc
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*AsyncIndexCdcDetails)(nil), "task.AsyncIndexCdcDetails")
...
var fileDescriptor_ce5d8dd45b4a91ff = []byte{
	...
	,
}
...
func (m *AsyncIndexCdcDetails) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AsyncIndexCdcDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AsyncIndexCdcDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Details_AsyncIndexCdc) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Details_AsyncIndexCdc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AsyncIndexCdc != nil {
		{
			size, err := m.AsyncIndexCdc.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AsyncIndexCdcDetails) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Details_AsyncIndexCdc) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AsyncIndexCdcDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AsyncIndexCdcDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AsyncIndexCdcDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Details) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AsyncIndexCdc", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AsyncIndexCdcDetails{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Details = &Details_AsyncIndexCdc{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTask(dAtA[iNdEx:])
