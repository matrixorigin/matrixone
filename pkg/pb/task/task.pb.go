...
type Task struct {
	...
	// to this task.
	ScheduleAfter int64 `protobuf:"varint,7,opt,name=ScheduleAfter,proto3" json:"ScheduleAfter,omitempty"`
	// LastHeartbeat time of the last heartbeat reported by TaskRunner. Unix timestamp in ms
	LastHeartbeat int64 `protobuf:"varint,8,opt,name=LastHeartbeat,proto3" json:"LastHeartbeat,omitempty"`
	...
	CompletedAt int64 `protobuf:"varint,10,opt,name=CompletedAt,proto3" json:"CompletedAt,omitempty"`
	// ExecuteResult execute result
	ExecuteResult        *ExecuteResult `protobuf:"bytes,11,opt,name=ExecuteResult,proto3" json:"ExecuteResult,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
var fileDescriptor_ce5d8dd45b4a91ff = []byte{
	...
	,
}
