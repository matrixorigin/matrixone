...
type PreInsert struct {
	...
	TrackOdkuResult              bool           `protobuf:"varint,19,opt,name=track_odku_result,json=trackOdkuResult,proto3" json:"track_odku_result,omitempty"`
	OdkuOrdinalColumn            int32          `protobuf:"varint,20,opt,name=odku_ordinal_column,json=odkuOrdinalColumn,proto3" json:"odku_ordinal_column,omitempty"`
	// ODKU provenance names the user-visible AUTO_INCREMENT source column.
	OdkuAutoIncrementColumn int32    `protobuf:"varint,21,opt,name=odku_auto_increment_column,json=odkuAutoIncrementColumn,proto3" json:"odku_auto_increment_column,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func (m *PreInsert) GetTrackOdkuResult() bool {
	if m != nil {
		return m.TrackOdkuResult
	}
	return false
}

func (m *PreInsert) GetOdkuOrdinalColumn() int32 {
	if m != nil {
		return m.OdkuOrdinalColumn
	}
	return 0
}

func (m *PreInsert) GetOdkuAutoIncrementColumn() int32 {
	if m != nil {
		return m.OdkuAutoIncrementColumn
	}
	return 0
}
...
type DedupJoin struct {
	...
	OdkuTargetAutoIncrementCol      int32                 `protobuf:"varint,30,opt,name=odku_target_auto_increment_col,json=odkuTargetAutoIncrementCol,proto3" json:"odku_target_auto_increment_col,omitempty"`
	OdkuGeneratedCol                int32                 `protobuf:"varint,31,opt,name=odku_generated_col,json=odkuGeneratedCol,proto3" json:"odku_generated_col,omitempty"`
	OdkuOrdinalCol                  int32                 `protobuf:"varint,32,opt,name=odku_ordinal_col,json=odkuOrdinalCol,proto3" json:"odku_ordinal_col,omitempty"`
	OdkuResultTracking              bool                  `protobuf:"varint,33,opt,name=odku_result_tracking,json=odkuResultTracking,proto3" json:"odku_result_tracking,omitempty"`
	OdkuGeneratedAutoIncrementCol   int32                 `protobuf:"varint,34,opt,name=odku_generated_auto_increment_col,json=odkuGeneratedAutoIncrementCol,proto3" json:"odku_generated_auto_increment_col,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}              `json:"-"`
	XXX_unrecognized                []byte                `json:"-"`
	XXX_sizecache                   int32                 `json:"-"`
}
...
func (m *DedupJoin) GetOdkuTargetAutoIncrementCol() int32 {
	if m != nil {
		return m.OdkuTargetAutoIncrementCol
	}
	return 0
}

func (m *DedupJoin) GetOdkuGeneratedCol() int32 {
	if m != nil {
		return m.OdkuGeneratedCol
	}
	return 0
}

func (m *DedupJoin) GetOdkuOrdinalCol() int32 {
	if m != nil {
		return m.OdkuOrdinalCol
	}
	return 0
}

func (m *DedupJoin) GetOdkuResultTracking() bool {
	if m != nil {
		return m.OdkuResultTracking
	}
	return false
}

func (m *DedupJoin) GetOdkuGeneratedAutoIncrementCol() int32 {
	if m != nil {
		return m.OdkuGeneratedAutoIncrementCol
	}
	return 0
}
...
type ProcessInfo struct {
	...
	// Statement-local ODKU ordinal range reserved by the initiating CN before
	// this remote pipeline starts. Older senders leave it zero.
	OdkuOrdinalBase      uint64   `protobuf:"varint,17,opt,name=odku_ordinal_base,json=odkuOrdinalBase,proto3" json:"odku_ordinal_base,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ProcessInfo) GetOdkuOrdinalBase() uint64 {
	if m != nil {
		return m.OdkuOrdinalBase
	}
	return 0
}
...
type SessionInfo struct {
	...
	// Session-visible LAST_INSERT_ID() baseline for expressions evaluated on a
	// remote CN. Zero is a valid value and also preserves old payload behavior.
	LastInsertId         uint64   `protobuf:"varint,17,opt,name=last_insert_id,json=lastInsertId,proto3" json:"last_insert_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SessionInfo) GetLastInsertId() uint64 {
	if m != nil {
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	// 9446 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *PreInsert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OdkuAutoIncrementColumn != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuAutoIncrementColumn))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	}
	if m.OdkuOrdinalColumn != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuOrdinalColumn))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	}
	if m.TrackOdkuResult {
		i--
		if m.TrackOdkuResult {
			dAtA[i] = 1
		} else {
...
func (m *DedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OdkuGeneratedAutoIncrementCol != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuGeneratedAutoIncrementCol))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x90
	}
	if m.OdkuResultTracking {
		i--
		if m.OdkuResultTracking {
			dAtA[i] = 1
		} else {
	...
	if m.OdkuOrdinalCol != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuOrdinalCol))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x80
	}
	if m.OdkuGeneratedCol != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuGeneratedCol))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf8
	}
	if m.OdkuTargetAutoIncrementCol != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuTargetAutoIncrementCol))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
...
func (m *ProcessInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OdkuOrdinalBase != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OdkuOrdinalBase))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
...
func (m *SessionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastInsertId != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.LastInsertId))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
...
func (m *PreInsert) ProtoSize() (n int) {
	...
	if m.OdkuOrdinalColumn != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuOrdinalColumn))
	}
	if m.OdkuAutoIncrementColumn != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuAutoIncrementColumn))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *DedupJoin) ProtoSize() (n int) {
	...
	if m.OdkuTargetAutoIncrementCol != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuTargetAutoIncrementCol))
	}
	if m.OdkuGeneratedCol != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuGeneratedCol))
	}
	if m.OdkuOrdinalCol != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuOrdinalCol))
	}
	if m.OdkuResultTracking {
		n += 3
	}
	if m.OdkuGeneratedAutoIncrementCol != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuGeneratedAutoIncrementCol))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ProcessInfo) ProtoSize() (n int) {
	...
	if m.OdkuOrdinalBase != 0 {
		n += 2 + sovPipeline(uint64(m.OdkuOrdinalBase))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *SessionInfo) ProtoSize() (n int) {
	...
	if m.LastInsertId != 0 {
		n += 2 + sovPipeline(uint64(m.LastInsertId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *PreInsert) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrackOdkuResult", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TrackOdkuResult = bool(v != 0)
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuOrdinalColumn", wireType)
			}
			m.OdkuOrdinalColumn = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuOrdinalColumn |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuAutoIncrementColumn", wireType)
			}
			m.OdkuAutoIncrementColumn = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuAutoIncrementColumn |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DedupJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuTargetAutoIncrementCol", wireType)
			}
			m.OdkuTargetAutoIncrementCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuTargetAutoIncrementCol |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuGeneratedCol", wireType)
			}
			m.OdkuGeneratedCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuGeneratedCol |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 32:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuOrdinalCol", wireType)
			}
			m.OdkuOrdinalCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuOrdinalCol |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 33:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuResultTracking", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OdkuResultTracking = bool(v != 0)
		case 34:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuGeneratedAutoIncrementCol", wireType)
			}
			m.OdkuGeneratedAutoIncrementCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuGeneratedAutoIncrementCol |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ProcessInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OdkuOrdinalBase", wireType)
			}
			m.OdkuOrdinalBase = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OdkuOrdinalBase |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
