...
type QuerySchedulingIntent struct {
	Explicit             bool     `protobuf:"varint,1,opt,name=explicit,proto3" json:"explicit,omitempty"`
	RequestedPool        string   `protobuf:"bytes,2,opt,name=requested_pool,json=requestedPool,proto3" json:"requested_pool,omitempty"`
	PoolFallback         uint32   `protobuf:"varint,3,opt,name=pool_fallback,json=poolFallback,proto3" json:"pool_fallback,omitempty"`
	EmptyWorkerPolicy    uint32   `protobuf:"varint,4,opt,name=empty_worker_policy,json=emptyWorkerPolicy,proto3" json:"empty_worker_policy,omitempty"`
	CurrentCnPolicy      uint32   `protobuf:"varint,5,opt,name=current_cn_policy,json=currentCnPolicy,proto3" json:"current_cn_policy,omitempty"`
	WorkerSetMode        uint32   `protobuf:"varint,6,opt,name=worker_set_mode,json=workerSetMode,proto3" json:"worker_set_mode,omitempty"`
	MaxWorkers           int32    `protobuf:"varint,7,opt,name=max_workers,json=maxWorkers,proto3" json:"max_workers,omitempty"`
	SelectionKey         string   `protobuf:"bytes,8,opt,name=selection_key,json=selectionKey,proto3" json:"selection_key,omitempty"`
...
func (m *QuerySchedulingIntent) Reset()         { *m = QuerySchedulingIntent{} }
func (m *QuerySchedulingIntent) String() string { return proto.CompactTextString(m) }
func (*QuerySchedulingIntent) ProtoMessage()    {}
func (*QuerySchedulingIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{51}
}
func (m *QuerySchedulingIntent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QuerySchedulingIntent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QuerySchedulingIntent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QuerySchedulingIntent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuerySchedulingIntent.Merge(m, src)
}
func (m *QuerySchedulingIntent) XXX_Size() int {
	return m.ProtoSize()
}
func (m *QuerySchedulingIntent) XXX_DiscardUnknown() {
	xxx_messageInfo_QuerySchedulingIntent.DiscardUnknown(m)
}

var xxx_messageInfo_QuerySchedulingIntent proto.InternalMessageInfo

func (m *QuerySchedulingIntent) GetExplicit() bool {
	if m != nil {
		return m.Explicit
	}
	return false
...
func (m *QuerySchedulingIntent) GetRequestedPool() string {
	if m != nil {
		return m.RequestedPool
	}
	return ""
}

func (m *QuerySchedulingIntent) GetPoolFallback() uint32 {
	if m != nil {
		return m.PoolFallback
	}
	return 0
}

func (m *QuerySchedulingIntent) GetEmptyWorkerPolicy() uint32 {
	if m != nil {
		return m.EmptyWorkerPolicy
	}
	return 0
}

func (m *QuerySchedulingIntent) GetCurrentCnPolicy() uint32 {
	if m != nil {
		return m.CurrentCnPolicy
	}
	return 0
}

func (m *QuerySchedulingIntent) GetWorkerSetMode() uint32 {
	if m != nil {
		return m.WorkerSetMode
	}
	return 0
}

func (m *QuerySchedulingIntent) GetMaxWorkers() int32 {
	if m != nil {
		return m.MaxWorkers
	}
	return 0
...
func (m *QuerySchedulingIntent) GetSelectionKey() string {
	if m != nil {
...
func (m *QuerySchedulingIntent) GetAlgorithmVersion() string {
	if m != nil {
...
type SessionInfo struct {
	...
	// Immutable CN label selector inherited by nested/internal SQL. Remote
	// processes must retain it so child queries cannot escape the parent pool.
	CnLabels              map[string]string      `protobuf:"bytes,15,rep,name=cn_labels,json=cnLabels,proto3" json:"cn_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	QuerySchedulingIntent *QuerySchedulingIntent `protobuf:"bytes,16,opt,name=query_scheduling_intent,json=querySchedulingIntent,proto3" json:"query_scheduling_intent,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}               `json:"-"`
	XXX_unrecognized      []byte                 `json:"-"`
	XXX_sizecache         int32                  `json:"-"`
}
...
func (m *SessionInfo) GetCnLabels() map[string]string {
	if m != nil {
		return m.CnLabels
	}
	return nil
...
func (m *SessionInfo) GetQuerySchedulingIntent() *QuerySchedulingIntent {
	if m != nil {
		return m.QuerySchedulingIntent
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*QuerySchedulingIntent)(nil), "pipeline.QuerySchedulingIntent")
	proto.RegisterType((*SessionInfo)(nil), "pipeline.SessionInfo")
	proto.RegisterMapType((map[string]string)(nil), "pipeline.SessionInfo.CnLabelsEntry")
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
...
func (m *DedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DedupDeleteKeepColIdxList) > 0 {
		dAtA47 := make([]byte, len(m.DedupDeleteKeepColIdxList)*10)
		var j46 int
	...
	if len(m.OldColCaptureProbeIdxList) > 0 {
		dAtA49 := make([]byte, len(m.OldColCaptureProbeIdxList)*10)
		var j48 int
	...
	if len(m.OldColCapturePlaceholderIdxList) > 0 {
		dAtA51 := make([]byte, len(m.OldColCapturePlaceholderIdxList)*10)
		var j50 int
	...
	if len(m.UpdateColIdxList) > 0 {
		dAtA53 := make([]byte, len(m.UpdateColIdxList)*10)
		var j52 int
...
func (m *ProductL2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA70 := make([]byte, len(m.ColList)*10)
		var j69 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA72 := make([]byte, len(m.RelList)*10)
		var j71 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *IndexJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA74 := make([]byte, len(m.Result)*10)
		var j73 int
...
func (m *FileOffset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Offset) > 0 {
		dAtA77 := make([]byte, len(m.Offset)*10)
		var j76 int
...
func (m *IcebergDataFileTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SplitOffsets) > 0 {
		dAtA79 := make([]byte, len(m.SplitOffsets)*10)
		var j78 int
...
func (m *IcebergDeleteFileTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EqualityFieldIds) > 0 {
		dAtA81 := make([]byte, len(m.EqualityFieldIds)*10)
		var j80 int
...
func (m *IcebergSnapshotRuntime) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PartitionSpecIds) > 0 {
		dAtA84 := make([]byte, len(m.PartitionSpecIds)*10)
		var j83 int
...
func (m *ExternalScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IcebergHiddenReadColumns) > 0 {
		dAtA90 := make([]byte, len(m.IcebergHiddenReadColumns)*10)
		var j89 int
	...
	if len(m.FileSize) > 0 {
		dAtA94 := make([]byte, len(m.FileSize)*10)
		var j93 int
...
func (m *HashBuild) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DedupDeleteKeepColIdxList) > 0 {
		dAtA96 := make([]byte, len(m.DedupDeleteKeepColIdxList)*10)
		var j95 int
		for _, num1 := range m.DedupDeleteKeepColIdxList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *QuerySchedulingIntent) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QuerySchedulingIntent) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QuerySchedulingIntent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AlgorithmVersion) > 0 {
		i -= len(m.AlgorithmVersion)
		copy(dAtA[i:], m.AlgorithmVersion)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.AlgorithmVersion)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.SelectionKey) > 0 {
		i -= len(m.SelectionKey)
		copy(dAtA[i:], m.SelectionKey)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.SelectionKey)))
		i--
		dAtA[i] = 0x42
	}
	if m.MaxWorkers != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.MaxWorkers))
		i--
		dAtA[i] = 0x38
	}
	if m.WorkerSetMode != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.WorkerSetMode))
		i--
		dAtA[i] = 0x30
	}
	if m.CurrentCnPolicy != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.CurrentCnPolicy))
		i--
		dAtA[i] = 0x28
	}
	if m.EmptyWorkerPolicy != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.EmptyWorkerPolicy))
		i--
		dAtA[i] = 0x20
	}
	if m.PoolFallback != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.PoolFallback))
		i--
		dAtA[i] = 0x18
	}
	if len(m.RequestedPool) > 0 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.RequestedPool)))
		i--
		dAtA[i] = 0x12
	}
	if m.Explicit {
...
func (m *SessionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.QuerySchedulingIntent != nil {
		{
			size, err := m.QuerySchedulingIntent.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *QuerySchedulingIntent) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.PoolFallback != 0 {
		n += 1 + sovPipeline(uint64(m.PoolFallback))
	}
	if m.EmptyWorkerPolicy != 0 {
		n += 1 + sovPipeline(uint64(m.EmptyWorkerPolicy))
	}
	if m.CurrentCnPolicy != 0 {
		n += 1 + sovPipeline(uint64(m.CurrentCnPolicy))
	}
	if m.WorkerSetMode != 0 {
		n += 1 + sovPipeline(uint64(m.WorkerSetMode))
	}
	if m.MaxWorkers != 0 {
		n += 1 + sovPipeline(uint64(m.MaxWorkers))
	}
	l = len(m.SelectionKey)
	if l > 0 {
		n += 1 + l + sovPipeline(uint64(l))
	}
	l = len(m.AlgorithmVersion)
	if l > 0 {
		n += 1 + l + sovPipeline(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *SessionInfo) ProtoSize() (n int) {
	...
	if m.QuerySchedulingIntent != nil {
		l = m.QuerySchedulingIntent.ProtoSize()
		n += 2 + l + sovPipeline(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *QuerySchedulingIntent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuerySchedulingIntent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuerySchedulingIntent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PoolFallback", wireType)
			}
			m.PoolFallback = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PoolFallback |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmptyWorkerPolicy", wireType)
			}
			m.EmptyWorkerPolicy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EmptyWorkerPolicy |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentCnPolicy", wireType)
			}
			m.CurrentCnPolicy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CurrentCnPolicy |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WorkerSetMode", wireType)
			}
			m.WorkerSetMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkerSetMode |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelectionKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SelectionKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			m.AlgorithmVersion = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPipeline(dAtA[iNdEx:])
...
func (m *SessionInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CnLabels", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CnLabels == nil {
				m.CnLabels = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.CnLabels[mapkey] = mapvalue
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuerySchedulingIntent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.QuerySchedulingIntent == nil {
				m.QuerySchedulingIntent = &QuerySchedulingIntent{}
			}
			if err := m.QuerySchedulingIntent.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
