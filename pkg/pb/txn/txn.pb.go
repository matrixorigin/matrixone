...
type TxnRequestOptions struct {
	...
	// on the server side.
	RetryCodes []ErrorCode `protobuf:"varint,1,rep,packed,name=RetryCodes,proto3,enum=txn.ErrorCode" json:"RetryCodes,omitempty"`
...
func (m *TxnRequestOptions) GetRetryCodes() []ErrorCode {
	if m != nil {
		return m.RetryCodes
	}
	return nil
...
var fileDescriptor_4f782e76b37adb9a = []byte{
	...
	,
}
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.RetryCodes) == 0 {
					m.RetryCodes = make([]ErrorCode, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v ErrorCode
					for shift := uint(0); ; shift += 7 {
