...
type TxnMeta struct {
	...
	DisableTrace         bool     `protobuf:"varint,12,opt,name=DisableTrace,proto3" json:"DisableTrace,omitempty"`
	DisableLock          bool     `protobuf:"varint,13,opt,name=DisableLock,proto3" json:"DisableLock,omitempty"`
...
func (m *TxnMeta) GetDisableTrace() bool {
	if m != nil {
...
func (m *TxnMeta) GetDisableLock() bool {
	if m != nil {
		return m.DisableLock
	}
	return false
}
...
var fileDescriptor_4f782e76b37adb9a = []byte{
	...
	,
}
...
func (m *TxnMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableTrace", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableTrace = bool(v != 0)
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableLock", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
