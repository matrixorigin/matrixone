...
type StatsInfo struct {
	...
	TimeSecond           int64                    `protobuf:"varint,13,opt,name=TimeSecond,proto3" json:"TimeSecond,omitempty"`
}
...
func (m *StatsInfo) GetTimeSecond() int64 {
	if m != nil {
		return m.TimeSecond
	}
	return 0
...
var fileDescriptor_a3f8e561c9795adb = []byte{
	...
	,
}
...
func (m *StatsInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TimeSecond != 0 {
		i = encodeVarintStatsinfo(dAtA, i, uint64(m.TimeSecond))
		i--
		dAtA[i] = 0x68
	}
...
func (m *StatsInfo) ProtoSize() (n int) {
	...
	if m.TimeSecond != 0 {
		n += 1 + sovStatsinfo(uint64(m.TimeSecond))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TimeSecond |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
