...
type StatsInfo struct {
	...
	ManualAnalyzed       bool                     `protobuf:"varint,14,opt,name=ManualAnalyzed,proto3" json:"ManualAnalyzed,omitempty"`
}
...
func (m *StatsInfo) GetManualAnalyzed() bool {
	if m != nil {
		return m.ManualAnalyzed
	}
	return false
}
...
var fileDescriptor_a3f8e561c9795adb = []byte{
	...
	,
}
...
func (m *StatsInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManualAnalyzed", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
