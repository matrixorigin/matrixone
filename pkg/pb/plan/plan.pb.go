...
type Administration_AdminType int32

const (
	Administration_CREATE_ACCOUNT   Administration_AdminType = 0
	Administration_ALTER_ACCOUNT    Administration_AdminType = 1
	Administration_DROP_ACCOUNT     Administration_AdminType = 2
	Administration_CREATE_USER      Administration_AdminType = 3
	Administration_ALTER_USER       Administration_AdminType = 4
	Administration_DROP_USER        Administration_AdminType = 5
	Administration_CREATE_ROLE      Administration_AdminType = 6
	Administration_GRANT_PRIVILEGE  Administration_AdminType = 7
	Administration_GRANT_ROLE       Administration_AdminType = 8
	Administration_REVOKE_PRIVILEGE Administration_AdminType = 9
	Administration_REVOKE_ROLE      Administration_AdminType = 10
	Administration_USE_ROLE         Administration_AdminType = 11
)

var Administration_AdminType_name = map[int32]string{
	0:  "CREATE_ACCOUNT",
	1:  "ALTER_ACCOUNT",
	2:  "DROP_ACCOUNT",
	3:  "CREATE_USER",
...
var Administration_AdminType_value = map[string]int32{
	"CREATE_ACCOUNT":   0,
	"ALTER_ACCOUNT":    1,
	"DROP_ACCOUNT":     2,
	"CREATE_USER":      3,
...
func (x Administration_AdminType) String() string {
	return proto.EnumName(Administration_AdminType_name, int32(x))
}

func (Administration_AdminType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{56, 0}
}

type AccountIdentified_AccountIdentifiedOption int32

const (
	AccountIdentified_ACCOUNT_IDENTIFIED_BY_PASSWORD        AccountIdentified_AccountIdentifiedOption = 0
	AccountIdentified_ACCOUNT_IDENTIFIED_BY_RANDOM_PASSWORD AccountIdentified_AccountIdentifiedOption = 1
	AccountIdentified_ACCOUNT_IDENTIFIED_WITH_SSL           AccountIdentified_AccountIdentifiedOption = 2
)

var AccountIdentified_AccountIdentifiedOption_name = map[int32]string{
	0: "ACCOUNT_IDENTIFIED_BY_PASSWORD",
	1: "ACCOUNT_IDENTIFIED_BY_RANDOM_PASSWORD",
	2: "ACCOUNT_IDENTIFIED_WITH_SSL",
}

var AccountIdentified_AccountIdentifiedOption_value = map[string]int32{
	"ACCOUNT_IDENTIFIED_BY_PASSWORD":        0,
	"ACCOUNT_IDENTIFIED_BY_RANDOM_PASSWORD": 1,
	"ACCOUNT_IDENTIFIED_WITH_SSL":           2,
}

func (x AccountIdentified_AccountIdentifiedOption) String() string {
	return proto.EnumName(AccountIdentified_AccountIdentifiedOption_name, int32(x))
}

func (AccountIdentified_AccountIdentifiedOption) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{59, 0}
}

type AccountStatus_AccountStatusOption int32

const (
	AccountStatus_ACCOUNT_STATUS_OPEN    AccountStatus_AccountStatusOption = 0
	AccountStatus_ACCOUNT_STATUS_SUSPEND AccountStatus_AccountStatusOption = 1
)

var AccountStatus_AccountStatusOption_name = map[int32]string{
	0: "ACCOUNT_STATUS_OPEN",
	1: "ACCOUNT_STATUS_SUSPEND",
}

var AccountStatus_AccountStatusOption_value = map[string]int32{
	"ACCOUNT_STATUS_OPEN":    0,
	"ACCOUNT_STATUS_SUSPEND": 1,
}

func (x AccountStatus_AccountStatusOption) String() string {
	return proto.EnumName(AccountStatus_AccountStatusOption_name, int32(x))
}

func (AccountStatus_AccountStatusOption) EnumDescriptor() ([]byte, []int) {
...
type Plan_Admin struct {
	Admin *Administration `protobuf:"bytes,6,opt,name=admin,proto3,oneof" json:"admin,omitempty"`
}
...
func (m *Plan) GetAdmin() *Administration {
	if x, ok := m.GetPlan().(*Plan_Admin); ok {
		return x.Admin
	}
	return nil
}
...
type Administration struct {
	AdminType Administration_AdminType `protobuf:"varint,1,opt,name=admin_type,json=adminType,proto3,enum=plan.Administration_AdminType" json:"admin_type,omitempty"`
	// Types that are valid to be assigned to Definition:
	//	*Administration_CreateAccount
	Definition           isAdministration_Definition `protobuf_oneof:"definition"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *Administration) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Administration) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Administration.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Administration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Administration.Merge(m, src)
}
func (m *Administration) XXX_Size() int {
	return m.ProtoSize()
}
func (m *Administration) XXX_DiscardUnknown() {
	xxx_messageInfo_Administration.DiscardUnknown(m)
}

var xxx_messageInfo_Administration proto.InternalMessageInfo

type isAdministration_Definition interface {
	isAdministration_Definition()
	MarshalTo([]byte) (int, error)
	ProtoSize() int
}

type Administration_CreateAccount struct {
	CreateAccount *CreateAccount `protobuf:"bytes,2,opt,name=create_account,json=createAccount,proto3,oneof" json:"create_account,omitempty"`
}

func (*Administration_CreateAccount) isAdministration_Definition() {}

func (m *Administration) GetDefinition() isAdministration_Definition {
	if m != nil {
		return m.Definition
	}
	return nil
...
func (m *Administration) GetAdminType() Administration_AdminType {
	if m != nil {
		return m.AdminType
	}
	return Administration_CREATE_ACCOUNT
}

func (m *Administration) GetCreateAccount() *CreateAccount {
	if x, ok := m.GetDefinition().(*Administration_CreateAccount); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*Administration) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Administration_CreateAccount)(nil),
	}
}
...
type CreateAccount struct {
	IfNotExists          bool               `protobuf:"varint,1,opt,name=if_not_exists,json=ifNotExists,proto3" json:"if_not_exists,omitempty"`
	Name                 string             `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	AuthOption           *AccountAuthOption `protobuf:"bytes,3,opt,name=auth_option,json=authOption,proto3" json:"auth_option,omitempty"`
	StatusOption         *AccountStatus     `protobuf:"bytes,4,opt,name=status_option,json=statusOption,proto3" json:"status_option,omitempty"`
	AccountComment       *AccountComment    `protobuf:"bytes,5,opt,name=account_comment,json=accountComment,proto3" json:"account_comment,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *CreateAccount) GetIfNotExists() bool {
	if m != nil {
		return m.IfNotExists
	}
	return false
...
func (m *CreateAccount) GetAuthOption() *AccountAuthOption {
	if m != nil {
		return m.AuthOption
	}
	return nil
...
func (m *CreateAccount) GetStatusOption() *AccountStatus {
	if m != nil {
		return m.StatusOption
	}
	return nil
}

func (m *CreateAccount) GetAccountComment() *AccountComment {
	if m != nil {
		return m.AccountComment
	}
	return nil
}
...
type AccountAuthOption struct {
	...
	IdentifiedType       *AccountIdentified `protobuf:"bytes,2,opt,name=identified_type,json=identifiedType,proto3" json:"identified_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *AccountAuthOption) Reset()         { *m = AccountAuthOption{} }
func (m *AccountAuthOption) String() string { return proto.CompactTextString(m) }
func (*AccountAuthOption) ProtoMessage()    {}
func (*AccountAuthOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{58}
}
func (m *AccountAuthOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccountAuthOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccountAuthOption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccountAuthOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountAuthOption.Merge(m, src)
}
func (m *AccountAuthOption) XXX_Size() int {
	return m.ProtoSize()
}
func (m *AccountAuthOption) XXX_DiscardUnknown() {
	xxx_messageInfo_AccountAuthOption.DiscardUnknown(m)
}

var xxx_messageInfo_AccountAuthOption proto.InternalMessageInfo

func (m *AccountAuthOption) GetAdminName() string {
	if m != nil {
		return m.AdminName
	}
	return ""
...
func (m *AccountAuthOption) GetIdentifiedType() *AccountIdentified {
	if m != nil {
		return m.IdentifiedType
	}
	return nil
}

type AccountIdentified struct {
	Typ                  AccountIdentified_AccountIdentifiedOption `protobuf:"varint,1,opt,name=Typ,proto3,enum=plan.AccountIdentified_AccountIdentifiedOption" json:"Typ,omitempty"`
...
func (m *AccountIdentified) Reset()         { *m = AccountIdentified{} }
func (m *AccountIdentified) String() string { return proto.CompactTextString(m) }
func (*AccountIdentified) ProtoMessage()    {}
func (*AccountIdentified) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{59}
}
func (m *AccountIdentified) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccountIdentified) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccountIdentified.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccountIdentified) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountIdentified.Merge(m, src)
}
func (m *AccountIdentified) XXX_Size() int {
	return m.ProtoSize()
}
func (m *AccountIdentified) XXX_DiscardUnknown() {
	xxx_messageInfo_AccountIdentified.DiscardUnknown(m)
}

var xxx_messageInfo_AccountIdentified proto.InternalMessageInfo

func (m *AccountIdentified) GetTyp() AccountIdentified_AccountIdentifiedOption {
	if m != nil {
		return m.Typ
	}
	return AccountIdentified_ACCOUNT_IDENTIFIED_BY_PASSWORD
}

func (m *AccountIdentified) GetStr() string {
	if m != nil {
		return m.Str
	}
	return ""
...
type AccountStatus struct {
	Option               AccountStatus_AccountStatusOption `protobuf:"varint,1,opt,name=option,proto3,enum=plan.AccountStatus_AccountStatusOption" json:"option,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
func (m *AccountStatus) GetOption() AccountStatus_AccountStatusOption {
	if m != nil {
		return m.Option
	}
	return AccountStatus_ACCOUNT_STATUS_OPEN
}
...
func (m *AccountComment) Reset()         { *m = AccountComment{} }
func (m *AccountComment) String() string { return proto.CompactTextString(m) }
func (*AccountComment) ProtoMessage()    {}
func (*AccountComment) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{61}
}
func (m *AccountComment) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccountComment) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccountComment.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccountComment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountComment.Merge(m, src)
}
func (m *AccountComment) XXX_Size() int {
	return m.ProtoSize()
}
func (m *AccountComment) XXX_DiscardUnknown() {
	xxx_messageInfo_AccountComment.DiscardUnknown(m)
}

var xxx_messageInfo_AccountComment proto.InternalMessageInfo

func (m *AccountComment) GetComment() string {
	if m != nil {
		return m.Comment
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("plan.Administration_AdminType", Administration_AdminType_name, Administration_AdminType_value)
	proto.RegisterEnum("plan.AccountIdentified_AccountIdentifiedOption", AccountIdentified_AccountIdentifiedOption_name, AccountIdentified_AccountIdentifiedOption_value)
	proto.RegisterEnum("plan.AccountStatus_AccountStatusOption", AccountStatus_AccountStatusOption_name, AccountStatus_AccountStatusOption_value)
	...
	proto.RegisterType((*Administration)(nil), "plan.Administration")
	proto.RegisterType((*CreateAccount)(nil), "plan.CreateAccount")
	proto.RegisterType((*AccountAuthOption)(nil), "plan.AccountAuthOption")
	proto.RegisterType((*AccountIdentified)(nil), "plan.AccountIdentified")
	proto.RegisterType((*AccountStatus)(nil), "plan.AccountStatus")
	proto.RegisterType((*AccountComment)(nil), "plan.AccountComment")
}
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
...
func (m *Plan_Admin) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Plan_Admin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Admin != nil {
		{
...
func (m *Administration) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Administration) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Administration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.AdminType != 0 {
		i = encodeVarintPlan(dAtA, i, uint64(m.AdminType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Administration_CreateAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Administration_CreateAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CreateAccount != nil {
		{
			size, err := m.CreateAccount.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CreateAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AccountComment != nil {
		{
			size, err := m.AccountComment.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.StatusOption != nil {
		{
			size, err := m.StatusOption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AuthOption != nil {
		{
			size, err := m.AuthOption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AccountAuthOption) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccountAuthOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccountAuthOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.IdentifiedType != nil {
		{
			size, err := m.IdentifiedType.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.AdminName) > 0 {
		...
		i = encodeVarintPlan(dAtA, i, uint64(len(m.AdminName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AccountIdentified) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccountIdentified) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccountIdentified) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AccountStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Option != 0 {
		i = encodeVarintPlan(dAtA, i, uint64(m.Option))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AccountComment) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccountComment) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccountComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Plan_Admin) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Administration) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AdminType != 0 {
		n += 1 + sovPlan(uint64(m.AdminType))
	}
	if m.Definition != nil {
		n += m.Definition.ProtoSize()
	}
...
func (m *Administration_CreateAccount) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CreateAccount != nil {
		l = m.CreateAccount.ProtoSize()
		n += 1 + l + sovPlan(uint64(l))
	}
	return n
}
func (m *CreateAccount) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.AuthOption != nil {
		l = m.AuthOption.ProtoSize()
		n += 1 + l + sovPlan(uint64(l))
	}
	if m.StatusOption != nil {
		l = m.StatusOption.ProtoSize()
		n += 1 + l + sovPlan(uint64(l))
	}
	if m.AccountComment != nil {
		l = m.AccountComment.ProtoSize()
		n += 1 + l + sovPlan(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *AccountAuthOption) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccountIdentified) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccountStatus) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccountComment) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Administration) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Administration: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Administration: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AdminType |= Administration_AdminType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			m.Definition = &Administration_CreateAccount{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPlan(dAtA[iNdEx:])
...
func (m *CreateAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthOption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AuthOption == nil {
				m.AuthOption = &AccountAuthOption{}
			}
			if err := m.AuthOption.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatusOption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StatusOption == nil {
				m.StatusOption = &AccountStatus{}
			}
			if err := m.StatusOption.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AccountComment", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AccountComment == nil {
				m.AccountComment = &AccountComment{}
			}
			if err := m.AccountComment.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AccountAuthOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccountAuthOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccountAuthOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdentifiedType", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IdentifiedType == nil {
				m.IdentifiedType = &AccountIdentified{}
			}
			if err := m.IdentifiedType.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AccountIdentified) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccountIdentified: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccountIdentified: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Typ |= AccountIdentified_AccountIdentifiedOption(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Option |= AccountStatus_AccountStatusOption(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AccountComment) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccountComment: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccountComment: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
