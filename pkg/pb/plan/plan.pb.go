...
type ExplainOption_FormatType int32

const (
	ExplainOption_TEXT ExplainOption_FormatType = 0
	ExplainOption_XML  ExplainOption_FormatType = 1
	ExplainOption_JSON ExplainOption_FormatType = 2
	ExplainOption_DOT  ExplainOption_FormatType = 3
)

var ExplainOption_FormatType_name = map[int32]string{
	0: "TEXT",
	1: "XML",
	2: "JSON",
	3: "DOT",
...
var ExplainOption_FormatType_value = map[string]int32{
	"TEXT": 0,
	"XML":  1,
	"JSON": 2,
	"DOT":  3,
...
func (x ExplainOption_FormatType) String() string {
	return proto.EnumName(ExplainOption_FormatType_name, int32(x))
}

func (ExplainOption_FormatType) EnumDescriptor() ([]byte, []int) {
...
func (Node_JoinFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{33, 1}
}
...
func (Node_AggMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{33, 2}
}
...
type ExplainOption struct {
	...
	Analyze              bool                     `protobuf:"varint,2,opt,name=Analyze,proto3" json:"Analyze,omitempty"`
	Format               ExplainOption_FormatType `protobuf:"varint,3,opt,name=format,proto3,enum=plan.ExplainOption_FormatType" json:"format,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *ExplainOption) Reset()         { *m = ExplainOption{} }
func (m *ExplainOption) String() string { return proto.CompactTextString(m) }
func (*ExplainOption) ProtoMessage()    {}
func (*ExplainOption) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{32}
}
func (m *ExplainOption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ExplainOption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExplainOption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ExplainOption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExplainOption.Merge(m, src)
}
func (m *ExplainOption) XXX_Size() int {
	return m.ProtoSize()
}
func (m *ExplainOption) XXX_DiscardUnknown() {
	xxx_messageInfo_ExplainOption.DiscardUnknown(m)
}

var xxx_messageInfo_ExplainOption proto.InternalMessageInfo

func (m *ExplainOption) GetVerbose() bool {
	if m != nil {
		return m.Verbose
	}
	return false
...
func (m *ExplainOption) GetAnalyze() bool {
	if m != nil {
		return m.Analyze
	}
	return false
...
func (m *ExplainOption) GetFormat() ExplainOption_FormatType {
	if m != nil {
		return m.Format
	}
	return ExplainOption_TEXT
}
...
type Query struct {
	...
	// explain opertion information
	ExplainOption        *ExplainOption `protobuf:"bytes,6,opt,name=explain_option,json=explainOption,proto3" json:"explain_option,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *Query) GetExplainOption() *ExplainOption {
	if m != nil {
		return m.ExplainOption
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("plan.ExplainOption_FormatType", ExplainOption_FormatType_name, ExplainOption_FormatType_value)
	...
	proto.RegisterType((*ExplainOption)(nil), "plan.ExplainOption")
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	// 5103 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ColData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.F64) > 0 {
		for iNdEx := len(m.F64) - 1; iNdEx >= 0; iNdEx-- {
			f27 := math.Float64bits(float64(m.F64[iNdEx]))
			i -= 8
	...
	if len(m.F32) > 0 {
		for iNdEx := len(m.F32) - 1; iNdEx >= 0; iNdEx-- {
			f28 := math.Float32bits(float32(m.F32[iNdEx]))
			i -= 4
...
func (m *ExplainOption) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ExplainOption) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ExplainOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Format != 0 {
		i = encodeVarintPlan(dAtA, i, uint64(m.Format))
		i--
		dAtA[i] = 0x18
	}
	if m.Analyze {
...
func (m *Node) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BindingTags) > 0 {
		dAtA37 := make([]byte, len(m.BindingTags)*10)
		var j36 int
	...
	if len(m.Children) > 0 {
		dAtA45 := make([]byte, len(m.Children)*10)
		var j44 int
...
func (m *Query) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExplainOption != nil {
		{
			size, err := m.ExplainOption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.Steps) > 0 {
		dAtA49 := make([]byte, len(m.Steps)*10)
		var j48 int
...
func (m *Prepare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ParamTypes) > 0 {
		dAtA80 := make([]byte, len(m.ParamTypes)*10)
		var j79 int
...
func (m *ExplainOption) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ExplainOption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExplainOption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExplainOption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Format |= ExplainOption_FormatType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Query) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExplainOption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExplainOption == nil {
				m.ExplainOption = &ExplainOption{}
			}
			if err := m.ExplainOption.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
