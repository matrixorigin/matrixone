...
type CreateTable struct {
	...
	// we need the table name of foreign key when create table. but we don't need it in ForeignKeyDef
	FkTables []string `protobuf:"bytes,6,rep,name=fk_tables,json=fkTables,proto3" json:"fk_tables,omitempty"`
	// we need column name when create table, but not in ForeignKeyDef
	FkCols               []*CreateTable_FkColName `protobuf:"bytes,7,rep,name=fk_cols,json=fkCols,proto3" json:"fk_cols,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
	...
	0x0f, 0x01, 0x88, 0x8d, 0x49, 0x2d, 0x75, 0x5d, 0xd9, 0xa8, 0x70, 0x01, 0xe8, 0x7f, 0x5d, 0x84,
	...
	0x1a, 0x50, 0x72, 0xef, 0x3e, 0x40, 0x42, 0x5e, 0x12, 0x24, 0x4c, 0x94, 0x7b, 0x9b, 0x48, 0x29,
	0xa4, 0x14, 0x82, 0x89, 0xf2, 0xe0, 0x3e, 0x52, 0x70, 0x22, 0x79, 0xa2, 0x10, 0x8c, 0xa3, 0xcc,
	...
	,
	...
	0xcb, 0x33, 0x12, 0x04, 0x76, 0x15, 0xd4, 0x30, 0x38, 0x32, 0xc9, 0x8a, 0x0a, 0xf3, 0x5a, 0x0e,
	0x83, 0xa3, 0xbe, 0xfb, 0x95, 0xa3, 0x0f, 0xa4, 0x9d, 0x07, 0x28, 0xf5, 0x5b, 0xcd, 0x4e, 0x93,
	...
	0x37, 0x7c, 0xe6, 0x8c, 0x62, 0x9c, 0x33, 0x1e, 0x47, 0x27, 0x7c, 0xee, 0x84, 0x34, 0xed, 0x3c,
	0x97, 0x10, 0x4e, 0xc4, 0x1e, 0xd2, 0xe4, 0xf2, 0x3c, 0x67, 0x0f, 0x89, 0x6f, 0x74, 0xe0, 0x4c,
	0x2d, 0x9a, 0x1c, 0xf2, 0x11, 0x84, 0xc7, 0x3f, 0x18, 0x3e, 0xa3, 0xe9, 0xe5, 0x39, 0x36, 0xd9,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x2f, 0x53, 0x67, 0x1a, 0x84, 0x27, 0x66, 0xfa, 0x24, 0x20, 0xcf, 0x41, 0xa0, 0xc8, 0xa2,
	0xfd, 0x73, 0x1d, 0x0a, 0xdd, 0xc0, 0x76, 0x30, 0xe2, 0xa0, 0xcf, 0x67, 0x67, 0xeb, 0x11, 0x48,
	...
	,
	...
	,
}
