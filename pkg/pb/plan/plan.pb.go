...
const (
	...
	// Monotonical function can filter by zonemap
	Function_MONOTONICAL Function_FuncFlag = 512
)
...
func (Node_JoinFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{35, 1}
}
...
func (Node_AggMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{35, 2}
}
...
type Const struct {
	...
	IsBin                bool          `protobuf:"varint,16,opt,name=isBin,proto3" json:"isBin,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
type ColDef struct {
	...
	IsCPkey              bool         `protobuf:"varint,9,opt,name=is_cPkey,json=isCPkey,proto3" json:"is_cPkey,omitempty"`
	OnUpdate             *Expr        `protobuf:"bytes,10,opt,name=on_update,json=onUpdate,proto3" json:"on_update,omitempty"`
	LowCardinality       bool         `protobuf:"varint,11,opt,name=low_cardinality,json=lowCardinality,proto3" json:"low_cardinality,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *ColDef) GetOnUpdate() *Expr {
	if m != nil {
		return m.OnUpdate
	}
	return nil
...
type PartitionInfo struct {
	...
	Expr                 *Expr            `protobuf:"bytes,2,opt,name=Expr,json=expr,proto3" json:"Expr,omitempty"`
	PartitionExpression  string           `protobuf:"bytes,3,opt,name=partitionExpression,proto3" json:"partitionExpression,omitempty"`
	Columns              []*Expr          `protobuf:"bytes,4,rep,name=Columns,json=columns,proto3" json:"Columns,omitempty"`
...
func (m *PartitionInfo) GetPartitionExpression() string {
	if m != nil {
...
func (m *ComputeIndexDef) Reset()         { *m = ComputeIndexDef{} }
func (m *ComputeIndexDef) String() string { return proto.CompactTextString(m) }
func (*ComputeIndexDef) ProtoMessage()    {}
func (*ComputeIndexDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{24}
}
func (m *ComputeIndexDef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ComputeIndexDef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ComputeIndexDef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ComputeIndexDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ComputeIndexDef.Merge(m, src)
}
func (m *ComputeIndexDef) XXX_Size() int {
	return m.ProtoSize()
}
func (m *ComputeIndexDef) XXX_DiscardUnknown() {
	xxx_messageInfo_ComputeIndexDef.DiscardUnknown(m)
}

var xxx_messageInfo_ComputeIndexDef proto.InternalMessageInfo

func (m *ComputeIndexDef) GetNames() []string {
	if m != nil {
		return m.Names
	}
	return nil
...
func (m *ComputeIndexDef) GetTableNames() []string {
	if m != nil {
		return m.TableNames
	}
	return nil
...
func (m *ComputeIndexDef) GetUniques() []bool {
	if m != nil {
		return m.Uniques
	}
	return nil
...
type ComputeIndexInfo struct {
	...
	Attrs                []string  `protobuf:"bytes,2,rep,name=attrs,proto3" json:"attrs,omitempty"`
...
func (m *ComputeIndexInfo) Reset()         { *m = ComputeIndexInfo{} }
func (m *ComputeIndexInfo) String() string { return proto.CompactTextString(m) }
func (*ComputeIndexInfo) ProtoMessage()    {}
func (*ComputeIndexInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{25}
}
func (m *ComputeIndexInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ComputeIndexInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ComputeIndexInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ComputeIndexInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ComputeIndexInfo.Merge(m, src)
}
func (m *ComputeIndexInfo) XXX_Size() int {
	return m.ProtoSize()
}
func (m *ComputeIndexInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_ComputeIndexInfo.DiscardUnknown(m)
}

var xxx_messageInfo_ComputeIndexInfo proto.InternalMessageInfo

func (m *ComputeIndexInfo) GetTableName() string {
	if m != nil {
		return m.TableName
	}
	return ""
...
func (m *ComputeIndexInfo) GetAttrs() []string {
	if m != nil {
		return m.Attrs
	}
	return nil
...
func (m *ComputeIndexInfo) GetCols() []*ColDef {
	if m != nil {
		return m.Cols
	}
	return nil
...
type TableDef struct {
	...
	ComputeIndexInfos    []*ComputeIndexInfo `protobuf:"bytes,9,rep,name=compute_index_infos,json=computeIndexInfos,proto3" json:"compute_index_infos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *TableDef) GetComputeIndexInfos() []*ComputeIndexInfo {
	if m != nil {
		return m.ComputeIndexInfos
	}
	return nil
}
...
func (*TableDef_DefType) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{26, 0}
}
...
type TableDef_DefType_ComputeIndex struct {
	ComputeIndex *ComputeIndexDef `protobuf:"bytes,6,opt,name=compute_index,json=computeIndex,proto3,oneof" json:"compute_index,omitempty"`
}
...
func (*TableDef_DefType_ComputeIndex) isTableDef_DefType_Def() {}
...
func (m *TableDef_DefType) GetComputeIndex() *ComputeIndexDef {
	if x, ok := m.GetDef().(*TableDef_DefType_ComputeIndex); ok {
		return x.ComputeIndex
	}
	return nil
}
...
func (*TableDef_DefType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*TableDef_DefType_ComputeIndex)(nil),
	}
}
...
type DeleteTableCtx struct {
	...
	ColIndex             int32               `protobuf:"varint,6,opt,name=colIndex,proto3" json:"colIndex,omitempty"`
	ComputeIndexInfos    []*ComputeIndexInfo `protobuf:"bytes,7,rep,name=compute_index_infos,json=computeIndexInfos,proto3" json:"compute_index_infos,omitempty"`
...
func (m *DeleteTableCtx) GetComputeIndexInfos() []*ComputeIndexInfo {
	if m != nil {
		return m.ComputeIndexInfos
	}
	return nil
...
type InsertValues struct {
	...
	CompositePkey        *ColDef             `protobuf:"bytes,7,opt,name=composite_pkey,json=compositePkey,proto3" json:"composite_pkey,omitempty"`
	ComputeIndexInfos    []*ComputeIndexInfo `protobuf:"bytes,8,rep,name=compute_index_infos,json=computeIndexInfos,proto3" json:"compute_index_infos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *InsertValues) GetComputeIndexInfos() []*ComputeIndexInfo {
	if m != nil {
		return m.ComputeIndexInfos
	}
	return nil
...
type IndexTableInfo struct {
	IndexTableName       string    `protobuf:"bytes,1,opt,name=index_table_name,json=indexTableName,proto3" json:"index_table_name,omitempty"`
	Cols                 []*ColDef `protobuf:"bytes,2,rep,name=cols,proto3" json:"cols,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
...
func (m *IndexTableInfo) Reset()         { *m = IndexTableInfo{} }
func (m *IndexTableInfo) String() string { return proto.CompactTextString(m) }
func (*IndexTableInfo) ProtoMessage()    {}
func (*IndexTableInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{63}
}
func (m *IndexTableInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IndexTableInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IndexTableInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IndexTableInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexTableInfo.Merge(m, src)
}
func (m *IndexTableInfo) XXX_Size() int {
	return m.ProtoSize()
}
func (m *IndexTableInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexTableInfo.DiscardUnknown(m)
}

var xxx_messageInfo_IndexTableInfo proto.InternalMessageInfo

func (m *IndexTableInfo) GetIndexTableName() string {
	if m != nil {
...
func (m *IndexTableInfo) GetCols() []*ColDef {
	if m != nil {
		return m.Cols
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ComputeIndexDef)(nil), "plan.ComputeIndexDef")
	proto.RegisterType((*ComputeIndexInfo)(nil), "plan.ComputeIndexInfo")
	...
	proto.RegisterType((*IndexTableInfo)(nil), "plan.IndexTableInfo")
}
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
...
func (m *PartitionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PartitionExpression) > 0 {
		i -= len(m.PartitionExpression)
		copy(dAtA[i:], m.PartitionExpression)
		i = encodeVarintPlan(dAtA, i, uint64(len(m.PartitionExpression)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Expr != nil {
...
func (m *ComputeIndexDef) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ComputeIndexDef) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ComputeIndexDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ComputeIndexInfo) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ComputeIndexInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ComputeIndexInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TableDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ComputeIndexInfos) > 0 {
		for iNdEx := len(m.ComputeIndexInfos) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ComputeIndexInfos[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TableDef_DefType_ComputeIndex) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TableDef_DefType_ComputeIndex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ComputeIndex != nil {
		{
			size, err := m.ComputeIndex.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ColData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.F64) > 0 {
		for iNdEx := len(m.F64) - 1; iNdEx >= 0; iNdEx-- {
			f30 := math.Float64bits(float64(m.F64[iNdEx]))
			i -= 8
	...
	if len(m.F32) > 0 {
		for iNdEx := len(m.F32) - 1; iNdEx >= 0; iNdEx-- {
			f31 := math.Float32bits(float32(m.F32[iNdEx]))
			i -= 4
...
func (m *Node) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BindingTags) > 0 {
		dAtA41 := make([]byte, len(m.BindingTags)*10)
		var j40 int
	...
	if len(m.Children) > 0 {
		dAtA49 := make([]byte, len(m.Children)*10)
		var j48 int
...
func (m *Query) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Steps) > 0 {
		dAtA52 := make([]byte, len(m.Steps)*10)
		var j51 int
...
func (m *Prepare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ParamTypes) > 0 {
		dAtA83 := make([]byte, len(m.ParamTypes)*10)
		var j82 int
...
func (m *IndexTableInfo) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IndexTableInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IndexTableInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ComputeIndexDef) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ComputeIndexInfo) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TableDef) ProtoSize() (n int) {
	...
	if len(m.ComputeIndexInfos) > 0 {
		for _, e := range m.ComputeIndexInfos {
			l = e.ProtoSize()
			n += 1 + l + sovPlan(uint64(l))
		}
	}
...
func (m *TableDef_DefType_ComputeIndex) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IndexTableInfo) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PartitionInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.PartitionExpression = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *ComputeIndexDef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ComputeIndexDef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ComputeIndexDef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ComputeIndexInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ComputeIndexInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ComputeIndexInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TableDef) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComputeIndexInfos", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ComputeIndexInfos = append(m.ComputeIndexInfos, &ComputeIndexInfo{})
			if err := m.ComputeIndexInfos[len(m.ComputeIndexInfos)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TableDef_DefType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComputeIndex", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Def = &TableDef_DefType_ComputeIndex{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPlan(dAtA[iNdEx:])
...
func (m *IndexTableInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexTableInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexTableInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
