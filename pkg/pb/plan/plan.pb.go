...
type Node struct {
	...
	DeleteCtx       *DeleteTableCtx `protobuf:"bytes,22,opt,name=delete_ctx,json=deleteCtx,proto3" json:"delete_ctx,omitempty"`
...
func (m *Node) GetDeleteCtx() *DeleteTableCtx {
	if m != nil {
		return m.DeleteCtx
	}
	return nil
...
type DeleteTableCtx struct {
	...
	OnSetAttrs           []*DeleteTableCtxAttrs  `protobuf:"bytes,9,rep,name=on_set_attrs,json=onSetAttrs,proto3" json:"on_set_attrs,omitempty"`
	OnSetIdx             []*DeleteTableCtxIdList `protobuf:"bytes,10,rep,name=on_set_idx,json=onSetIdx,proto3" json:"on_set_idx,omitempty"`
	CanTruncate          bool                    `protobuf:"varint,11,opt,name=can_truncate,json=canTruncate,proto3" json:"can_truncate,omitempty"`
	ParentIds            []*DeleteTableCtxIdList `protobuf:"bytes,12,rep,name=parent_ids,json=parentIds,proto3" json:"parent_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *DeleteTableCtx) GetDelRef() []*ObjectRef {
	if m != nil {
		return m.DelRef
	}
	return nil
...
func (m *DeleteTableCtx) GetDelIdxRef() []*ObjectRef {
	if m != nil {
		return m.DelIdxRef
	}
	return nil
...
func (m *DeleteTableCtx) GetDelIdxIdx() []int32 {
	if m != nil {
		return m.DelIdxIdx
	}
	return nil
...
func (m *DeleteTableCtx) GetOnRestrictRef() []*ObjectRef {
	if m != nil {
...
func (m *DeleteTableCtx) GetOnRestrictIdx() []int32 {
	if m != nil {
...
func (m *DeleteTableCtx) GetOnCascadeRef() []*ObjectRef {
	if m != nil {
...
func (m *DeleteTableCtx) GetOnCascadeIdx() []int32 {
	if m != nil {
...
func (m *DeleteTableCtx) GetOnSetRef() []*ObjectRef {
	if m != nil {
		return m.OnSetRef
	}
	return nil
...
func (m *DeleteTableCtx) GetOnSetAttrs() []*DeleteTableCtxAttrs {
	if m != nil {
		return m.OnSetAttrs
	}
	return nil
...
func (m *DeleteTableCtx) GetOnSetIdx() []*DeleteTableCtxIdList {
	if m != nil {
		return m.OnSetIdx
	}
	return nil
...
func (m *DeleteTableCtx) GetParentIds() []*DeleteTableCtxIdList {
	if m != nil {
		return m.ParentIds
	}
	return nil
...
type DeleteTableCtxIdList struct {
...
func (m *DeleteTableCtxIdList) Reset()         { *m = DeleteTableCtxIdList{} }
func (m *DeleteTableCtxIdList) String() string { return proto.CompactTextString(m) }
func (*DeleteTableCtxIdList) ProtoMessage()    {}
func (*DeleteTableCtxIdList) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{46, 0}
}
func (m *DeleteTableCtxIdList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeleteTableCtxIdList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeleteTableCtxIdList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DeleteTableCtxIdList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteTableCtxIdList.Merge(m, src)
}
func (m *DeleteTableCtxIdList) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DeleteTableCtxIdList) XXX_DiscardUnknown() {
	xxx_messageInfo_DeleteTableCtxIdList.DiscardUnknown(m)
}

var xxx_messageInfo_DeleteTableCtxIdList proto.InternalMessageInfo

func (m *DeleteTableCtxIdList) GetList() []int64 {
	if m != nil {
		return m.List
	}
	return nil
...
type DeleteTableCtxAttrs struct {
...
func (m *DeleteTableCtxAttrs) Reset()         { *m = DeleteTableCtxAttrs{} }
func (m *DeleteTableCtxAttrs) String() string { return proto.CompactTextString(m) }
func (*DeleteTableCtxAttrs) ProtoMessage()    {}
func (*DeleteTableCtxAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{46, 1}
}
func (m *DeleteTableCtxAttrs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeleteTableCtxAttrs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeleteTableCtxAttrs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DeleteTableCtxAttrs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteTableCtxAttrs.Merge(m, src)
}
func (m *DeleteTableCtxAttrs) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DeleteTableCtxAttrs) XXX_DiscardUnknown() {
	xxx_messageInfo_DeleteTableCtxAttrs.DiscardUnknown(m)
}

var xxx_messageInfo_DeleteTableCtxAttrs proto.InternalMessageInfo

func (m *DeleteTableCtxAttrs) GetList() []string {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DeleteTableCtxIdList)(nil), "plan.DeleteTableCtx.idList")
	proto.RegisterType((*DeleteTableCtxAttrs)(nil), "plan.DeleteTableCtx.attrs")
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
...
func (m *DeleteTableCtxIdList) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DeleteTableCtxIdList) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DeleteTableCtxIdList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DeleteTableCtxAttrs) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DeleteTableCtxAttrs) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DeleteTableCtxAttrs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DeleteTableCtxIdList) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeleteTableCtxAttrs) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeleteTableCtx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.OnSetAttrs = append(m.OnSetAttrs, &DeleteTableCtxAttrs{})
		...
		case 10:
			...
			m.OnSetIdx = append(m.OnSetIdx, &DeleteTableCtxIdList{})
		...
		case 12:
			...
			m.ParentIds = append(m.ParentIds, &DeleteTableCtxIdList{})
...
func (m *DeleteTableCtxIdList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *DeleteTableCtxAttrs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
