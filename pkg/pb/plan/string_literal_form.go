...
// MORPC v59. WidenedUnaryMinus requires MORPC v61. A struct makes compatibility
...
// with v61, TINYINT/SMALLINT/INT operands produce BIGINT so their minimum value
// can be negated exactly. A pre-v61 worker resolves the same overload ID to the
