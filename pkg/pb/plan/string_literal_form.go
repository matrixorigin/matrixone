...
const (
	...
	statementHashFunctionID          int32 = 581
...
// StatementHashFunction requires MORPC v86 for the remote function contract;
// v87 separately fences build identity and deferred resolver-error transport.
