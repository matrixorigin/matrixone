...
const (
	...
	// OpCommitMergeV2 requires the receiver to preserve row lineage.
	// A pre-V2 TN rejects this unknown opcode before applying the merge.
	OpCode_OpCommitMergeV2 OpCode = 2018
)
...
type MergeCommitEntry struct {
	...
	// Monotonic version of the producer's row-lineage contract. Version 0 is
	// emitted by legacy producers and carries no lineage guarantee. Version 1
	// guarantees that CN-origin rows retain both their object marker and row
	// commit timestamp across rewrites.
	LineageVersion       uint32   `protobuf:"varint,11,opt,name=lineage_version,json=lineageVersion,proto3" json:"lineage_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *MergeCommitEntry) GetLineageVersion() uint32 {
	if m != nil {
		return m.LineageVersion
	}
	return 0
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *MergeCommitEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LineageVersion != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.LineageVersion))
		i--
		dAtA[i] = 0x58
	}
	if m.Level != 0 {
...
func (m *MergeCommitEntry) ProtoSize() (n int) {
	...
	if m.LineageVersion != 0 {
		n += 1 + sovApi(uint64(m.LineageVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *MergeCommitEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LineageVersion", wireType)
			}
			m.LineageVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LineageVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
