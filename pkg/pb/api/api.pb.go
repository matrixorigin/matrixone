...
type Entry struct {
	...
	// table definition version used by the CN when planning this write.
	// Consult table_def_version_known because zero is a valid initial version.
	TableDefVersion uint32 `protobuf:"varint,9,opt,name=table_def_version,json=tableDefVersion,proto3" json:"table_def_version,omitempty"`
	// whether table_def_version was supplied by a version-aware CN.
	TableDefVersionKnown bool     `protobuf:"varint,10,opt,name=table_def_version_known,json=tableDefVersionKnown,proto3" json:"table_def_version_known,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Entry) GetTableDefVersion() uint32 {
	if m != nil {
		return m.TableDefVersion
	}
	return 0
}

func (m *Entry) GetTableDefVersionKnown() bool {
	if m != nil {
		return m.TableDefVersionKnown
	}
	return false
}
...
type SchemaExtra struct {
	...
	// Advances only when ALTER TABLE ... AUTO_INCREMENT resets allocation.
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TableDefVersion != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.TableDefVersion))
		i--
		dAtA[i] = 0x48
	}
	if m.PkCheckByTn != 0 {
...
func (m *Entry) ProtoSize() (n int) {
	...
	if m.TableDefVersion != 0 {
		n += 1 + sovApi(uint64(m.TableDefVersion))
	}
	if m.TableDefVersionKnown {
		n += 2
	}
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableDefVersion", wireType)
			}
			m.TableDefVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TableDefVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableDefVersionKnown", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TableDefVersionKnown = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
			if err != nil {
