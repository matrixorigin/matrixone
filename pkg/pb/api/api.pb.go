...
type SchemaExtra struct {
	...
	// Table-owned AUTO_INCREMENT reservation policy. Zero inherits the service default.
	AutoIdCache uint64 `protobuf:"varint,20,opt,name=auto_id_cache,json=autoIdCache,proto3" json:"auto_id_cache,omitempty"`
	// Physical tuple/key encoding used by this relation. Zero identifies
	// legacy catalog rows; native 0900 definitions use the registered format.
	KeyFormat uint32 `protobuf:"varint,21,opt,name=key_format,json=keyFormat,proto3" json:"key_format,omitempty"`
	// Semantic collation contract used by textual columns inherited from the
	// table default. Zero preserves the legacy interpretation; column-level
	// identities are carried by each plan column independently.
	CollationVersion     uint32   `protobuf:"varint,22,opt,name=collation_version,json=collationVersion,proto3" json:"collation_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SchemaExtra) GetAutoIdCache() uint64 {
	if m != nil {
...
func (m *SchemaExtra) GetKeyFormat() uint32 {
	if m != nil {
		return m.KeyFormat
	}
	return 0
...
func (m *SchemaExtra) GetCollationVersion() uint32 {
	if m != nil {
		return m.CollationVersion
	}
	return 0
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *SchemaExtra) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CollationVersion != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.CollationVersion))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	...
	if m.KeyFormat != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.KeyFormat))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	...
	if m.AutoIdCache != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.AutoIdCache))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if len(m.IndexTables) > 0 {
		dAtA29 := make([]byte, len(m.IndexTables)*10)
		var j28 int
	...
	if len(m.Hints) > 0 {
		dAtA31 := make([]byte, len(m.Hints)*10)
		var j30 int
		for _, num := range m.Hints {
			for num >= 1<<7 {
...
func (m *SchemaExtra) ProtoSize() (n int) {
	...
	if m.AutoIdCache != 0 {
		n += 2 + sovApi(uint64(m.AutoIdCache))
	}
	if m.KeyFormat != 0 {
		n += 2 + sovApi(uint64(m.KeyFormat))
	}
	if m.CollationVersion != 0 {
		n += 2 + sovApi(uint64(m.CollationVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 21:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KeyFormat |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CollationVersion", wireType)
			}
			m.CollationVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CollationVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
