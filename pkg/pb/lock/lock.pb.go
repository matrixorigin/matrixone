...
const (
	...
	// GetLockHolder get current holder on a special lock
	Method_GetLockHolder Method = 18
	// CheckActiveTxn checks whether a txn is still active on the lock service
	Method_CheckActiveTxn Method = 19
	// GetTxnWaitingListOnLockTable gets the wait-for snapshot from the service
	// that physically owns the transaction's locks. Unlike GetWaitingList, the
	// handler is owner-local and never recursively calls another lock service.
	Method_GetTxnWaitingListOnLockTable Method = 20
	// BatchUnlock releases several physical tables owned by the same lock
	// service in one transaction-closure admission.
	Method_BatchUnlock Method = 21
	// Instance-bound drain protocol. Legacy UUID restart methods keep their
	// wire semantics and cannot serve as a fallback for new controllers.
	Method_BeginDrain Method = 22
	Method_QueryDrain Method = 23
)
...
var Method_name = map[int32]string{
	...
	18: "GetLockHolder",
	19: "CheckActiveTxn",
	20: "GetTxnWaitingListOnLockTable",
	21: "BatchUnlock",
	22: "BeginDrain",
	23: "QueryDrain",
}
...
var Method_value = map[string]int32{
	...
	"GetLockHolder":                18,
	"CheckActiveTxn":               19,
	"GetTxnWaitingListOnLockTable": 20,
	"BatchUnlock":                  21,
	"BeginDrain":                   22,
	"QueryDrain":                   23,
}
...
type LockOptions struct {
	...
	LockWaitDeadline int64               `protobuf:"varint,11,opt,name=LockWaitDeadline,proto3" json:"LockWaitDeadline,omitempty"`
	// Snapshot against which the SQL execution plan was compiled. This is
	// separate from SnapShotTs, which is the transaction creation timestamp and
	// is also used by rolling-restart admission. It is sent only when the plan
	// predates transaction creation. Otherwise, and for older senders, the lock
	// service falls back to SnapShotTs.
	PlanSnapshotTs       *timestamp.Timestamp `protobuf:"bytes,12,opt,name=PlanSnapshotTs,proto3" json:"PlanSnapshotTs,omitempty"`
...
func (m *LockOptions) GetLockWaitDeadline() int64 {
	if m != nil {
		return m.LockWaitDeadline
	}
	return 0
}

func (m *LockOptions) GetPlanSnapshotTs() *timestamp.Timestamp {
	if m != nil {
...
type LockTable struct {
	...
	// AllocatorID identifies the allocator process that created this bind.
	AllocatorID          string   `protobuf:"bytes,8,opt,name=AllocatorID,proto3" json:"AllocatorID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LockTable) GetAllocatorID() string {
	if m != nil {
...
type Request struct {
	...
	GetLockHolder          GetLockHolderRequest          `protobuf:"bytes,19,opt,name=GetLockHolder,proto3" json:"GetLockHolder"`
	...
	CheckActiveTxn         CheckActiveTxnRequest         `protobuf:"bytes,21,opt,name=CheckActiveTxn,proto3" json:"CheckActiveTxn"`
	BatchUnlock            BatchUnlockRequest            `protobuf:"bytes,22,opt,name=BatchUnlock,proto3" json:"BatchUnlock"`
	BeginDrain             BeginDrainRequest             `protobuf:"bytes,23,opt,name=BeginDrain,proto3" json:"BeginDrain"`
	QueryDrain             QueryDrainRequest             `protobuf:"bytes,24,opt,name=QueryDrain,proto3" json:"QueryDrain"`
	XXX_NoUnkeyedLiteral   struct{}                      `json:"-"`
	XXX_unrecognized       []byte                        `json:"-"`
	XXX_sizecache          int32                         `json:"-"`
}
...
func (m *Request) GetGetLockHolder() GetLockHolderRequest {
	if m != nil {
		return m.GetLockHolder
	}
	return GetLockHolderRequest{}
}
...
func (m *Request) GetCheckActiveTxn() CheckActiveTxnRequest {
	if m != nil {
		return m.CheckActiveTxn
	}
	return CheckActiveTxnRequest{}
}

func (m *Request) GetBatchUnlock() BatchUnlockRequest {
	if m != nil {
		return m.BatchUnlock
	}
	return BatchUnlockRequest{}
}

func (m *Request) GetBeginDrain() BeginDrainRequest {
	if m != nil {
		return m.BeginDrain
	}
	return BeginDrainRequest{}
}

func (m *Request) GetQueryDrain() QueryDrainRequest {
	if m != nil {
		return m.QueryDrain
	}
	return QueryDrainRequest{}
}
...
type Response struct {
	...
	GetLockHolder          GetLockHolderResponse          `protobuf:"bytes,21,opt,name=GetLockHolder,proto3" json:"GetLockHolder"`
	CheckActiveTxn         CheckActiveTxnResponse         `protobuf:"bytes,22,opt,name=CheckActiveTxn,proto3" json:"CheckActiveTxn"`
	BatchUnlock            BatchUnlockResponse            `protobuf:"bytes,23,opt,name=BatchUnlock,proto3" json:"BatchUnlock"`
	BeginDrain             BeginDrainResponse             `protobuf:"bytes,24,opt,name=BeginDrain,proto3" json:"BeginDrain"`
	QueryDrain             QueryDrainResponse             `protobuf:"bytes,25,opt,name=QueryDrain,proto3" json:"QueryDrain"`
	XXX_NoUnkeyedLiteral   struct{}                       `json:"-"`
	XXX_unrecognized       []byte                         `json:"-"`
	XXX_sizecache          int32                          `json:"-"`
}
...
func (m *Response) GetGetLockHolder() GetLockHolderResponse {
	if m != nil {
		return m.GetLockHolder
	}
	return GetLockHolderResponse{}
}

func (m *Response) GetCheckActiveTxn() CheckActiveTxnResponse {
	if m != nil {
		return m.CheckActiveTxn
	}
	return CheckActiveTxnResponse{}
}

func (m *Response) GetBatchUnlock() BatchUnlockResponse {
	if m != nil {
		return m.BatchUnlock
	}
	return BatchUnlockResponse{}
}

func (m *Response) GetBeginDrain() BeginDrainResponse {
	if m != nil {
		return m.BeginDrain
	}
	return BeginDrainResponse{}
}

func (m *Response) GetQueryDrain() QueryDrainResponse {
	if m != nil {
		return m.QueryDrain
	}
	return QueryDrainResponse{}
}
...
type LockResponse struct {
	...
	// TxnWaitingListOnLockTableSupported is an explicit capability handshake.
	// An origin may compact its remote bookkeeping only after the physical owner
	// returned true for this successful Lock response.
	TxnWaitingListOnLockTableSupported bool `protobuf:"varint,2,opt,name=TxnWaitingListOnLockTableSupported,proto3" json:"TxnWaitingListOnLockTableSupported,omitempty"`
	// BatchUnlockSupported is an explicit capability handshake. The origin uses
	// BatchUnlock only for tables whose successful physical-owner Lock response
	// advertised this bit.
	BatchUnlockSupported bool     `protobuf:"varint,3,opt,name=BatchUnlockSupported,proto3" json:"BatchUnlockSupported,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LockResponse) GetTxnWaitingListOnLockTableSupported() bool {
	if m != nil {
		return m.TxnWaitingListOnLockTableSupported
	}
	return false
}

func (m *LockResponse) GetBatchUnlockSupported() bool {
	if m != nil {
		return m.BatchUnlockSupported
	}
	return false
}
...
// GetLockHolderRequest gets the current holder on a special row lock.
type GetLockHolderRequest struct {
	Row                  []byte   `protobuf:"bytes,1,opt,name=Row,proto3" json:"Row,omitempty"`
	Sharding             Sharding `protobuf:"varint,2,opt,name=Sharding,proto3,enum=lock.Sharding" json:"Sharding,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GetLockHolderRequest) Reset()         { *m = GetLockHolderRequest{} }
func (m *GetLockHolderRequest) String() string { return proto.CompactTextString(m) }
func (*GetLockHolderRequest) ProtoMessage()    {}
func (*GetLockHolderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{8}
}
func (m *GetLockHolderRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetLockHolderRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetLockHolderRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetLockHolderRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetLockHolderRequest.Merge(m, src)
}
func (m *GetLockHolderRequest) XXX_Size() int {
	return m.ProtoSize()
}
func (m *GetLockHolderRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetLockHolderRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetLockHolderRequest proto.InternalMessageInfo

func (m *GetLockHolderRequest) GetRow() []byte {
	if m != nil {
		return m.Row
	}
	return nil
...
func (m *GetLockHolderRequest) GetSharding() Sharding {
	if m != nil {
		return m.Sharding
	}
	return Sharding_None
...
// GetLockHolderResponse gets the current holder on a special row lock.
type GetLockHolderResponse struct {
	Holder               WaitTxn  `protobuf:"bytes,1,opt,name=Holder,proto3" json:"Holder"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GetLockHolderResponse) Reset()         { *m = GetLockHolderResponse{} }
func (m *GetLockHolderResponse) String() string { return proto.CompactTextString(m) }
func (*GetLockHolderResponse) ProtoMessage()    {}
func (*GetLockHolderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{9}
}
func (m *GetLockHolderResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetLockHolderResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetLockHolderResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetLockHolderResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetLockHolderResponse.Merge(m, src)
}
func (m *GetLockHolderResponse) XXX_Size() int {
	return m.ProtoSize()
}
func (m *GetLockHolderResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetLockHolderResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetLockHolderResponse proto.InternalMessageInfo

func (m *GetLockHolderResponse) GetHolder() WaitTxn {
	if m != nil {
		return m.Holder
	}
	return WaitTxn{}
...
// BatchUnlockRequest releases a bounded set of tables that belong to one
// physical owner. Mutating proxy handoffs continue to use table-scoped Unlock.
type BatchUnlockRequest struct {
	TxnID                []byte              `protobuf:"bytes,1,opt,name=TxnID,proto3" json:"TxnID,omitempty"`
	CommitTS             timestamp.Timestamp `protobuf:"bytes,2,opt,name=CommitTS,proto3" json:"CommitTS"`
	LockTables           []LockTable         `protobuf:"bytes,3,rep,name=LockTables,proto3" json:"LockTables"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}

func (m *BatchUnlockRequest) Reset()         { *m = BatchUnlockRequest{} }
func (m *BatchUnlockRequest) String() string { return proto.CompactTextString(m) }
func (*BatchUnlockRequest) ProtoMessage()    {}
func (*BatchUnlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{15}
}
func (m *BatchUnlockRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BatchUnlockRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BatchUnlockRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BatchUnlockRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchUnlockRequest.Merge(m, src)
}
func (m *BatchUnlockRequest) XXX_Size() int {
	return m.ProtoSize()
}
func (m *BatchUnlockRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchUnlockRequest.DiscardUnknown(m)
}

var xxx_messageInfo_BatchUnlockRequest proto.InternalMessageInfo

func (m *BatchUnlockRequest) GetTxnID() []byte {
	if m != nil {
		return m.TxnID
	}
	return nil
...
func (m *BatchUnlockRequest) GetCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.CommitTS
	}
	return timestamp.Timestamp{}
...
func (m *BatchUnlockRequest) GetLockTables() []LockTable {
	if m != nil {
		return m.LockTables
	}
	return nil
...
type BatchUnlockResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BatchUnlockResponse) Reset()         { *m = BatchUnlockResponse{} }
func (m *BatchUnlockResponse) String() string { return proto.CompactTextString(m) }
func (*BatchUnlockResponse) ProtoMessage()    {}
func (*BatchUnlockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{16}
}
func (m *BatchUnlockResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BatchUnlockResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BatchUnlockResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BatchUnlockResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchUnlockResponse.Merge(m, src)
}
func (m *BatchUnlockResponse) XXX_Size() int {
	return m.ProtoSize()
}
func (m *BatchUnlockResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchUnlockResponse.DiscardUnknown(m)
}

var xxx_messageInfo_BatchUnlockResponse proto.InternalMessageInfo
...
type GetBindResponse struct {
	LockTable            LockTable `protobuf:"bytes,2,opt,name=LockTable,proto3" json:"LockTable"`
	AllocatorVersion     uint64    `protobuf:"varint,3,opt,name=AllocatorVersion,proto3" json:"AllocatorVersion,omitempty"`
	AllocatorID          string    `protobuf:"bytes,4,opt,name=AllocatorID,proto3" json:"AllocatorID,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *GetBindResponse) GetAllocatorVersion() uint64 {
	if m != nil {
...
func (m *GetBindResponse) GetAllocatorID() string {
	if m != nil {
		return m.AllocatorID
	}
	return ""
...
func (m *KeepLockTableBindResponse) GetAllocatorVersion() uint64 {
	if m != nil {
		return m.AllocatorVersion
	}
	return 0
...
func (m *KeepLockTableBindResponse) GetAllocatorID() string {
	if m != nil {
		return m.AllocatorID
	}
	return ""
...
// BeginDrain is accepted only for an exact, live lock-service incarnation.
type BeginDrainRequest struct {
	ServiceID            string   `protobuf:"bytes,1,opt,name=ServiceID,proto3" json:"ServiceID,omitempty"`
	AttemptID            string   `protobuf:"bytes,2,opt,name=AttemptID,proto3" json:"AttemptID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BeginDrainRequest) Reset()         { *m = BeginDrainRequest{} }
func (m *BeginDrainRequest) String() string { return proto.CompactTextString(m) }
func (*BeginDrainRequest) ProtoMessage()    {}
func (*BeginDrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{25}
}
func (m *BeginDrainRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BeginDrainRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BeginDrainRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BeginDrainRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BeginDrainRequest.Merge(m, src)
}
func (m *BeginDrainRequest) XXX_Size() int {
	return m.ProtoSize()
}
func (m *BeginDrainRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_BeginDrainRequest.DiscardUnknown(m)
}

var xxx_messageInfo_BeginDrainRequest proto.InternalMessageInfo

func (m *BeginDrainRequest) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *BeginDrainRequest) GetAttemptID() string {
	if m != nil {
		return m.AttemptID
	}
	return ""
...
type BeginDrainResponse struct {
	OK                   bool     `protobuf:"varint,1,opt,name=OK,proto3" json:"OK,omitempty"`
	ServiceID            string   `protobuf:"bytes,2,opt,name=ServiceID,proto3" json:"ServiceID,omitempty"`
	AttemptID            string   `protobuf:"bytes,3,opt,name=AttemptID,proto3" json:"AttemptID,omitempty"`
	AllocatorID          string   `protobuf:"bytes,4,opt,name=AllocatorID,proto3" json:"AllocatorID,omitempty"`
	AllocatorVersion     uint64   `protobuf:"varint,5,opt,name=AllocatorVersion,proto3" json:"AllocatorVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BeginDrainResponse) Reset()         { *m = BeginDrainResponse{} }
func (m *BeginDrainResponse) String() string { return proto.CompactTextString(m) }
func (*BeginDrainResponse) ProtoMessage()    {}
func (*BeginDrainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{26}
}
func (m *BeginDrainResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BeginDrainResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BeginDrainResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BeginDrainResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BeginDrainResponse.Merge(m, src)
}
func (m *BeginDrainResponse) XXX_Size() int {
	return m.ProtoSize()
}
func (m *BeginDrainResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_BeginDrainResponse.DiscardUnknown(m)
}

var xxx_messageInfo_BeginDrainResponse proto.InternalMessageInfo

func (m *BeginDrainResponse) GetOK() bool {
	if m != nil {
		return m.OK
	}
	return false
...
func (m *BeginDrainResponse) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *BeginDrainResponse) GetAttemptID() string {
	if m != nil {
		return m.AttemptID
	}
	return ""
...
func (m *BeginDrainResponse) GetAllocatorID() string {
	if m != nil {
		return m.AllocatorID
	}
	return ""
...
func (m *BeginDrainResponse) GetAllocatorVersion() uint64 {
	if m != nil {
		return m.AllocatorVersion
	}
	return 0
...
// QueryDrain never treats allocator replacement or missing state as success.
type QueryDrainRequest struct {
	ServiceID            string   `protobuf:"bytes,1,opt,name=ServiceID,proto3" json:"ServiceID,omitempty"`
	AttemptID            string   `protobuf:"bytes,2,opt,name=AttemptID,proto3" json:"AttemptID,omitempty"`
	AllocatorID          string   `protobuf:"bytes,3,opt,name=AllocatorID,proto3" json:"AllocatorID,omitempty"`
	AllocatorVersion     uint64   `protobuf:"varint,4,opt,name=AllocatorVersion,proto3" json:"AllocatorVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *QueryDrainRequest) Reset()         { *m = QueryDrainRequest{} }
func (m *QueryDrainRequest) String() string { return proto.CompactTextString(m) }
func (*QueryDrainRequest) ProtoMessage()    {}
func (*QueryDrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{27}
}
func (m *QueryDrainRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDrainRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDrainRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDrainRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDrainRequest.Merge(m, src)
}
func (m *QueryDrainRequest) XXX_Size() int {
	return m.ProtoSize()
}
func (m *QueryDrainRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDrainRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDrainRequest proto.InternalMessageInfo

func (m *QueryDrainRequest) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *QueryDrainRequest) GetAttemptID() string {
	if m != nil {
		return m.AttemptID
	}
	return ""
...
func (m *QueryDrainRequest) GetAllocatorID() string {
	if m != nil {
		return m.AllocatorID
	}
	return ""
...
func (m *QueryDrainRequest) GetAllocatorVersion() uint64 {
	if m != nil {
		return m.AllocatorVersion
	}
	return 0
...
type QueryDrainResponse struct {
...
func (m *QueryDrainResponse) Reset()         { *m = QueryDrainResponse{} }
func (m *QueryDrainResponse) String() string { return proto.CompactTextString(m) }
func (*QueryDrainResponse) ProtoMessage()    {}
func (*QueryDrainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{28}
}
func (m *QueryDrainResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDrainResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDrainResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDrainResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDrainResponse.Merge(m, src)
}
func (m *QueryDrainResponse) XXX_Size() int {
	return m.ProtoSize()
}
func (m *QueryDrainResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDrainResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDrainResponse proto.InternalMessageInfo

func (m *QueryDrainResponse) GetSafe() bool {
	if m != nil {
		return m.Safe
	}
	return false
...
func (m *QueryDrainResponse) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *QueryDrainResponse) GetAttemptID() string {
	if m != nil {
		return m.AttemptID
	}
	return ""
...
func (m *QueryDrainResponse) GetAllocatorID() string {
	if m != nil {
		return m.AllocatorID
	}
	return ""
...
func (m *QueryDrainResponse) GetAllocatorVersion() uint64 {
	if m != nil {
		return m.AllocatorVersion
	}
	return 0
...
func (*AbortRemoteDeadlockTxnResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{36}
}
...
func (*CannotCommitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{37}
}
...
type CannotCommitResponse struct {
	...
	FenceTS              timestamp.Timestamp `protobuf:"bytes,2,opt,name=FenceTS,proto3" json:"FenceTS"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*CannotCommitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{38}
}
...
func (m *CannotCommitResponse) GetFenceTS() timestamp.Timestamp {
	if m != nil {
		return m.FenceTS
	}
	return timestamp.Timestamp{}
...
func (*GetActiveTxnRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{39}
}
...
func (*GetActiveTxnResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{40}
}
...
func (*CheckOrphanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{41}
}
...
func (*CheckOrphanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{42}
}
...
type OrphanTxn struct {
	...
	Txn     [][]byte `protobuf:"bytes,2,rep,name=Txn,proto3" json:"Txn,omitempty"`
	// Persist installs a source-service Commit fence until ExpireAtUnixNano.
	// It is used only when a Commit request may already be buffered in the
	// source CN transport. TN rejects that Commit after its absolute deadline,
	// so one fence can safely cover many unknown outcomes without retaining one
	// tombstone per transaction.
	Persist              bool     `protobuf:"varint,3,opt,name=Persist,proto3" json:"Persist,omitempty"`
	ExpireAtUnixNano     int64    `protobuf:"varint,4,opt,name=ExpireAtUnixNano,proto3" json:"ExpireAtUnixNano,omitempty"`
	CommitSequence       uint64   `protobuf:"varint,5,opt,name=CommitSequence,proto3" json:"CommitSequence,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*OrphanTxn) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{43}
}
...
func (m *OrphanTxn) GetPersist() bool {
	if m != nil {
		return m.Persist
	}
	return false
...
func (m *OrphanTxn) GetExpireAtUnixNano() int64 {
	if m != nil {
		return m.ExpireAtUnixNano
	}
	return 0
}

func (m *OrphanTxn) GetCommitSequence() uint64 {
	if m != nil {
...
type Result struct {
	...
	// TableDefChangedAt is the latest committed table-definition change retained
	// by this lock table. A CN whose statement snapshot is older must rebuild its
	// plan before writing with the physical table generation it resolved.
	TableDefChangedAt    *timestamp.Timestamp `protobuf:"bytes,11,opt,name=TableDefChangedAt,proto3" json:"TableDefChangedAt,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{44}
}
...
func (m *Result) GetTableDefChangedAt() *timestamp.Timestamp {
	if m != nil {
		return m.TableDefChangedAt
	}
	return nil
}
...
func (*ExtraMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{45}
}
...
func (*ResumeInvalidCNRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{46}
}
...
func (*ResumeInvalidCNResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{47}
}
...
type CheckActiveTxnRequest struct {
	ServiceID            string   `protobuf:"bytes,1,opt,name=ServiceID,proto3" json:"ServiceID,omitempty"`
	Txn                  []byte   `protobuf:"bytes,2,opt,name=Txn,proto3" json:"Txn,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *CheckActiveTxnRequest) Reset()         { *m = CheckActiveTxnRequest{} }
func (m *CheckActiveTxnRequest) String() string { return proto.CompactTextString(m) }
func (*CheckActiveTxnRequest) ProtoMessage()    {}
func (*CheckActiveTxnRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{48}
}
func (m *CheckActiveTxnRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckActiveTxnRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckActiveTxnRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckActiveTxnRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckActiveTxnRequest.Merge(m, src)
}
func (m *CheckActiveTxnRequest) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CheckActiveTxnRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckActiveTxnRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CheckActiveTxnRequest proto.InternalMessageInfo

func (m *CheckActiveTxnRequest) GetServiceID() string {
	if m != nil {
		return m.ServiceID
	}
	return ""
...
func (m *CheckActiveTxnRequest) GetTxn() []byte {
	if m != nil {
		return m.Txn
	}
	return nil
...
type CheckActiveTxnResponse struct {
	Valid                bool     `protobuf:"varint,1,opt,name=Valid,proto3" json:"Valid,omitempty"`
...
func (m *CheckActiveTxnResponse) Reset()         { *m = CheckActiveTxnResponse{} }
func (m *CheckActiveTxnResponse) String() string { return proto.CompactTextString(m) }
func (*CheckActiveTxnResponse) ProtoMessage()    {}
func (*CheckActiveTxnResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{49}
}
func (m *CheckActiveTxnResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckActiveTxnResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckActiveTxnResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckActiveTxnResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckActiveTxnResponse.Merge(m, src)
}
func (m *CheckActiveTxnResponse) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CheckActiveTxnResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckActiveTxnResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CheckActiveTxnResponse proto.InternalMessageInfo

func (m *CheckActiveTxnResponse) GetValid() bool {
	if m != nil {
		return m.Valid
	}
	return false
...
func (m *CheckActiveTxnResponse) GetActive() bool {
	if m != nil {
		return m.Active
	}
	return false
...
func init() {
	...
	proto.RegisterType((*GetLockHolderRequest)(nil), "lock.GetLockHolderRequest")
	proto.RegisterType((*GetLockHolderResponse)(nil), "lock.GetLockHolderResponse")
	...
	proto.RegisterType((*BatchUnlockRequest)(nil), "lock.BatchUnlockRequest")
	proto.RegisterType((*BatchUnlockResponse)(nil), "lock.BatchUnlockResponse")
	...
	proto.RegisterType((*BeginDrainRequest)(nil), "lock.BeginDrainRequest")
	proto.RegisterType((*BeginDrainResponse)(nil), "lock.BeginDrainResponse")
	proto.RegisterType((*QueryDrainRequest)(nil), "lock.QueryDrainRequest")
	proto.RegisterType((*QueryDrainResponse)(nil), "lock.QueryDrainResponse")
	...
	proto.RegisterType((*CheckActiveTxnRequest)(nil), "lock.CheckActiveTxnRequest")
	proto.RegisterType((*CheckActiveTxnResponse)(nil), "lock.CheckActiveTxnResponse")
}
...
var fileDescriptor_164ad2988c7acaf1 = []byte{
	...
	,
}
...
func (m *LockOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LockWaitDeadline != 0 {
		i = encodeVarintLock(dAtA, i, uint64(m.LockWaitDeadline))
		i--
		dAtA[i] = 0x58
	}
...
func (m *LockTable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AllocatorID) > 0 {
		i -= len(m.AllocatorID)
		copy(dAtA[i:], m.AllocatorID)
		i = encodeVarintLock(dAtA, i, uint64(len(m.AllocatorID)))
		i--
		dAtA[i] = 0x42
	}
	if m.OriginTable != 0 {
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.QueryDrain.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0xc2
	{
		size, err := m.BeginDrain.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0xba
	{
		size, err := m.BatchUnlock.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0xb2
	{
		size, err := m.CheckActiveTxn.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0xa2
	{
		size, err := m.GetLockHolder.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *LockResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TxnWaitingListOnLockTableSupported {
		i--
		if m.TxnWaitingListOnLockTableSupported {
			dAtA[i] = 1
		} else {
...
func (m *GetLockHolderRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetLockHolderRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetLockHolderRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetLockHolderResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetLockHolderResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetLockHolderResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BatchUnlockRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BatchUnlockRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BatchUnlockRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BatchUnlockResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BatchUnlockResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BatchUnlockResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetBindResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AllocatorVersion != 0 {
		i = encodeVarintLock(dAtA, i, uint64(m.AllocatorVersion))
		i--
		dAtA[i] = 0x18
	}
	{
...
func (m *BeginDrainRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BeginDrainRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BeginDrainRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AttemptID) > 0 {
		...
		i = encodeVarintLock(dAtA, i, uint64(len(m.AttemptID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ServiceID) > 0 {
...
func (m *BeginDrainResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BeginDrainResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BeginDrainResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDrainRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDrainRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDrainRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDrainResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDrainResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDrainResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CannotCommitResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.FenceTS.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *OrphanTxn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CommitSequence != 0 {
		i = encodeVarintLock(dAtA, i, uint64(m.CommitSequence))
		i--
		dAtA[i] = 0x28
	}
	if m.ExpireAtUnixNano != 0 {
		i = encodeVarintLock(dAtA, i, uint64(m.ExpireAtUnixNano))
		i--
		dAtA[i] = 0x20
	}
	if m.Persist {
...
func (m *Result) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TableDefChangedAt != nil {
		{
			size, err := m.TableDefChangedAt.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CheckActiveTxnRequest) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckActiveTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckActiveTxnRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CheckActiveTxnResponse) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckActiveTxnResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckActiveTxnResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LockOptions) ProtoSize() (n int) {
	...
	if m.LockWaitDeadline != 0 {
		n += 1 + sovLock(uint64(m.LockWaitDeadline))
	}
	if m.PlanSnapshotTs != nil {
...
func (m *Request) ProtoSize() (n int) {
	...
	n += 2 + l + sovLock(uint64(l))
	l = m.GetLockHolder.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	l = m.AbortRemoteDeadlockTxn.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	l = m.CheckActiveTxn.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	l = m.BatchUnlock.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	l = m.BeginDrain.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	l = m.QueryDrain.ProtoSize()
	n += 2 + l + sovLock(uint64(l))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *GetLockHolderRequest) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetLockHolderResponse) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.Holder.ProtoSize()
	n += 1 + l + sovLock(uint64(l))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *BatchUnlockRequest) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BatchUnlockResponse) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetBindResponse) ProtoSize() (n int) {
	...
	n += 1 + l + sovLock(uint64(l))
	if m.AllocatorVersion != 0 {
		n += 1 + sovLock(uint64(m.AllocatorVersion))
	}
	l = len(m.AllocatorID)
	if l > 0 {
		n += 1 + l + sovLock(uint64(l))
...
func (m *BeginDrainRequest) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BeginDrainResponse) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDrainRequest) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDrainResponse) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OrphanTxn) ProtoSize() (n int) {
	...
	if m.ExpireAtUnixNano != 0 {
		n += 1 + sovLock(uint64(m.ExpireAtUnixNano))
	}
	if m.CommitSequence != 0 {
		n += 1 + sovLock(uint64(m.CommitSequence))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Result) ProtoSize() (n int) {
	...
	if m.TableDefChangedAt != nil {
		l = m.TableDefChangedAt.ProtoSize()
		n += 1 + l + sovLock(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *CheckActiveTxnRequest) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CheckActiveTxnResponse) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LockOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockWaitDeadline", wireType)
			}
			m.LockWaitDeadline = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLock
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LockWaitDeadline |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *LockTable) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.AllocatorID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLock(dAtA[iNdEx:])
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GetLockHolder", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GetLockHolder.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 20:
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckActiveTxn", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CheckActiveTxn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchUnlock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BatchUnlock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BeginDrain", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BeginDrain.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryDrain", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.QueryDrain.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LockResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxnWaitingListOnLockTableSupported", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxnWaitingListOnLockTableSupported = bool(v != 0)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchUnlockSupported", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BatchUnlockSupported = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipLock(dAtA[iNdEx:])
			if err != nil {
...
func (m *GetLockHolderRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetLockHolderRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetLockHolderRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetLockHolderResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetLockHolderResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetLockHolderResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BatchUnlockRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BatchUnlockRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BatchUnlockRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BatchUnlockResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BatchUnlockResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BatchUnlockResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetBindResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllocatorVersion", wireType)
			}
			m.AllocatorVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLock
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AllocatorVersion |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BeginDrainRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BeginDrainRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BeginDrainRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BeginDrainResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BeginDrainResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BeginDrainResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryDrainRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDrainRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDrainRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryDrainResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDrainResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDrainResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *CannotCommitResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FenceTS", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FenceTS.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *OrphanTxn) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitSequence", wireType)
			}
			m.CommitSequence = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CommitSequence |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Result) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableDefChangedAt", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TableDefChangedAt == nil {
				m.TableDefChangedAt = &timestamp.Timestamp{}
			}
			if err := m.TableDefChangedAt.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CheckActiveTxnRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckActiveTxnRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckActiveTxnRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CheckActiveTxnResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckActiveTxnResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckActiveTxnResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
