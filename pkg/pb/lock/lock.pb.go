...
type Result struct {
	...
	LockedOn *LockTable `protobuf:"bytes,1,opt,name=LockedOn,proto3" json:"LockedOn,omitempty"`
	// AfterWait if true means current operation is blocked by a active txn.
	AfterWait bool `protobuf:"varint,2,opt,name=AfterWait,proto3" json:"AfterWait,omitempty"`
	// CommitTS if current txn is blocked by a committed txn, the value is the
	// committed txn's commit timestamp in dn
...
func (m *Result) GetAfterWait() bool {
	if m != nil {
		return m.AfterWait
	}
	return false
...
func (m *Result) GetCommitTS() timestamp.Timestamp {
	if m != nil {
		return m.CommitTS
	}
...
var fileDescriptor_164ad2988c7acaf1 = []byte{
	...
	,
}
...
func (m *Result) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AfterWait", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
