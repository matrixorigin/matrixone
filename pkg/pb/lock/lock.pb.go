...
const (
	...
	// AppendSharedLocks append shared locks with a hold txn
	Method_AppendSharedLocks Method = 9
)
...
type LockOptions struct {
	...
	AggregationShared    bool        `protobuf:"varint,8,opt,name=AggregationShared,proto3" json:"AggregationShared,omitempty"`
...
func (m *LockOptions) GetGroup() string {
	if m != nil {
		return m.Group
	}
	return ""
...
func (m *LockOptions) GetAggregationShared() bool {
	if m != nil {
		return m.AggregationShared
	}
	return false
}
...
func (m *LockTable) GetGroup() string {
	if m != nil {
		return m.Group
	}
	return ""
...
type Request struct {
	...
	AppendSharedLocks    AppendSharedLocksRequest `protobuf:"bytes,11,opt,name=AppendSharedLocks,proto3" json:"AppendSharedLocks"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *Request) GetAppendSharedLocks() AppendSharedLocksRequest {
	if m != nil {
		return m.AppendSharedLocks
	}
	return AppendSharedLocksRequest{}
}
...
type Response struct {
	...
	AppendSharedLocks    AppendSharedLocksResponse `protobuf:"bytes,12,opt,name=AppendSharedLocks,proto3" json:"AppendSharedLocks"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Response) GetAppendSharedLocks() AppendSharedLocksResponse {
	if m != nil {
		return m.AppendSharedLocks
	}
	return AppendSharedLocksResponse{}
}
...
func (m *GetBindRequest) GetGroup() string {
	if m != nil {
		return m.Group
	}
	return ""
...
// AppendSharedLocksRequest append shared locks request
type AppendSharedLocksRequest struct {
	HoldTxnID            []byte    `protobuf:"bytes,1,opt,name=HoldTxnID,proto3" json:"HoldTxnID,omitempty"`
	Row                  []byte    `protobuf:"bytes,2,opt,name=Row,proto3" json:"Row,omitempty"`
	SharedTxnIDs         []WaitTxn `protobuf:"bytes,3,rep,name=SharedTxnIDs,proto3" json:"SharedTxnIDs"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *AppendSharedLocksRequest) Reset()         { *m = AppendSharedLocksRequest{} }
func (m *AppendSharedLocksRequest) String() string { return proto.CompactTextString(m) }
func (*AppendSharedLocksRequest) ProtoMessage()    {}
func (*AppendSharedLocksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{20}
}
func (m *AppendSharedLocksRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AppendSharedLocksRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AppendSharedLocksRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AppendSharedLocksRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AppendSharedLocksRequest.Merge(m, src)
}
func (m *AppendSharedLocksRequest) XXX_Size() int {
	return m.Size()
}
func (m *AppendSharedLocksRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AppendSharedLocksRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AppendSharedLocksRequest proto.InternalMessageInfo

func (m *AppendSharedLocksRequest) GetHoldTxnID() []byte {
	if m != nil {
		return m.HoldTxnID
	}
	return nil
...
func (m *AppendSharedLocksRequest) GetRow() []byte {
	if m != nil {
		return m.Row
	}
	return nil
...
func (m *AppendSharedLocksRequest) GetSharedTxnIDs() []WaitTxn {
	if m != nil {
		return m.SharedTxnIDs
	}
	return nil
}

// AppendSharedLocksResponse append shared locks response
type AppendSharedLocksResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AppendSharedLocksResponse) Reset()         { *m = AppendSharedLocksResponse{} }
func (m *AppendSharedLocksResponse) String() string { return proto.CompactTextString(m) }
func (*AppendSharedLocksResponse) ProtoMessage()    {}
func (*AppendSharedLocksResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_164ad2988c7acaf1, []int{21}
}
func (m *AppendSharedLocksResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AppendSharedLocksResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AppendSharedLocksResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AppendSharedLocksResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AppendSharedLocksResponse.Merge(m, src)
}
func (m *AppendSharedLocksResponse) XXX_Size() int {
	return m.Size()
}
func (m *AppendSharedLocksResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AppendSharedLocksResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AppendSharedLocksResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AppendSharedLocksRequest)(nil), "lock.AppendSharedLocksRequest")
	proto.RegisterType((*AppendSharedLocksResponse)(nil), "lock.AppendSharedLocksResponse")
}
...
var fileDescriptor_164ad2988c7acaf1 = []byte{
	...
	,
}
...
func (m *LockOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Group) > 0 {
		i -= len(m.Group)
		copy(dAtA[i:], m.Group)
		i = encodeVarintLock(dAtA, i, uint64(len(m.Group)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.AppendSharedLocks.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *AppendSharedLocksRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AppendSharedLocksRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AppendSharedLocksRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SharedTxnIDs) > 0 {
		for iNdEx := len(m.SharedTxnIDs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SharedTxnIDs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.HoldTxnID) > 0 {
		i -= len(m.HoldTxnID)
		copy(dAtA[i:], m.HoldTxnID)
		i = encodeVarintLock(dAtA, i, uint64(len(m.HoldTxnID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AppendSharedLocksResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AppendSharedLocksResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AppendSharedLocksResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AppendSharedLocksRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AppendSharedLocksResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LockOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AggregationShared", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppendSharedLocks", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AppendSharedLocks.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AppendSharedLocksRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppendSharedLocksRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppendSharedLocksRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HoldTxnID", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HoldTxnID = append(m.HoldTxnID[:0], dAtA[iNdEx:postIndex]...)
			if m.HoldTxnID == nil {
				m.HoldTxnID = []byte{}
			}
			iNdEx = postIndex
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SharedTxnIDs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SharedTxnIDs = append(m.SharedTxnIDs, WaitTxn{})
			if err := m.SharedTxnIDs[len(m.SharedTxnIDs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AppendSharedLocksResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppendSharedLocksResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppendSharedLocksResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
