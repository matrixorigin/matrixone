module github.com/matrixorigin/matrixone/pkg/iceberg/adapter/iceberggo

go 1.26.4

require (
	github.com/apache/iceberg-go v0.5.0
	github.com/matrixorigin/matrixone v0.0.0
)
...
require (
	...
	github.com/unum-cloud/usearch/golang v0.0.0-20260524141737-9fd6b0115dcd // indirect
...
// Keep the adapter spike's local MatrixOne dependency on the same forks as the
// root module. The iceberg-go module can otherwise win MVS for shared runtime
// packages and break MatrixOne-only ABI assumptions.
replace github.com/hashicorp/memberlist => github.com/matrixorigin/memberlist v0.5.1-0.20230322082342-95015c95ee76

replace github.com/matrixorigin/matrixone => ../../../..
...
replace (
	...
	github.com/lni/dragonboat/v4 v4.0.0-20220815145555-6f622e8bcbef => github.com/matrixorigin/dragonboat/v4 v4.0.0-20260706084232-ea0aa61b062b
