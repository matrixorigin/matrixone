...
//
//	mockgen -source pkg/util/export/table/aggr.go --destination pkg/util/export/mock_aggr_test.go -package=export
//
...
func (mr *MockWindowKeyMockRecorder) Before(end any) *gomock.Call {
...
// Aggred mocks base method.
func (m *MockItem) Aggred() int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Aggred")
	ret0, _ := ret[0].(int64)
	return ret0
}

// Aggred indicates an expected call of Aggred.
func (mr *MockItemMockRecorder) Aggred() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Aggred", reflect.TypeOf((*MockItem)(nil).Aggred))
}
...
func (mr *MockItemMockRecorder) Key(duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAggregatorMockRecorder) AddItem(i any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAggregatorMockRecorder) PopResultsBeforeWindow(end any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
