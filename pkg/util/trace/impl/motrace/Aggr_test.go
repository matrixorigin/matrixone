...
func TestAggregator(t *testing.T) {
	...
	targetBytes := []byte(`[6,5,2.000,15,20,25,2,0,220.0803,0,0,128,0,0,0,0,0]`)
	for idx := 0; idx < 4; idx++ {
	...
	require.Equal(t, []byte(`[6,5,2.000,15,20,25,0,0,220.0803,0,0,128,0,0,0,0,0]`), results[0].(*StatementInfo).GetStatsArrayBytes())
