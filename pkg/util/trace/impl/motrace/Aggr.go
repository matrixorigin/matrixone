...
type Aggregator struct {
	...
	UpdateFunc  func(existing, new Item, ctx context.Context)
...
func NewAggregator(ctx context.Context, windowSize time.Duration, newItemFunc func(i Item, ctx context.Context) Item, updateFunc func(existing, new Item, ctx context.Context), filterFunc func(i Item) bool) *Aggregator {
