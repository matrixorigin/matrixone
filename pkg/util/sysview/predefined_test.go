...
func TestInformationSchemaColumnsDDLRequiresCurrentViewMetadata(t *testing.T) {
	...
	assert.Equal(t, 4, strings.Count(InformationSchemaColumnsDDL,
	...
	assert.Contains(t, InformationSchemaColumnsDDL,
		"mc.att_database in ('information_schema','mo_catalog','mo_debug','mo_task','mysql','system','system_metrics')")
}
