...
func TestInitInformationSchemaSysTablesForProtocol(t *testing.T) {
	...
	predecessor := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion87)
	...
	for _, protocol := range []int64{defines.MORPCVersion58, defines.MORPCVersion87} {
	...
	latest := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion88)
