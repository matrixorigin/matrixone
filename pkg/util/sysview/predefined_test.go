...
func TestInitInformationSchemaSysTablesForProtocol(t *testing.T) {
	...
	predecessor := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion81)
	...
	for _, protocol := range []int64{defines.MORPCVersion58, defines.MORPCVersion81} {
	...
	latest := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion82)
