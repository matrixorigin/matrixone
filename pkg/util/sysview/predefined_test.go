...
func TestInitInformationSchemaSysTablesForProtocol(t *testing.T) {
	...
	predecessor := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion74)
	...
	for _, protocol := range []int64{defines.MORPCVersion58, defines.MORPCVersion74} {
	...
	latest := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion75)
