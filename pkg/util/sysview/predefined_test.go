...
func TestInitInformationSchemaSysTablesForProtocol(t *testing.T) {
	...
	predecessor := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion88)
	...
	for _, protocol := range []int64{defines.MORPCVersion58, defines.MORPCVersion88} {
	...
	latest := InitInformationSchemaSysTablesForProtocol(defines.MORPCVersion89)
