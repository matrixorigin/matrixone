...
func TestPartition(t *testing.T) {
	...
	vector.Append(v0, []int8{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []int16{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []int32{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []int64{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []uint8{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []uint16{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []uint32{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []uint64{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []types.Date{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []float32{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []float64{3, 4, 5, 6, 7, 8}, true, mp)
	...
	vector.Append(v0, []string{"hello", "Gut", "konichiwa", "nihao", "nihao", "nihao", "nihao"}, true, mp)
	Partition([]int64{1, 3, 5}, []bool{false, false, false}, partitions, v10)
	require.Equal(t, []int64{0, 1}, partitions)
