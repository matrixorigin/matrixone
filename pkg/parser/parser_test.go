...
func (s *testParserSuite) TestDMLStmt(c *C) {
	table := []testCase{
		...
		// for https://matrixbase/pkg/parser/issues/963
...
// For issue #51
// See https://matrixbase/pkg/parser/pull/51 for details
...
// See https://matrixbase/pkg/parser/issue/94
...
// See https://matrixbase/pkg/parser/issue/95
