...
// DiscardOffsetReset mocks base method.
func (m *MockAutoIncrementService) DiscardOffsetReset(ctx context.Context, tableID uint64, txn client.TxnOperator) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DiscardOffsetReset", ctx, tableID, txn)
	ret0, _ := ret[0].(error)
	return ret0
}

// DiscardOffsetReset indicates an expected call of DiscardOffsetReset.
func (mr *MockAutoIncrementServiceMockRecorder) DiscardOffsetReset(ctx, tableID, txn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiscardOffsetReset", reflect.TypeOf((*MockAutoIncrementService)(nil).DiscardOffsetReset), ctx, tableID, txn)
}
...
func (m *MockAutoIncrementService) SetOffset(ctx context.Context, tableID uint64, colIndex int, offset uint64, txn client.TxnOperator) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetOffset", ctx, tableID, colIndex, offset, txn)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetOffset indicates an expected call of SetOffset.
func (mr *MockAutoIncrementServiceMockRecorder) SetOffset(ctx, tableID, colIndex, offset, txn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetOffset", reflect.TypeOf((*MockAutoIncrementService)(nil).SetOffset), ctx, tableID, colIndex, offset, txn)
}
...
func (m *MockincrTableCache) acquire() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "acquire")
}

// acquire indicates an expected call of acquire.
func (mr *MockincrTableCacheMockRecorder) acquire() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "acquire", reflect.TypeOf((*MockincrTableCache)(nil).acquire))
}
...
func (m *MockincrTableCache) insertAutoValues(ctx context.Context, tableID uint64, vecs []*vector.Vector, rows int, estimate int64) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "insertAutoValues", ctx, tableID, vecs, rows, estimate)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockincrTableCacheMockRecorder) insertAutoValues(ctx, tableID, vecs, rows, estimate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "insertAutoValues", reflect.TypeOf((*MockincrTableCache)(nil).insertAutoValues), ctx, tableID, vecs, rows, estimate)
}

// release mocks base method.
func (m *MockincrTableCache) release() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "release")
}

// release indicates an expected call of release.
func (mr *MockincrTableCacheMockRecorder) release() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "release", reflect.TypeOf((*MockincrTableCache)(nil).release))
}

// retire mocks base method.
func (m *MockincrTableCache) retire() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "retire")
}

// retire indicates an expected call of retire.
func (mr *MockincrTableCacheMockRecorder) retire() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "retire", reflect.TypeOf((*MockincrTableCache)(nil).retire))
}
...
func (m *MockvalueAllocator) forceSetOffset(ctx context.Context, tableID uint64, colIndex int, offset uint64, txnOp client.TxnOperator) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "forceSetOffset", ctx, tableID, colIndex, offset, txnOp)
	ret0, _ := ret[0].(error)
	return ret0
}

// forceSetOffset indicates an expected call of forceSetOffset.
func (mr *MockvalueAllocatorMockRecorder) forceSetOffset(ctx, tableID, colIndex, offset, txnOp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "forceSetOffset", reflect.TypeOf((*MockvalueAllocator)(nil).forceSetOffset), ctx, tableID, colIndex, offset, txnOp)
}
...
// ForceSetOffset mocks base method.
func (m *MockIncrValueStore) ForceSetOffset(ctx context.Context, tableID uint64, colIndex int, offset uint64, txnOp client.TxnOperator) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForceSetOffset", ctx, tableID, colIndex, offset, txnOp)
	ret0, _ := ret[0].(error)
	return ret0
...
// ForceSetOffset indicates an expected call of ForceSetOffset.
func (mr *MockIncrValueStoreMockRecorder) ForceSetOffset(ctx, tableID, colIndex, offset, txnOp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForceSetOffset", reflect.TypeOf((*MockIncrValueStore)(nil).ForceSetOffset), ctx, tableID, colIndex, offset, txnOp)
}
