...
func (m *MockWorkspace) SetHaveDDL(haveDDL bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetHaveDDL", haveDDL)
}

// SetHaveDDL indicates an expected call of SetHaveDDL.
func (mr *MockWorkspaceMockRecorder) SetHaveDDL(haveDDL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetHaveDDL", reflect.TypeOf((*MockWorkspace)(nil).SetHaveDDL), haveDDL)
}
