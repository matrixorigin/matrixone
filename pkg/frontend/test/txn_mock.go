...
func (m *MockWorkspace) Adjust(ctx context.Context, writeOffset uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Adjust", ctx, writeOffset)
	ret0, _ := ret[0].(error)
	return ret0
}

// Adjust indicates an expected call of Adjust.
func (mr *MockWorkspaceMockRecorder) Adjust(ctx, writeOffset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Adjust", reflect.TypeOf((*MockWorkspace)(nil).Adjust), ctx, writeOffset)
}
