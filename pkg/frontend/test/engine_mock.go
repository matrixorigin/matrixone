...
func (mr *MockReaderMockRecorder) BlkCnt() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlkCnt", reflect.TypeOf((*MockReader)(nil).BlkCnt))
}
