...
//
//	mockgen -source pkg/lockservice/types.go --destination pkg/frontend/test/lock_mock/types.go -package=lock_mock
//

// Package lock_mock is a generated GoMock package.
package lock_mock
