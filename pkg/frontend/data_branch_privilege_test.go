...
func TestValidateDataBranchDeleteDatabaseTargetUsesDatabaseIdentity(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:         "v75 marked empty database",
		...
		{
			name:         "v73 marked empty database fails closed",
		...
		{
			name:         "v75 unmarked empty database",
			protocol:     defines.MORPCVersion75,
			wantErr:      "not an active branch database",
			wantSQLCount: 2,
		},
		{
			name:         "v73 unmarked empty database",
			protocol:     defines.MORPCVersion73,
			wantErr:      "not an active branch database",
			wantSQLCount: 2,
		},
		...
		{
			name:         "v75 marked database with ordinary table",
			protocol:     defines.MORPCVersion75,
			databaseType: catalog.SystemDBTypeDataBranch,
		...
		{
			name:         "v73 marked database with ordinary table",
			protocol:     defines.MORPCVersion73,
			databaseType: catalog.SystemDBTypeDataBranch,
			tables:       [][]interface{}{{int64(tableID), "local_t"}},
			wantErr:      "not an active branch table",
		...
		{
			name:         "v75 marked database with branch table",
			protocol:     defines.MORPCVersion75,
			databaseType: catalog.SystemDBTypeDataBranch,
		...
		{
			name:         "v73 legacy database with branch table",
			protocol:     defines.MORPCVersion73,
			tables:       [][]interface{}{{int64(tableID), "branch_t"}},
			activeIDs:    [][]interface{}{{int64(tableID)}},
			wantIDs:      []uint64{tableID},
		...
		{
			name:         "v75 legacy database with branch table",
			protocol:     defines.MORPCVersion75,
			tables:       [][]interface{}{{int64(tableID), "branch_t"}},
			activeIDs:    [][]interface{}{{int64(tableID)}},
			wantIDs:      []uint64{tableID},
		...
		{
			name:         "v73 marked database retains legacy receipt validation",
			protocol:     defines.MORPCVersion73,
			databaseType: catalog.SystemDBTypeDataBranch,
			tables:       [][]interface{}{{int64(tableID), "branch_t"}},
			activeIDs:    [][]interface{}{{int64(tableID)}},
