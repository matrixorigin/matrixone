...
const (
	...
	checkTenantFormat = `select account_id,account_name,status,version,suspended_time,create_version,version_offset from mo_catalog.mo_account where account_name = "%s" order by account_id;`
