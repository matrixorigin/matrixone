...
var tableDefs []engine.TableDef = []engine.TableDef{
	...
	&engine.AttributeDef{
		Attr: engine.Attribute{
			Default: engine.DefaultExpr{Exist: true, Value: types.Decimal128{10, 1}},
			Type: types.Type{
...
func Test_buildConstantValue(t *testing.T) {
	...
	convey.Convey("buildConstantValue Int", t, func() {
		...
		typ.Oid = types.T_decimal128
		ret, err = buildConstantValue(typ, num)
		convey.So(ret, convey.ShouldResemble, types.Decimal128{12, 0})
		convey.So(err, convey.ShouldBeNil)
	...
	convey.Convey("buildConstantValue Float", t, func() {
		...
		typ.Scale = 1
		ret, err = buildConstantValue(typ, num)
		convey.So(ret, convey.ShouldResemble, types.Decimal128{15, 0})
		convey.So(err, convey.ShouldBeNil)
