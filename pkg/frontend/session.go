...
// text alone.
func (ses *Session) updateSqlModeCaches(oldNative, oldOnlyFullGroupBy, oldBoolSumAvg, oldHighNotPrecedence bool, oldParserFlags mysql.SQLModeFlags, oldIgnoreSpace bool, val interface{}) {
