...
func ExecRequest(requestCtx context.Context, ses *Session, req *Request) (resp *Response, err error) {
	...
	case COM_QUERY:
		...
		ses.addSqlCount(1)
		ses.Debug(requestCtx, "query trace", logutil.QueryField(SubStringFromBegin(query, int(getGlobalPu().SV.LengthOfQueryPrinted))))
...
func NewJsonPlanHandler(ctx context.Context, stmt *motrace.StatementInfo, ses FeSession, plan *plan2.Plan) *jsonPlanHandler {
