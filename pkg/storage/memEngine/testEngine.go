...
func NewTestEngine() storage.Engine {
	e := New(kv.New(), storage.Node{Id: "0", Addr: "127.0.0.1"})
	ctx := context.TODO()
...
func CreateR(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef

		{
			attrs = append(attrs, &storage.AttributeDef{
...
func CreateS(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateT(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateT1(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateCustomer(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateLineorder(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreatePart(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateSupplier(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
...
func CreateDate(db storage.Database) {
	ctx := context.TODO()
	{
		var attrs []storage.TableDef
