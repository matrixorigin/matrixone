...
func New(db *kv.KV, n storage.Node) *MemEngine {
	return &MemEngine{
		n:  n,
		db: db,
	}
...
func (e *MemEngine) Database(_ context.Context, name string, _ client.TxnOperator) (storage.Database, error) {
	if name != "test" {
...
func (e *MemEngine) Nodes() storage.Nodes {
	return nil
}
