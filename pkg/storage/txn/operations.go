...
func init() {
	...
	gob.Register(new(storage.CommentDef))
	gob.Register(new(storage.AttributeDef))
	gob.Register(new(storage.IndexTableDef))
	gob.Register(new(storage.PropertiesDef))
	gob.Register(new(storage.PrimaryIndexDef))
