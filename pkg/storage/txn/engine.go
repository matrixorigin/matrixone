...
// Engine is an storage.Engine impl
type Engine struct {
...
var _ storage.Engine = new(Engine)
...
func (e *Engine) Database(ctx context.Context, dbName string, txnOperator client.TxnOperator) (storage.Database, error) {
...
func (e *Engine) Nodes() storage.Nodes {
