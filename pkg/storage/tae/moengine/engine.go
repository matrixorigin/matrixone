...
var (
	_ storage.Engine = (*txnEngine)(nil)
)
...
func (e *txnEngine) Delete(_ context.Context, name string, ctx client.TxnOperator) (err error) {
	...
	if txn, err = e.impl.GetTxnByCtx(ctx.(storage.Snapshot)); err != nil {
		panic(err)
	}
...
func (e *txnEngine) Database(_ context.Context, name string, ctx client.TxnOperator) (storage.Database, error) {
	var err error
	var txn txnif.AsyncTxn
...
func (e *txnEngine) Nodes() storage.Nodes {
	return nil
}
