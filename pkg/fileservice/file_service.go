...
type IOEntry struct {
	...
	// if ToObject is provided, caller should always read ObjectBytes instead of Data, WriterForRead or ReadCloserForRead
	ObjectBytes []byte
	...
	ToObject func(reader io.Reader, data []byte) (object []byte, objectSize int64, err error)
