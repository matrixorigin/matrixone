...
func New(capacity int64, postEvict func(key any, value []byte, sz int64)) *Clock {
	return &Clock{}
}

func (c *Clock) Set(key any, value []byte, size int64, preloading bool) (isNewEntry bool) {
	//TODO implement me
	panic("implement me")
}
