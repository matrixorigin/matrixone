...
func Decimal64VecSub(xs, ys, rs *vector.Vector) error {
	...
	if xs.IsScalar() {
		C.Decimal64_Sub_SV(dec64PtrToC(&rt[0]), dec64PtrToC(&xt[0]), dec64PtrToC(&yt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	} else if ys.IsScalar() {
		C.Decimal64_Sub_SV(dec64PtrToC(&rt[0]), dec64PtrToC(&yt[0]), dec64PtrToC(&xt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	} else {
		C.Decimal64_Sub_VV(dec64PtrToC(&rt[0]), dec64PtrToC(&xt[0]), dec64PtrToC(&yt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	}
	return nil
}
...
func Decimal128VecSub(xs, ys, rs *vector.Vector) error {
	...
	if xs.IsScalar() {
		C.Decimal128_Sub_SV(dec128PtrToC(&rt[0]), dec128PtrToC(&xt[0]), dec128PtrToC(&yt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	} else if ys.IsScalar() {
		C.Decimal128_Sub_SV(dec128PtrToC(&rt[0]), dec128PtrToC(&yt[0]), dec128PtrToC(&xt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	} else {
		C.Decimal128_Sub_VV(dec128PtrToC(&rt[0]), dec128PtrToC(&xt[0]), dec128PtrToC(&yt[0]),
			C.uint64_t(len(rt)), (*C.uint64_t)(nulls.Ptr(rs.Nsp)))
	}
	return nil
}
