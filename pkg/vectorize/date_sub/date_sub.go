...
var (
	DateSub       func([]types.Date, []int64, []int64, *nulls.Nulls, []types.Date) []types.Date
	DatetimeSub   func([]types.Datetime, []int64, []int64, *nulls.Nulls, []types.Datetime) []types.Datetime
