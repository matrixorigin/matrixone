...
func TestFloorFloat32(t *testing.T) {
	...
	res0 := floorFloat32Pure(nums, res, 0)
	...
	resMinus1 := floorFloat32Pure(nums, res, -1)
	...
	res1 := floorFloat32Pure(nums, res, 1)
...
func TestFloorFloat64(t *testing.T) {
	...
	res1 := floorFloat64Pure(nums, res, 1)
