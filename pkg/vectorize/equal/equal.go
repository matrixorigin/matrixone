...
func NumericEqual[T constraints.Integer | constraints.Float](xs, ys, rs *vector.Vector) error {
	...
	//rc := C.Numeric_VecEq(void *r, void *a, void  *b, uint64_t n, uint64_t *nulls, int32_t flag, int32_t szof)
