...
func (ht *String24HashMap) Init(proc *process.Process) error {
...
func (ht *String24HashMap) Insert(hash uint64, key *[3]uint64, proc *process.Process) (inserted bool, value *uint64, err error) {
...
func (ht *String24HashMap) InsertBatch(hashes []uint64, keys [][3]uint64, inserted []uint8, values []*uint64, proc *process.Process) (err error) {
...
func (ht *String24HashMap) resizeOnDemand(n uint64, proc *process.Process) error {
...
func (ht *String24HashMap) Destroy(proc *process.Process) {
	if ht == nil || proc == nil {
		return
	}
