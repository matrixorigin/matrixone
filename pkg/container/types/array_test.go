...
func BenchmarkStringToArray(b *testing.B) {
	...
	b.Run("StringToArray-ForLoop", func(b *testing.B) {
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
	...
	/*
		Benchmark 1: (this)
			...
			BenchmarkStringToArray/StringToArray-Trim_Split-10         	1000000000	         0.0000752 ns/op
			BenchmarkStringToArray/StringToArray-ForLoop
			BenchmarkStringToArray/StringToArray-ForLoop-10            	    7466	    153929 ns/op

		Benchmark 2:  While inserting via SQL Alchemy,
			# mo       macos   insert/second=330.54838430904914 Split (v1)
			# mo       macos   insert/second=321.54838430904914 ForLoop (v2)
	*/
}
