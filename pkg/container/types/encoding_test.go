...
func TestCompareValues(t *testing.T) {
	...
	require.Equal(t, -1, CompareValue(false, true))
	...
	require.Equal(t, -1, CompareValue(Datetime(1), Datetime(2)))
	require.Equal(t, -1, CompareValue(uuidA, uuidB))
	require.Equal(t, -1, CompareValue(tsA, tsB))
...
func TestCompareValuesNULL(t *testing.T) {
	require.Equal(t, int(0), CompareValue(nil, nil))
	require.Equal(t, int(-1), CompareValue(nil, 1))
	require.Equal(t, int(1), CompareValue(1, nil))
}
