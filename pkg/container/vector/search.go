...
func FixedSizeSearchOffsetsByGTTypeChecked[T types.Decimal | types.Uuid](
...
func FixedSizedLinearCollectOffsetsByBetweenFactory[
	T types.Decimal | types.Uuid](lb, ub T, cmp func(T, T) int) func(*Vector) []int64 {
	return func(vector *Vector) []int64 {
		var sels []int64
		vecLen := vector.Length()
		if vecLen == 0 {
