...
var clusterUpgEntries = []versions.UpgradeEntry{
	...
	upg_mo_user_defined_function_add_sql_mode,
...
var upg_mo_user_defined_function_add_sql_mode = versions.UpgradeEntry{
	Schema:    catalog.MO_CATALOG,
	...
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		info, err := versions.CheckTableColumn(txn, accountId, catalog.MO_CATALOG, "mo_user_defined_function", "sql_mode")
		if err != nil {
			return false, err
		}
		return info.IsExits, nil
