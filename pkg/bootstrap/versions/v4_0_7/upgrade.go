...
func init() {
	Handler = &versionHandle{
		metadata: versions.Version{
			...
			// The tenant migration publishes the v76 VIEWS definition as well as widening
			...
			// any CN is still below v76 would retain the predecessor VIEWS definition and
