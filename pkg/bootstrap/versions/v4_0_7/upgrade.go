...
func init() {
	Handler = &versionHandle{
		metadata: versions.Version{
			...
			// The tenant migration publishes the v75 VIEWS definition as well as widening
			...
			// any CN is still below v75 would retain the predecessor VIEWS definition and
