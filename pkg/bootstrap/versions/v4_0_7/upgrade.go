...
func init() {
	Handler = &versionHandle{
		metadata: versions.Version{
			...
			// The tenant migration publishes the v92 VIEWS definition as well as widening
			...
			// any CN is still below v92 would retain the predecessor VIEWS definition and
			...
			RequiredProtocolVersion: defines.MORPCVersion92,
		},
	}
}
