...
func init() {
	Handler = &versionHandle{
		metadata: versions.Version{
			...
			// The tenant migration publishes the v88 VIEWS definition as well as widening
			...
			// any CN is still below v88 would retain the predecessor VIEWS definition and
			...
			RequiredProtocolVersion: defines.MORPCVersion88,
		},
	}
}
