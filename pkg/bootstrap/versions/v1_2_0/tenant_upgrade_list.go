...
var upg_mo_foreign_keys = versions.UpgradeEntry{
	...
	UpgSql:    frontend.MoCatalogMoForeignKeys,
...
var upg_mo_snapshots = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    frontend.MoCatalogMoSnapshots,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_schema_privileges = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaSchemaPrivileges,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_table_privileges = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaTablePrivileges,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_column_privileges = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaColumnPrivileges,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_collations = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaCollations,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_table_constraints = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaTableConstraints,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_events = versions.UpgradeEntry{
	...
	TableName: "events",
	UpgType:   versions.CREATE_NEW_TABLE,
	UpgSql:    sysview.InformationSchemaEvents,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
...
var upg_information_schema_tables = versions.UpgradeEntry{
	...
	UpgSql:    sysview.InformationSchemaTables,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaTables {
			return true, nil
		}
		return false, nil
	},
...
var upg_information_schema_processlist = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    sysview.InformationSchemaProcesslist,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaProcesslist {
			return true, nil
		}
		return false, nil
	},
...
var upg_information_schema_referenctial_constraints = versions.UpgradeEntry{
	...
	UpgType:   versions.CREATE_VIEW,
	UpgSql:    sysview.InformationSchemaReferentialConstraints,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaReferentialConstraints {
			return true, nil
		}
		return false, nil
	},
...
var upg_information_schema_columns = versions.UpgradeEntry{
	...
	TableName: "COLUMNS",
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    sysview.InformationSchemaColumns,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaColumns {
			return true, nil
		}
		return false, nil
	},
...
var upg_information_schema_views = versions.UpgradeEntry{
	...
	TableName: "VIEWS",
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    sysview.InformationSchemaViews,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaViews {
			return true, nil
		}
		return false, nil
	},
...
var upg_information_schema_partitions = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    sysview.InformationSchemaPartitions,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == sysview.InformationSchemaPartitions {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_sessions = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoSessions,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoSessions {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_configurations = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoConfigurations,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoConfigurations {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_locks = versions.UpgradeEntry{
	...
	TableName: "mo_locks",
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoLocks,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoLocks {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_variables = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoVariables,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoVariables {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_transactions = versions.UpgradeEntry{
	...
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoTransactions,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoTransactions {
			return true, nil
		}
		return false, nil
	},
...
var upg_mo_catalog_mo_cache = versions.UpgradeEntry{
	...
	TableName: "mo_cache",
	UpgType:   versions.MODIFY_VIEW,
	UpgSql:    frontend.MoCatalogMoCache,
	CheckFunc: func(txn executor.TxnExecutor, accountId uint32) (bool, error) {
		...
		if exists && viewDef == frontend.MoCatalogMoCache {
			return true, nil
		}
		return false, nil
	},
