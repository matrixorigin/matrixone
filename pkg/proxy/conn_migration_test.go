...
func runTestWithQueryService(t *testing.T, cn metadata.CNService, fn func(qc queryservice.QueryService, addr string)) {
...
func TestQueryServiceMigrateConn(t *testing.T) {
	...
	runTestWithQueryService(t, cn, func(qc queryservice.QueryService, addr string) {
