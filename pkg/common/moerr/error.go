...
const (
	...
	// Digest parser errors use the next free internal codes after the
	// user-lock and binary-operand errors already assigned on main.
	ErrDigestParse            uint16 = 20337
	ErrDigestParseUndisclosed uint16 = 20338
