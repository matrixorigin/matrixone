...
// compareUTF8mb4GeneralCI implements MySQL's legacy utf8mb4_general_ci
// semantics: every Unicode character contributes exactly one sort weight.
// In particular, the collation has no multi-character expansions.
