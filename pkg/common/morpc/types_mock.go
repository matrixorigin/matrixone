...
// Package morpc is a generated GoMock package.
package morpc
...
func (m *MockClientSession) CreateCache(arg0 context.Context, arg1 uint64) (MessageCache, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCache", arg0, arg1)
	ret0, _ := ret[0].(MessageCache)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClientSession) GetCache(arg0 uint64) (MessageCache, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientSession) Write(arg0 context.Context, arg1 Message) error {
	m.ctrl.T.Helper()
