...
func NewJoinMap(sels [][]int32, nullSels []int32, expr *plan.Expr, mp *StrHashMap, hasNull bool, idx *index.LowCardinalityIndex) *JoinMap {
	cnt := int64(1)
	return &JoinMap{
		cnt:      &cnt,
		mp:       mp,
...
func (jm *JoinMap) Nullsels() []int32 {
	return jm.nullSels
}
