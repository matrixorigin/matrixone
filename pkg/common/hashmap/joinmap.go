...
func NewJoinMap(singleSel []int32, sels [][]int32, expr *plan.Expr, ihm *IntHashMap, shm *StrHashMap, hasNull bool, isDup bool) *JoinMap {
	cnt := int64(1)
	return &JoinMap{
		cnt:       &cnt,
		shm:       shm,
...
func (jm *JoinMap) SingleSel() []int32 {
	return jm.singleSel
}
