...
// tar so a IVF-PQ index that cannot fit is refused as soon as the total says so, instead of
...
func (s *IvfpqSearch[B, Q]) Preload(sqlproc *sqlexec.SqlProcess) error { return nil }
