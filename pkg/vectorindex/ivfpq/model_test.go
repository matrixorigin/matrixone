...
func TestModelBuildAndLoad(t *testing.T) {
	...
	fmt.Printf("SearchF32 result: keys=%v dists=%v\n", keys, dists)
	// IVF-PQ is lossy; verify the nearest neighbor is one of the first few IDs.
