...
func NewCagraBuild[B, Q cuvs.VectorType](
	...
	tmpDir, err := os.MkdirTemp(spillDir, fmt.Sprintf("mo-cagra-%d-", os.Getpid()))
	if err != nil {
		return nil, err
	}
...
func (b *CagraBuild[B, Q]) ToInsertSql(ts int64, buildTS int64, provenance bool) ([]string, error) {
