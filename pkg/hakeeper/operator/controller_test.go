...
func TestDispatchAndRemoveOperator(t *testing.T) {
	...
	c.Dispatch([]*Operator{operator1}, pb.LogState{}, pb.TNStore{}, pb.CNState{})
	assert.Equal(t, []*Operator{operator1}, c.operators[1])

	c.Dispatch([]*Operator{operator2}, pb.LogState{}, pb.TNStore{}, pb.CNState{})
	assert.Equal(t, []*Operator{operator1, operator2}, c.operators[1])

	c.Dispatch([]*Operator{operator3}, pb.LogState{}, pb.TNStore{}, pb.CNState{})
...
func TestRemoveFinishedOperator(t *testing.T) {
	...
	c.Dispatch([]*Operator{op1}, logState, pb.TNStore{}, pb.CNState{})
	...
	c.RemoveFinishedOperator(logState, pb.TNStore{}, pb.CNState{})
