...
func NewGpuIvfFlatFromDataDirectory[B, Q VectorType](dir string, dimension uint32, metric DistanceType,
	...
	C.gpu_ivf_flat_load_dir(cIvfFlat, cDir, C.distribution_mode_t(mode), unsafe.Pointer(&errmsg))
	if errmsg != nil {
		errStr := C.GoString(errmsg)
		C.free(unsafe.Pointer(errmsg))
		C.gpu_ivf_flat_destroy(cIvfFlat, nil)
...
func (gi *GpuIvfFlat[B, Q]) Pack(filename, spillDir string) error {
	if gi.cIvfFlat == nil {
		return moerr.NewInternalErrorNoCtx("GpuIvfFlat is not initialized")
	}
...
func (gi *GpuIvfFlat[B, Q]) Unpack(filename, spillDir string, mode DistributionMode) error {
	...
	C.gpu_ivf_flat_load_dir(gi.cIvfFlat, cDir, C.distribution_mode_t(mode), unsafe.Pointer(&errmsg))
	if errmsg != nil {
		errStr := C.GoString(errmsg)
		C.free(unsafe.Pointer(errmsg))
		return moerr.NewInternalErrorNoCtx(errStr)
...
func (gi *GpuIvfFlat[B, Q]) DeleteId(id int64) error {
	...
	var errmsg *C.char
	C.gpu_ivf_flat_delete_id(gi.cIvfFlat, C.int64_t(id), unsafe.Pointer(&errmsg))
	if errmsg != nil {
		errStr := C.GoString(errmsg)
		C.free(unsafe.Pointer(errmsg))
		return moerr.NewInternalErrorNoCtx(errStr)
...
func (gi *GpuIvfFlat[B, Q]) SearchQuantize(queries []B, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams) (SearchResultIvfFlat, error) {
	...
	res := C.gpu_ivf_flat_search_quantize(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
...
func (gi *GpuIvfFlat[B, Q]) SearchAsyncWithParams(queries []Q, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams) (uint64, error) {
	...
	jobID := C.gpu_ivf_flat_search_async(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
...
func (gi *GpuIvfFlat[B, Q]) SearchQuantizeAsyncWithParams(queries []B, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams) (uint64, error) {
	...
	jobID := C.gpu_ivf_flat_search_quantize_async(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
...
func (gi *GpuIvfFlat[B, Q]) SearchWait(jobID uint64, numQueries uint64, limit uint32) ([]int64, []float32, error) {
	...
	var errmsg *C.char
	res := C.gpu_ivf_flat_search_wait(gi.cIvfFlat, C.uint64_t(jobID), unsafe.Pointer(&errmsg))
...
func (gi *GpuIvfFlat[B, Q]) SetFilterColumns(colMetaJSON string, totalCount uint64) error {
	...
	C.gpu_ivf_flat_set_filter_columns(gi.cIvfFlat, cMeta, C.uint64_t(totalCount), unsafe.Pointer(&errmsg))
	if errmsg != nil {
		errStr := C.GoString(errmsg)
		C.free(unsafe.Pointer(errmsg))
		return moerr.NewInternalErrorNoCtx(errStr)
...
func (gi *GpuIvfFlat[B, Q]) AddFilterChunk(colIdx uint32, data []byte, nullBitmap []uint32, nrows uint64) error {
	...
	C.gpu_ivf_flat_add_filter_chunk(
		gi.cIvfFlat,
		C.uint32_t(colIdx),
...
func (gi *GpuIvfFlat[B, Q]) SearchWithFilter(queries []Q, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams, predsJSON string) (SearchResultIvfFlat, error) {
	...
	res := C.gpu_ivf_flat_search_with_filter(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
...
func (gi *GpuIvfFlat[B, Q]) SearchQuantizeWithFilter(queries []B, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams, predsJSON string) (SearchResultIvfFlat, error) {
	if gi.cIvfFlat == nil {
		return SearchResultIvfFlat{}, moerr.NewInternalErrorNoCtx("GpuIvfFlat is not initialized")
	}
	if len(queries) == 0 || numQueries == 0 {
	...
	res := C.gpu_ivf_flat_search_quantize_with_filter(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
...
func (gi *GpuIvfFlat[B, Q]) SearchQuantizeWithFilterAsync(queries []B, numQueries uint64, dimension uint32, limit uint32, sp IvfFlatSearchParams, predsJSON string) (uint64, error) {
	...
	jobID := C.gpu_ivf_flat_search_quantize_with_filter_async(
		gi.cIvfFlat,
		unsafe.Pointer(&queries[0]),
		C.uint64_t(numQueries),
		C.uint32_t(dimension),
