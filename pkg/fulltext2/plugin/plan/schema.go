...
func (Hooks) BuildFullTextIndexDefs(
	...
	metaTbl := &plan.TableDef{
		...
		Cols: []*plan.ColDef{
			...
			{Name: catalog.FullText2Index_TblCol_Metadata_Nrow, Alg: plan.CompressType_Lz4, Typ: plan.Type{Id: int32(types.T_int64)}, Default: planplugin.ZeroInt64Default()},
			{Name: catalog.FullText2Index_TblCol_Metadata_Build_Ts, Alg: plan.CompressType_Lz4, Typ: plan.Type{Id: int32(types.T_int64)}, Default: planplugin.ZeroInt64Default()},
		},
	}
