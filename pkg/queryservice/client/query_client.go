...
var methodVersions = map[pb.CmdMethod]int64{
	...
	pb.CmdMethod_SetVectorIndexFreshnessInterval: defines.MORPCVersion85,
	pb.CmdMethod_GetVectorIndexCacheInfo:         defines.MORPCVersion85,
	pb.CmdMethod_EvictVectorIndexCache:           defines.MORPCVersion85,
	pb.CmdMethod_GetVectorIndexCacheKeys:         defines.MORPCVersion85,
