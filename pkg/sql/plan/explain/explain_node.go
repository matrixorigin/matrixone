...
func (a AnalyzeInfoDescribeImpl) GetDescription(ctx context.Context, options *ExplainOptions, buf *bytes.Buffer) error {
	fmt.Fprintf(buf, "timeConsumed=%dms, dop=%v, timeConsumedEachParallel=%v", a.AnalyzeInfo.TimeConsumed/1000000, len(a.AnalyzeInfo.TimeConsumedArray), a.AnalyzeInfo.TimeConsumedArray)
