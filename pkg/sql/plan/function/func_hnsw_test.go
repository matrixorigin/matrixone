...

		{
			...
			inputs: []FunctionTestInput{
				...
				NewFunctionTestInput(types.T_varchar.ToType(),
					[]string{""}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{int32(types.T_array_float32)}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{2}, []bool{false}),
				NewFunctionTestInput(types.T_json.ToType(),
					[]string{"{..."}, []bool{false}),
		...
		},
		{
			...
			inputs: []FunctionTestInput{
				...
				NewFunctionTestInput(types.T_varchar.ToType(),
					[]string{""}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{int32(types.T_array_float64)}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{2}, []bool{false}),
				NewFunctionTestInput(types.T_json.ToType(),
					[]string{"{..."}, []bool{false}),
		...
		},
		{
			...
			inputs: []FunctionTestInput{
				...
				NewFunctionTestInput(types.T_varchar.ToType(),
					[]string{""}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{int32(types.T_float32)}, []bool{false}),
				NewFunctionTestInput(types.T_int32.ToType(),
					[]int32{2}, []bool{false}),
				NewFunctionTestInput(types.T_json.ToType(),
					[]string{"{..."}, []bool{false}),
