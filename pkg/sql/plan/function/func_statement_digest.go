...
func StatementHash(
	...
	// A received remote process must pass the build fence for the whole scope,
	// including zero-row, all-NULL, and all-masked batches. This is a dispatch
	// invariant, not a property that can depend on an active row callback.
