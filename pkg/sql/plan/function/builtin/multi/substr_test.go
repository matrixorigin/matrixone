...
func TestSubStrBlob(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:       "TEST01",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 5, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte("efghijklmn"),
			wantScalar: true,
		},
		{
			name:       "TEST02",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 7, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte("ghijklmn"),
			wantScalar: true,
		},
		{
			name:       "TEST03",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 11, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte("klmn"),
			wantScalar: true,
		},
		{
			name:       "TEST04",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 16, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "TEST05",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 5, 6, true, procs),
			proc:       procs,
			wantBytes:  []byte("efghij"),
			wantScalar: true,
		},
		{
			name:       "TEST06",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 5, 10, true, procs),
			proc:       procs,
			wantBytes:  []byte("efghijklmn"),
			wantScalar: true,
		},
		{
			name:       "TEST07",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 5, 0, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "TEST08",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 6, -8, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "TEST09",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 6, -9, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "TEST09",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 6, -4, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "TEST10",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), 6, -1, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test11",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -4, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte("klmn"),
			wantScalar: true,
		},
		{
			name:       "Test12",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -14, 0, false, procs),
			proc:       procs,
			wantBytes:  []byte("abcdefghijklmn"),
			wantScalar: true,
		},
		...
		{
			name:       "Test14",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -4, 3, true, procs),
			proc:       procs,
			wantBytes:  []byte("klm"),
			wantScalar: true,
		},
		{
			name:       "Test15",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -14, 10, true, procs),
			proc:       procs,
			wantBytes:  []byte("abcdefghij"),
			wantScalar: true,
		},
		{
			name:       "Test16",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -14, 15, true, procs),
			proc:       procs,
			wantBytes:  []byte("abcdefghijklmn"),
			wantScalar: true,
		},
		{
			name:       "Test17",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -16, 10, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test18",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -16, 20, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test19",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -16, 2, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test20",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -12, 2, true, procs),
			proc:       procs,
			wantBytes:  []byte("cd"),
			wantScalar: true,
		},
		{
			name:       "Test21",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -12, 14, true, procs),
			proc:       procs,
			wantBytes:  []byte("cdefghijklmn"),
			wantScalar: true,
		},
		{
			name:       "Test22",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -12, 0, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test23",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -6, -5, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test24",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -6, -10, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
		{
			name:       "Test25",
			vecs:       makeSubStrBlobVectors([]byte("abcdefghijklmn"), -6, 0, true, procs),
			proc:       procs,
			wantBytes:  []byte(""),
			wantScalar: true,
		},
