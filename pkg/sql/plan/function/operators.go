	...
	PLUS: {
		...
		Overloads: []Function{
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusStringAndString[types.Varlena, types.Varlena],
			},
			{
				Index:     13,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusStringAndFloat[types.Varlena, float32],
			},
			{
				Index:     17,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusStringAndFloat[types.Varlena, float64],
			},
			{
				Index:     19,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusStringAndSigned[types.Varlena, int64],
			},
			{
				Index:     21,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusStringAndUnsigned[types.Varlena, uint64],
			},
			{
				Index:     22,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusFloatAndString[float32, types.Varlena],
			},
			{
				Index:     25,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusFloatAndString[float64, types.Varlena],
			},
			{
				Index:     27,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
			...
			},
			{
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusSignedAndString[int64, types.Varlena],
			},
			{
				Index:     29,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
				...
				ReturnTyp: types.T_float64,
				Fn:        operator.PlusUnsignedAndString[uint64, types.Varlena],
			},
			{
				Index:     30,
				Flag:      plan.Function_STRICT | plan.Function_MONOTONICAL,
