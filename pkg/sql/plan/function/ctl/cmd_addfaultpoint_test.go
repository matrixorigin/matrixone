...
//	require.Nil(t, err)
//
//	qs1.AddHandleFunc(query.CmdMethod_FaultInject, mockHandleFaultInjection, false)
//	qs2.AddHandleFunc(query.CmdMethod_FaultInject, mockHandleFaultInjection, false)
//
