		...
		Overloads: []Function{
			{
				...
				Layout:    STANDARD_FUNCTION,
				Args:      []types.T{types.T_float64},
				ReturnTyp: types.T_float64, Fn: unary.Exp,
			},
		},
	},
	EXTRACT: {
		...
		Overloads: []Function{
			{
				...
				Layout:    STANDARD_FUNCTION,
				Args:      []types.T{types.T_float64},
				ReturnTyp: types.T_float64, Fn: unary.Ln,
			},
		},
	},
	LOG: {
		...
		Overloads: []Function{
			{
				...
				Layout:    STANDARD_FUNCTION,
				Args:      []types.T{types.T_float64},
				ReturnTyp: types.T_float64, Fn: unary.Log,
			},
		},
	},
	LTRIM: {
		...
		Overloads: []Function{
			{
				...
				Layout:    STANDARD_FUNCTION,
				Args:      []types.T{types.T_float64},
				ReturnTyp: types.T_float64, Fn: unary.Sin,
			},
		},
	},
	SPACE: {
