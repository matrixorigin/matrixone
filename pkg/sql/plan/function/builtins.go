...
var builtins = map[int]Functions{
	...
	SUBSTRING_INDEX: {
		...
		Overloads: []Function{
			...
			{
				Index:     9,
				Args:      []types.T{types.T_text, types.T_varchar, types.T_int64},
				ReturnTyp: types.T_varchar,
				Fn:        multi.SubStrIndex,
			},
			{
				Index:     10,
				Args:      []types.T{types.T_text, types.T_varchar, types.T_uint64},
				ReturnTyp: types.T_varchar,
				Fn:        multi.SubStrIndex,
			},
			{
				Index:     11,
				Args:      []types.T{types.T_text, types.T_varchar, types.T_float64},
				ReturnTyp: types.T_varchar,
				Fn:        multi.SubStrIndex,
			},
			{
			...
			{
				Index:     13,
				Args:      []types.T{types.T_blob, types.T_varchar, types.T_uint64},
				ReturnTyp: types.T_varchar,
				Fn:        multi.SubStrIndex,
			},
			{
				Index:     14,
				Args:      []types.T{types.T_blob, types.T_varchar, types.T_float64},
				ReturnTyp: types.T_varchar,
				Fn:        multi.SubStrIndex,
			},
		},
