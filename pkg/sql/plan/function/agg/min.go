...
func RegisterMin2(id int64) {
	...
	aggexec.RegisterAggFromFixedRetFixed(
		aggexec.MakeSingleColumnAggInformation(id, types.T_decimal256.ToType(), MinReturnType, true),
		nil,
		nil,
		aggMinOfDecimal256Init,
		aggMinOfDecimal256Fill, aggMinOfDecimal256Fills, aggMinOfDecimal256Merge, nil)
...
// min(decimal256) — max positive value as initial sentinel
...
func aggMinOfDecimal256Init(_ types.Type, _ ...types.Type) types.Decimal256 {
	return decimal256MaxPositive
}

func aggMinOfDecimal256Fill(
...
var fromTypeIDtoMaxValue = map[types.T]interface{}{
	...
	types.T_year:      types.MoYear(math.MaxInt16),
