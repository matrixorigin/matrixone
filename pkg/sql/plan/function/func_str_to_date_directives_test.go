...
func TestStrToDateDayAndWeekDirectives(t *testing.T) {
	for _, tc := range []struct {
		...
		{"signed ordinal day", "+1st February 2024", "%D %M %Y", "2024-02-01", true},
		{"ordinal day overridden", "32nd 2024 060", "%D %Y %j", "2024-02-29", true},
		{"day of year", "2024 060", "%Y %j", "2024-02-29", true},
		{"signed day of year", "2024 +60", "%Y %j", "2024-02-29", true},
		{"missing repeated day of year preserves prior value", "2024 060", "%Y %j%j", "2024-02-29", true},
		{"negative day of year rejected", "2024-02-29 -01", "%Y-%m-%d %j", "", false},
		...
		{"weekday with UTF-8 Latin1 letter suffix", "2024-09-Mondayé", "%Y-%u-%W", "", false},
		{"weekday with non-Latin1 letter suffix", "2024-09-Mondayא", "%Y-%u-%W", "2024-02-26", true},
		{"abbreviated rejects full name", "2024-09-Monday", "%Y-%u-%a", "", false},
		{"iso week year", "2024-09-1", "%x-%v-%w", "2024-02-26", true},
		{"signed week year", "+024-01-1", "%x-%v-%w", "0024-01-01", true},
		{"sunday week year", "2024-09-1", "%X-%V-%w", "2024-03-04", true},
		{"monday week", "2024-09-1", "%Y-%u-%w", "2024-02-26", true},
		{"signed monday week", "2024-+9-1", "%Y-%u-%w", "2024-02-26", true},
