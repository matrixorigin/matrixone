...
var supportedStringBuiltIns = []FuncNew{
	...
	// function `not_reg_match`
	{
		...
		checkFn:    fixedTypeMatchPreservingBinary(0, 1),
	...
	// function `regexp_instr`
	{
		...
		Overloads: []overload{
			...
			{
				overloadId: 3,
				args:       []types.T{types.T_varchar, types.T_varchar, types.T_int64, types.T_int64, types.T_int64},
				retType: func(parameters []types.Type) types.Type {
					return types.T_int64.ToType()
				},
				newOp: func() executeLogicOfOverload {
			...
			{
				overloadId: 4,
				args:       []types.T{types.T_varchar, types.T_varchar, types.T_int64, types.T_int64, types.T_int64, types.T_varchar},
				retType: func(parameters []types.Type) types.Type {
					return types.T_int64.ToType()
				},
				newOp: func() executeLogicOfOverload {
	...
	// function `regexp_replace`
	{
		...
		class:      plan.Function_STRICT,
		layout:     STANDARD_FUNCTION,
		checkFn:    fixedTypeMatchPreservingBinary(0, 1, 2),
...
var supportedOthersBuiltIns = []FuncNew{
	...
	// function `charset`
	{
		...
		class:      plan.Function_STRICT,
		layout:     STANDARD_FUNCTION,
		checkFn:    fixedTypeMatchPreservingBinary(0),
