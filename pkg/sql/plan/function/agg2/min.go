...
func (a aggMin[from]) Init(set aggexec.AggSetter[from]) {
...
func (a aggMinDecimal64) Init(set aggexec.AggSetter[types.Decimal64]) {
...
func (a aggMinDecimal128) Init(set aggexec.AggSetter[types.Decimal128]) {
