...
func Test_Cluster(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: [][]float64{
				{0.15915269938161652, 0.31830539876323305, 0.5757527355814478, 0.7349054349630643}, // {1, 2, 3.6666666666666665, 4.666666666666666}
				{0.8077006350571528, 0.26637173227965466, 0.3230802540228611, 0.4038503175285764},  // {10, 3.333333333333333, 4, 5}
			},
