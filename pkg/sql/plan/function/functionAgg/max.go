...
func NewAggMax(overloadID int64, dist bool, inputTypes []types.Type, outputType types.Type, _ any, partialresult any) (agg.Agg[any], error) {
	...
	case types.T_uint8:
		return newGenericMax[uint8](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_uint16:
		return newGenericMax[uint16](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_uint32:
		return newGenericMax[uint32](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_uint64:
		return newGenericMax[uint64](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_int8:
		return newGenericMax[int8](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_int16:
		return newGenericMax[int16](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_int32:
		return newGenericMax[int32](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_int64:
		return newGenericMax[int64](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_float32:
		return newGenericMax[float32](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_float64:
		return newGenericMax[float64](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_date:
		return newGenericMax[types.Date](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_datetime:
		return newGenericMax[types.Datetime](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_timestamp:
		return newGenericMax[types.Timestamp](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_time:
		return newGenericMax[types.Time](overloadID, inputTypes[0], outputType, dist, partialresult)
	case types.T_enum:
		return newGenericMax[types.Enum](overloadID, inputTypes[0], outputType, dist, partialresult)
...
func newGenericMax[T compare](overloadID int64, typ types.Type, otyp types.Type, dist bool, partialresult any) (agg.Agg[any], error) {
	aggPriv := &sAggMax[T]{}
	if dist {
...
func (s *sAggMax[T]) Eval(lastResult []T, partialresult any) (result []T, err error) {
...
func (s *sAggBoolMax) Eval(lastResult []bool, partialresult any) (result []bool, err error) {
	return lastResult, nil
}
...
func (s *sAggDecimal64Max) Eval(lastResult []types.Decimal64, partialresult any) (result []types.Decimal64, err error) {
	return lastResult, nil
}
...
func (s *sAggDecimal128Max) Eval(lastResult []types.Decimal128, partialresult any) (result []types.Decimal128, err error) {
	return lastResult, nil
}
...
func (s *sAggUuidMax) Eval(lastResult []types.Uuid, partialresult any) (result []types.Uuid, err error) {
	return lastResult, nil
}
...
func (s *sAggStrMax) Eval(lastResult [][]byte, _ any) (result [][]byte, err error) {
	return lastResult, nil
}
