...
func (s *sAggSum[Input, Output]) Eval(lastResult []Output, _ any) ([]Output, error) {
...
func (s *sAggDecimal64Sum) Eval(lastResult []types.Decimal64, _ any) ([]types.Decimal64, error) {
	return lastResult, nil
}
...
func (s *sAggDecimal128Sum) Eval(lastResult []types.Decimal128, _ any) ([]types.Decimal128, error) {
	return lastResult, nil
}
