...
func TestExactMathStringNumericPrefixTypeMatching(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"abs string", []types.Type{types.T_varchar.ToType()}, types.T_float64, false, nil},
		{"sign string", []types.Type{types.T_varchar.ToType()}, types.T_int64, false, nil},
		{"ceil string", []types.Type{types.T_varchar.ToType()}, types.T_float64, false, nil},
		{"floor string", []types.Type{types.T_varchar.ToType()}, types.T_float64, false, nil},
		{"round string", []types.Type{types.T_varchar.ToType()}, types.T_float64, false, nil},
		{"truncate string", []types.Type{types.T_varchar.ToType(), types.T_int64.ToType()}, types.T_float64, false, nil},
		{"round string digits string", []types.Type{types.T_varchar.ToType(), types.T_varchar.ToType()}, types.T_float64, true, []types.T{types.T_varchar, types.T_int64}},
		{"truncate string digits string", []types.Type{types.T_varchar.ToType(), types.T_varchar.ToType()}, types.T_float64, true, []types.T{types.T_varchar, types.T_int64}},
