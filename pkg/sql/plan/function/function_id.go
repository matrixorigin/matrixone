...
const (
	...
	// INTERNAL_COLLATION_COMPOSITE_KEY_V2 frames multiple text parts with the
	// same versioned codec. It is planner/runtime-only and intentionally absent
	// from functionIdRegister.
