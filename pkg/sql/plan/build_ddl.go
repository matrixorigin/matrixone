...
func buildCTASDefaultFromOrigin(
	...
	if err = RequirePersistedExpressionProtocol(ctx.GetContext(), ctx.GetProcess(), defaultExpr); err != nil {
		return nil, err
	}
...
func appendCheckDef(
	...
	if err = RequirePersistedExpressionProtocol(ctx.GetContext(), ctx.GetProcess(), checkExpr); err != nil {
		return err
	}
