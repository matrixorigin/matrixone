...
func isUnsignedType(expr *plan.Expr) bool {
...
func isSignedType(expr *plan.Expr) bool {
	t := types.T(expr.Typ.Id)
...
func IsFloatType(expr *plan.Expr) bool {
	t := types.T(expr.Typ.Id)
...
func isStringType(expr *plan.Expr) bool {
	t := types.T(expr.Typ.Id)
...
func isDateRelateType(expr *plan.Expr) bool {
	t := types.T(expr.Typ.Id)
