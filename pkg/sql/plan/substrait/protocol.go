...
const (
	...
	CapabilityDocument     = `{"protocol_version":1,"substrait_version":"0.78.0","tae_read_protocol_version":1,"tae_read_feature_bits":0,"operators":["read","filter","project","aggregate","sort","fetch"],"types":["bool","i8","i16","i32","i64","fp32","fp64","fixed_char","date","varchar","precision_timestamp_us"],"semantic_registry":"exact-mo-overload-argument-result-nullability-v1","scalar_overloads":["and(bool,bool)->bool","or(bool,bool)->bool","not(bool)->bool","equal(i64,i64)->bool","not_equal(i64,i64)->bool","lt(i64,i64)->bool","lte(i64,i64)->bool","gt(i64,i64)->bool","gte(i64,i64)->bool","is_null(i64)->bool","is_not_null(i64)->bool","is_not_distinct_from(i64,i64)->bool","add(i64,i64)->i64","subtract(i64,i64)->i64","multiply(i64,i64)->i64","modulus(i64,i64)->i64","between(i64,i64,i64)->bool"],"aggregate_overloads":["count(i64)->i64","count_all(i64_literal)->i64","min(i64)->i64","max(i64)->i64"],"transport":"arrow-flight","sirius_execution_contract":1,"max_plan_bytes":16777216}`
)
