...
func NewBinding(tag, nodeID int32, table string, tableID uint64, cols []string, colIsHidden []bool, types []*plan.Type, isClusterTable bool, defaultVals []string) *Binding {
	binding := &Binding{
		tag:            tag,
		nodeId:         nodeID,
		table:          table,
