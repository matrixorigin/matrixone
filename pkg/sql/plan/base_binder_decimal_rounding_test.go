...
func TestDecimalRoundingReturnMetadata(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "ceil small decimal", function: "ceil", input: types.New(types.T_decimal64, 10, 4), want: types.T_int64.ToType()},
		{name: "floor small decimal", function: "floor", input: types.New(types.T_decimal64, 10, 4), want: types.T_int64.ToType()},
