...
const MYSQL_PREPARE = 57587
const MYSQL_DEALLOCATE = 57588
const MYSQL_PROPERTIES = 57589
const MYSQL_PARSER = 57590
const MYSQL_VISIBLE = 57591
const MYSQL_INVISIBLE = 57592
const MYSQL_BTREE = 57593
const MYSQL_HASH = 57594
const MYSQL_RTREE = 57595
const MYSQL_BSI = 57596
const MYSQL_ZONEMAP = 57597
const MYSQL_LEADING = 57598
const MYSQL_BOTH = 57599
const MYSQL_TRAILING = 57600
const MYSQL_UNKNOWN = 57601
const MYSQL_EXPIRE = 57602
const MYSQL_ACCOUNT = 57603
const MYSQL_UNLOCK = 57604
const MYSQL_DAY = 57605
const MYSQL_NEVER = 57606
const MYSQL_SECOND = 57607
const MYSQL_ASCII = 57608
const MYSQL_COALESCE = 57609
const MYSQL_COLLATION = 57610
const MYSQL_HOUR = 57611
const MYSQL_MICROSECOND = 57612
const MYSQL_MINUTE = 57613
const MYSQL_MONTH = 57614
const MYSQL_QUARTER = 57615
const MYSQL_REPEAT = 57616
const MYSQL_REVERSE = 57617
const MYSQL_ROW_COUNT = 57618
const MYSQL_WEEK = 57619
const MYSQL_REVOKE = 57620
const MYSQL_FUNCTION = 57621
const MYSQL_PRIVILEGES = 57622
const MYSQL_TABLESPACE = 57623
const MYSQL_EXECUTE = 57624
const MYSQL_SUPER = 57625
const MYSQL_GRANT = 57626
const MYSQL_OPTION = 57627
const MYSQL_REFERENCES = 57628
const MYSQL_REPLICATION = 57629
const MYSQL_SLAVE = 57630
const MYSQL_CLIENT = 57631
const MYSQL_USAGE = 57632
const MYSQL_RELOAD = 57633
const MYSQL_FILE = 57634
const MYSQL_TEMPORARY = 57635
const MYSQL_ROUTINE = 57636
const MYSQL_EVENT = 57637
const MYSQL_SHUTDOWN = 57638
const MYSQL_NULLX = 57639
const MYSQL_AUTO_INCREMENT = 57640
const MYSQL_APPROXNUM = 57641
const MYSQL_SIGNED = 57642
const MYSQL_UNSIGNED = 57643
const MYSQL_ZEROFILL = 57644
const MYSQL_USER = 57645
const MYSQL_IDENTIFIED = 57646
const MYSQL_CIPHER = 57647
const MYSQL_ISSUER = 57648
const MYSQL_X509 = 57649
const MYSQL_SUBJECT = 57650
const MYSQL_SAN = 57651
const MYSQL_REQUIRE = 57652
const MYSQL_SSL = 57653
const MYSQL_NONE = 57654
const MYSQL_PASSWORD = 57655
const MYSQL_MAX_QUERIES_PER_HOUR = 57656
const MYSQL_MAX_UPDATES_PER_HOUR = 57657
const MYSQL_MAX_CONNECTIONS_PER_HOUR = 57658
const MYSQL_MAX_USER_CONNECTIONS = 57659
const MYSQL_FORMAT = 57660
const MYSQL_VERBOSE = 57661
const MYSQL_CONNECTION = 57662
const MYSQL_LOAD = 57663
const MYSQL_INFILE = 57664
const MYSQL_TERMINATED = 57665
const MYSQL_OPTIONALLY = 57666
const MYSQL_ENCLOSED = 57667
const MYSQL_ESCAPED = 57668
const MYSQL_STARTING = 57669
const MYSQL_LINES = 57670
const MYSQL_DATABASES = 57671
const MYSQL_TABLES = 57672
const MYSQL_EXTENDED = 57673
const MYSQL_FULL = 57674
const MYSQL_PROCESSLIST = 57675
const MYSQL_FIELDS = 57676
const MYSQL_COLUMNS = 57677
const MYSQL_OPEN = 57678
const MYSQL_ERRORS = 57679
const MYSQL_WARNINGS = 57680
const MYSQL_INDEXES = 57681
const MYSQL_SCHEMAS = 57682
const MYSQL_NAMES = 57683
const MYSQL_GLOBAL = 57684
const MYSQL_SESSION = 57685
const MYSQL_ISOLATION = 57686
const MYSQL_LEVEL = 57687
const MYSQL_READ = 57688
const MYSQL_WRITE = 57689
const MYSQL_ONLY = 57690
const MYSQL_REPEATABLE = 57691
const MYSQL_COMMITTED = 57692
const MYSQL_UNCOMMITTED = 57693
const MYSQL_SERIALIZABLE = 57694
const MYSQL_LOCAL = 57695
const MYSQL_EXCEPT = 57696
const MYSQL_CURRENT_TIMESTAMP = 57697
const MYSQL_DATABASE = 57698
const MYSQL_CURRENT_TIME = 57699
const MYSQL_LOCALTIME = 57700
const MYSQL_LOCALTIMESTAMP = 57701
const MYSQL_UTC_DATE = 57702
const MYSQL_UTC_TIME = 57703
const MYSQL_UTC_TIMESTAMP = 57704
const MYSQL_REPLACE = 57705
const MYSQL_CONVERT = 57706
const MYSQL_SEPARATOR = 57707
const MYSQL_CURRENT_DATE = 57708
const MYSQL_CURRENT_USER = 57709
const MYSQL_CURRENT_ROLE = 57710
const MYSQL_SECOND_MICROSECOND = 57711
const MYSQL_MINUTE_MICROSECOND = 57712
const MYSQL_MINUTE_SECOND = 57713
const MYSQL_HOUR_MICROSECOND = 57714
const MYSQL_HOUR_SECOND = 57715
const MYSQL_HOUR_MINUTE = 57716
const MYSQL_DAY_MICROSECOND = 57717
const MYSQL_DAY_SECOND = 57718
const MYSQL_DAY_MINUTE = 57719
const MYSQL_DAY_HOUR = 57720
const MYSQL_YEAR_MONTH = 57721
const MYSQL_SQL_TSI_HOUR = 57722
const MYSQL_SQL_TSI_DAY = 57723
const MYSQL_SQL_TSI_WEEK = 57724
const MYSQL_SQL_TSI_MONTH = 57725
const MYSQL_SQL_TSI_QUARTER = 57726
const MYSQL_SQL_TSI_YEAR = 57727
const MYSQL_SQL_TSI_SECOND = 57728
const MYSQL_SQL_TSI_MINUTE = 57729
const MYSQL_RECURSIVE = 57730
const MYSQL_CONFIG = 57731
const MYSQL_MATCH = 57732
const MYSQL_AGAINST = 57733
const MYSQL_BOOLEAN = 57734
const MYSQL_LANGUAGE = 57735
const MYSQL_WITH = 57736
const MYSQL_QUERY = 57737
const MYSQL_EXPANSION = 57738
const MYSQL_ADDDATE = 57739
const MYSQL_BIT_AND = 57740
const MYSQL_BIT_OR = 57741
const MYSQL_BIT_XOR = 57742
const MYSQL_CAST = 57743
const MYSQL_COUNT = 57744
const MYSQL_APPROX_COUNT_DISTINCT = 57745
const MYSQL_APPROX_PERCENTILE = 57746
const MYSQL_CURDATE = 57747
const MYSQL_CURTIME = 57748
const MYSQL_DATE_ADD = 57749
const MYSQL_DATE_SUB = 57750
const MYSQL_EXTRACT = 57751
const MYSQL_GROUP_CONCAT = 57752
const MYSQL_MAX = 57753
const MYSQL_MID = 57754
const MYSQL_MIN = 57755
const MYSQL_NOW = 57756
const MYSQL_POSITION = 57757
const MYSQL_SESSION_USER = 57758
const MYSQL_STD = 57759
const MYSQL_STDDEV = 57760
const MYSQL_STDDEV_POP = 57761
const MYSQL_STDDEV_SAMP = 57762
const MYSQL_SUBDATE = 57763
const MYSQL_SUBSTR = 57764
const MYSQL_SUBSTRING = 57765
const MYSQL_SUM = 57766
const MYSQL_SYSDATE = 57767
const MYSQL_SYSTEM_USER = 57768
const MYSQL_TRANSLATE = 57769
const MYSQL_TRIM = 57770
const MYSQL_VARIANCE = 57771
const MYSQL_VAR_POP = 57772
const MYSQL_VAR_SAMP = 57773
const MYSQL_AVG = 57774
const MYSQL_ROW = 57775
const MYSQL_OUTFILE = 57776
const MYSQL_HEADER = 57777
const MYSQL_MAX_FILE_SIZE = 57778
const MYSQL_FORCE_QUOTE = 57779
const MYSQL_UNUSED = 57780
