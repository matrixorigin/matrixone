...
func init() {
	reuse.CreatePool[CreateOptionCharset](
		...
		reuse.DefaultOptions[CreateOptionCharset]().WithEnableChecker(),
	)

	reuse.CreatePool[ClusterByOption](
		func() *ClusterByOption { return &ClusterByOption{} },
		func(c *ClusterByOption) { c.reset() },
		reuse.DefaultOptions[ClusterByOption]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[CreateOptionCollate](
		...
		reuse.DefaultOptions[CreateOptionCollate]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[AttributeColumnFormat](
		...
		reuse.DefaultOptions[AttributeColumnFormat]().WithEnableChecker(),
	)

	reuse.CreatePool[AttributeStorage](
		func() *AttributeStorage { return &AttributeStorage{} },
		func(a *AttributeStorage) { a.reset() },
		reuse.DefaultOptions[AttributeStorage]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[AttributeCheckConstraint](
		...
		reuse.DefaultOptions[AttributeCheckConstraint]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[AttributeGeneratedAlways](
		...
		reuse.DefaultOptions[AttributeGeneratedAlways]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionEngineAttr](
		...
		reuse.DefaultOptions[TableOptionEngineAttr]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionInsertMethod](
		...
		reuse.DefaultOptions[TableOptionInsertMethod]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionAUTOEXTEND_SIZE](
		...
		reuse.DefaultOptions[TableOptionAUTOEXTEND_SIZE]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionAutoIncrement](
		...
		reuse.DefaultOptions[TableOptionAutoIncrement]().WithEnableChecker(),
	)

	reuse.CreatePool[TableOptionComment](
		func() *TableOptionComment { return &TableOptionComment{} },
		func(t *TableOptionComment) { t.reset() },
		reuse.DefaultOptions[TableOptionComment]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionAvgRowLength](
		...
		reuse.DefaultOptions[TableOptionAvgRowLength]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionChecksum](
		...
		reuse.DefaultOptions[TableOptionChecksum]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionCompression](
		...
		reuse.DefaultOptions[TableOptionCompression]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionConnection](
		...
		reuse.DefaultOptions[TableOptionConnection]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionPassword](
		...
		reuse.DefaultOptions[TableOptionPassword]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionDelayKeyWrite](
		...
		reuse.DefaultOptions[TableOptionDelayKeyWrite]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionRowFormat](
		...
		reuse.DefaultOptions[TableOptionRowFormat]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionStartTrans](
		...
		reuse.DefaultOptions[TableOptionStartTrans]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionSecondaryEngineAttr](
		...
		reuse.DefaultOptions[TableOptionSecondaryEngineAttr]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionStatsPersistent](
		...
		reuse.DefaultOptions[TableOptionStatsPersistent]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionStatsAutoRecalc](
		...
		reuse.DefaultOptions[TableOptionStatsAutoRecalc]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionPackKeys](
		...
		reuse.DefaultOptions[TableOptionPackKeys]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionTablespace](
		...
		reuse.DefaultOptions[TableOptionTablespace]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionDataDirectory](
		...
		reuse.DefaultOptions[TableOptionDataDirectory]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionIndexDirectory](
		...
		reuse.DefaultOptions[TableOptionIndexDirectory]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionStorageMedia](
		...
		reuse.DefaultOptions[TableOptionStorageMedia]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[TableOptionStatsSamplePages](
		...
		reuse.DefaultOptions[TableOptionStatsSamplePages]().WithEnableChecker(),
	)

	reuse.CreatePool[TableOptionUnion](
		func() *TableOptionUnion { return &TableOptionUnion{} },
		func(t *TableOptionUnion) { t.reset() },
		reuse.DefaultOptions[TableOptionUnion]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[ResourceOptionMaxQueriesPerHour](
		...
		reuse.DefaultOptions[ResourceOptionMaxQueriesPerHour]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[ResourceOptionMaxUpdatesPerHour](
		...
		reuse.DefaultOptions[ResourceOptionMaxUpdatesPerHour]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[ResourceOptionMaxConnectionPerHour](
		...
		reuse.DefaultOptions[ResourceOptionMaxConnectionPerHour]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[ResourceOptionMaxUserConnections](
		...
		reuse.DefaultOptions[ResourceOptionMaxUserConnections]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordExpireNone](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordExpireNone]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordExpireDefault](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordExpireDefault]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordExpireNever](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordExpireNever]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordExpireInterval](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordExpireInterval]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordHistoryDefault](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordHistoryDefault]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordHistoryCount](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordHistoryCount]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordReuseIntervalDefault](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordReuseIntervalDefault]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordReuseIntervalCount](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordReuseIntervalCount]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordRequireCurrentNone](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordRequireCurrentNone]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordRequireCurrentDefault](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordRequireCurrentDefault]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordRequireCurrentOptional](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordRequireCurrentOptional]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionFailedLoginAttempts](
		...
		reuse.DefaultOptions[UserMiscOptionFailedLoginAttempts]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordLockTimeCount](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordLockTimeCount]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionPasswordLockTimeUnbounded](
		...
		reuse.DefaultOptions[UserMiscOptionPasswordLockTimeUnbounded]().WithEnableChecker(),
	)
	...
	reuse.CreatePool[UserMiscOptionAccountLock](
		...
		reuse.DefaultOptions[UserMiscOptionAccountLock]().WithEnableChecker(),
	)
...
type Partition struct {
	...
	// NewFromNonParserPlace is a boolean flag indicating whether the creation of a new object is from a non-parser place.
	// The existence of this flag indicates that somewhere other than the parser, something holds the memory generated by the parser and managed by the reuse package.
	// Parser will release this node (if not, it is a bug). If the memory is also released outside, this recursive call will cause double free problem.
	// so, a flag is needed.
	NewFromNonParserPlace bool
}
...
func (node *Partition) reset() {
	if node.NewFromNonParserPlace == false {
		...
		node.NewFromNonParserPlace = false
	}
	*node = Partition{}
}
...
func CopyPartition(p *Partition) *Partition {
	...
	newp := reuse.Alloc[Partition](nil)
	newp.Name = p.Name
	newp.Values = p.Values
	newp.Options = p.Options
	newp.Subs = p.Subs
	newp.NewFromNonParserPlace = true
	return newp
}
