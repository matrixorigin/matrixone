...
// Match
%token <str> MATCH AGAINST BOOLEAN LANGUAGE WITH QUERY EXPANSION WITHOUT VALIDATION RETRIEVAL
...
| REINDEX ident FULLTEXT index_option_list
    {
        var io *tree.IndexOption = nil
        if $4 == nil {
            io = tree.NewIndexOption()
