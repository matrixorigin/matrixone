...
%type <str> optype
%type <identifierList> column_list column_list_opt partition_clause_opt partition_id_list insert_column_list accounts_list diff_columns_opt
...
drop_cdc_stmt:
    DROP CDC exists_opt drop_cdc_opt
    {
        $$ = tree.NewDropCDC($4, $3)
    }
