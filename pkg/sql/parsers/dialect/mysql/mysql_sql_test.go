...
var (
	validSQL = []struct {
		...
		{
			input:  `dump database t tables t1 into 'a.sql'`,
			output: `dump database t tables t1 into a.sql`,
		},
		{
			input:  `dump database t tables t1 into 'a.sql' max_file_size 1`,
			output: `dump database t tables t1 into a.sql max_file_size 1`,
		},
		{
			input:  `dump database t tables t1,t2 into 'a.sql'`,
			output: `dump database t tables t1, t2 into a.sql`,
		},
		{
			input:  `dump database t tables t1,t2 into 'a.sql' max_file_size 1`,
			output: `dump database t tables t1, t2 into a.sql max_file_size 1`,
		},
	}
)
