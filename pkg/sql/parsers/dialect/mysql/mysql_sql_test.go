...
var (
	validSQL = []struct {
		...
		input:  "alter account configuration test set mysql_compatbility_mode = '{transaction_isolation: REPEATABLE-READ, lower_case_table_names: 0}'",
		output: "alter account configuration for test as {transaction_isolation: REPEATABLE-READ, lower_case_table_names: 0} ",
	}, {
		input: "show profiles",
	}, {
