...
var (
	validSQL = []struct {
		...
		output: "select cluster_centers(a, 1,L2,RANDOM) from t1",
	}, {
		...
		input:  "select cluster_centers(a kmeans '5,L2,KMEANS++') from t1;",
		output: "select cluster_centers(a, 5,L2,KMEANS++) from t1",
	}, {
