...
var (
	validSQL = []struct {
		...
		{
			input:  `create function helloworld () returns tmp language sql as 'select id from test_table limit 1'`,
			output: `create function helloworld () returns tmp language sql as 'select id from test_table limit 1'`,
		},
		{
		...
		{
			input:  `drop function charat (varchar, int)`,
			output: `drop function charat (varchar, int)`,
		},
		{
			input:  `drop function charat (varchar, int)`,
			output: `drop function charat (varchar, int)`,
