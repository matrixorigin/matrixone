...
var (
	validSQL = []struct {
		...
		input:  "create external table t (a int) URL s3option{'endpoint'='s3.us-west-2.amazonaws.com', 'access_key_id'='XXX', 'secret_access_key'='XXX', 'bucket'='wangjian-test', 'filepath'='*.txt', 'region'='us-west-2'}",
		output: "create external table t (a int) url s3option {'endpoint'='endpoint', 'access_key_id'='XXX', 'secret_access_key'='XXX', 'bucket'='wangjian-test', 'filepath'='*.txt', 'region'='us-west-2'}",
	}, {
		...
		input:  "LOAD DATA URL s3option{'endpoint'='s3.us-west-2.amazonaws.com', 'access_key_id'='XXX', 'secret_access_key'='XXX', 'bucket'='wangjian-test', 'filepath'='*.txt', 'region'='us-west-2'} into table db.a",
		output: "load data url s3option {'endpoint'='endpoint', 'access_key_id'='XXX', 'secret_access_key'='XXX', 'bucket'='wangjian-test', 'filepath'='*.txt', 'region'='us-west-2'} into table db.a",
	}, {
