...
// disabled; try_null numeric mappings are eligible because malformed values
// become SQL NULL and cannot satisfy comparisons. String/collation predicates
// and IS NULL remain residual-only until their full candidate-set semantics
// are proven.
