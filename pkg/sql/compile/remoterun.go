...
func validateRemoteExpressionPipelineProtocol(
	...
	if features.IntegerArithmeticDomains && (!hasProtocolVersion || protocolVersion < defines.MORPCVersion67) {
		return moerr.NewNotSupportedNoCtx("checked integer arithmetic requires MORPC protocol version 67")
	}
