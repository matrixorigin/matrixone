...
func validateRemoteExpressionPipelineProtocol(
	...
	if features.RowDependentConvBases && (!hasProtocolVersion || protocolVersion < defines.MORPCVersion65) {
		return moerr.NewNotSupportedNoCtx("row-dependent CONV bases require MORPC protocol version 65")
	}
	return nil
}
