...
func validateRemoteExpressionPipelineProtocol(
	...
	if features.RowDependentConvBases && (!hasProtocolVersion || protocolVersion < defines.MORPCVersion69) {
		return moerr.NewNotSupportedNoCtx("row-dependent CONV bases require MORPC protocol version 69")
	}
