...
func (c *Compile) compileExternScan(n *plan.Node) ([]*Scope, error) {
	...
	if param.HivePartitioning {
		return c.compileExternScanHiveFileFanout(n, param, fileList, fileSize, strictSqlMode)
	}
...
func (c *Compile) compileExternScanHiveFileFanout(n *plan.Node, param *tree.ExternParam, fileList []string, fileSize []int64, strictSqlMode bool) ([]*Scope, error) {
	...
	if len(shards) <= 1 {
		...
		return c.compileExternScanSerialReadWrite(n, &serialParam, fileList, fileSize, strictSqlMode)
	}
