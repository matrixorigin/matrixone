...
// Source: ../../../pkg/sql/planner/types.go
...
import (
	...
	function "github.com/matrixorigin/matrixone/pkg/sql/function"
...
func (m *MockCompilerContext2) BuildTableDefByMoColumns(dbName, table string) (*plan.TableDef, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) DatabaseExists(name string, snapshot *plan.Snapshot) bool {
	m.ctrl.T.Helper()
...
// GetAccountName mocks base method.
...
func (m *MockCompilerContext2) GetDatabaseId(dbName string, snapshot *plan.Snapshot) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) GetSnapshot() *plan.Snapshot {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSnapshot")
	ret0, _ := ret[0].(*plan.Snapshot)
	return ret0
}
...
func (m *MockCompilerContext2) GetSubscriptionMeta(dbName string, snapshot *plan.Snapshot) (*plan.SubscriptionMeta, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) Resolve(schemaName, tableName string, snapshot *plan.Snapshot) (*plan.ObjectRef, *plan.TableDef, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) ResolveById(tableId uint64, snapshot *plan.Snapshot) (*plan.ObjectRef, *plan.TableDef, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) ResolveIndexTableByRef(ref *plan.ObjectRef, tblName string, snapshot *plan.Snapshot) (*plan.ObjectRef, *plan.TableDef, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) ResolveSnapshotWithSnapshotName(snapshotName string) (*plan.Snapshot, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) ResolveSubscriptionTableById(tableId uint64, pubmeta *plan.SubscriptionMeta) (*plan.ObjectRef, *plan.TableDef, error) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) SetSnapshot(snapshot *plan.Snapshot) {
	m.ctrl.T.Helper()
...
func (m *MockCompilerContext2) Stats(obj *plan.ObjectRef, snapshot *plan.Snapshot) (*statsinfo.StatsInfo, error) {
	m.ctrl.T.Helper()
