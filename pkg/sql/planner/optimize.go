...
func (opt *BaseOptimizer) Optimize(stmt tree.Statement, isPrepareStmt bool) (*plan.Query, error) {
...
func (opt *BaseOptimizer) optimize() (*plan.Query, error) {
...
func (opt *BaseOptimizer) exploreNode(n *plan.Node) {
