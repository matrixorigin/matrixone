...
func (rule *GetParamRule) MatchNode(node *plan.Node) bool {
...
func (rule *GetParamRule) ApplyNode(node *plan.Node) error {
	return nil
}
...
func (rule *ResetParamOrderRule) MatchNode(_ *plan.Node) bool {
	return false
}
...
func (rule *ResetParamOrderRule) ApplyNode(node *plan.Node) error {
	return nil
}
...
func NewResetParamRefRule(ctx context.Context, params []*plan.Expr) *ResetParamRefRule {
...
func (rule *ResetParamRefRule) MatchNode(_ *plan.Node) bool {
	return false
}
...
func (rule *ResetParamRefRule) ApplyNode(node *plan.Node) error {
	return nil
}
