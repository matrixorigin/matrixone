...
func bindAndOptimizeSelectQuery(stmtType plan.Query_StatementType, ctx CompilerContext, stmt *tree.Select, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
...
func bindAndOptimizeInsertQuery(ctx CompilerContext, stmt *tree.Insert, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
...
func bindAndOptimizeReplaceQuery(ctx CompilerContext, stmt *tree.Replace, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
		v2.TxnStatementBuildInsertHistogram.Observe(time.Since(start).Seconds())
	}()
...
func bindAndOptimizeLoadQuery(ctx CompilerContext, stmt *tree.Load, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
...
func bindAndOptimizeDeleteQuery(ctx CompilerContext, stmt *tree.Delete, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
...
func bindAndOptimizeUpdateQuery(ctx CompilerContext, stmt *tree.Update, isPrepareStmt bool, skipStats bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
		v2.TxnStatementBuildDeleteHistogram.Observe(time.Since(start).Seconds())
	}()
...
func buildExplainPlan(ctx CompilerContext, stmt tree.Statement, isPrepareStmt bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
...
func buildExplainAnalyze(ctx CompilerContext, stmt *tree.ExplainAnalyze, isPrepareStmt bool) (*plan.Plan, error) {
	return buildExplainPlan(ctx, stmt.Statement, isPrepareStmt)
}

func buildExplainPhyPlan(ctx CompilerContext, stmt *tree.ExplainPhyPlan, isPrepareStmt bool) (*plan.Plan, error) {
	return buildExplainPlan(ctx, stmt.Statement, isPrepareStmt)
}

func BuildPlan(ctx CompilerContext, stmt tree.Statement, isPrepareStmt bool) (*plan.Plan, error) {
	start := time.Now()
	defer func() {
