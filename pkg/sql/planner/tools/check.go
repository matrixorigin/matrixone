...
func (checker *ExprChecker) Check(astExpr tree.Expr, expr *plan.Expr) (bool, error) {
...
func (checker *ExprChecker) checkFuncExpr(astExpr *tree.FuncExpr, expr *plan.Expr) (bool, error) {
	fun := expr.GetF()
...
func (checker *ExprChecker) checkBinaryExpr(astExpr *tree.BinaryExpr, expr *plan.Expr) (bool, error) {
	switch astExpr.Op {
	case tree.PLUS:
		fun := expr.GetF()
...
func (checker *ExprChecker) checkComparisonExpr(astExpr *tree.ComparisonExpr, expr *plan.Expr) (bool, error) {
	switch astExpr.Op {
	case tree.EQUAL:
		fun := expr.GetF()
