...
- Files: `pkg/sql/compile/compile.go`, `pkg/sql/planner/stats.go`.
...
- Files: `pkg/sql/compile/scope.go`, `pkg/sql/compile/compile.go`,
  `pkg/sql/planner/shuffle.go`, `pkg/vm/engine/readutil/exec_util.go`,
...
- `pkg/sql/planner/stats.go`: `GetExecType`, `CalcQueryDOP`, multi-CN thresholds and flags.
...
- `pkg/sql/planner/shuffle.go`: `ShouldSkipObjByShuffle`, `CalcRangeShuffleIDXForObj`.
