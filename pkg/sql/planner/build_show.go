...
func buildShowCreateDatabase(stmt *tree.ShowCreateDatabase,
	ctx CompilerContext) (*plan.Plan, error) {
...
// buildShowCreateView
func buildShowCreateView(stmt *tree.ShowCreateView, ctx CompilerContext) (*plan.Plan, error) {
	var err error
	tblName := stmt.Name.GetTableName()
	dbName := stmt.Name.GetDBName()
...
func buildShowSequences(stmt *tree.ShowSequences, ctx CompilerContext) (*plan.Plan, error) {
	// snapshot to fix
...
func buildShowTableNumber(stmt *tree.ShowTableNumber, ctx CompilerContext) (*plan.Plan, error) {
	accountId, err := ctx.GetAccountId()
	if err != nil {
		return nil, err
	}
...
func buildShowColumnNumber(stmt *tree.ShowColumnNumber, ctx CompilerContext) (*plan.Plan, error) {
	accountId, err := ctx.GetAccountId()
	if err != nil {
		return nil, err
	}
...
func buildShowTableValues(stmt *tree.ShowTableValues, ctx CompilerContext) (*plan.Plan, error) {
	dbName, err := databaseIsValid(getSuitableDBName(stmt.Table.GetDBName(), stmt.DbName), ctx, nil)
	if err != nil {
		return nil, err
	}
...
func buildShowTableStatus(stmt *tree.ShowTableStatus, ctx CompilerContext) (*plan.Plan, error) {
	if stmt.Like != nil && stmt.Where != nil {
		return nil, moerr.NewSyntaxError(ctx.GetContext(), "like clause and where clause cannot exist at the same time")
	}
...
func buildShowTarget(stmt *tree.ShowTarget, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
	sql := ""
	switch stmt.Type {
...
func buildShowLocks(stmt *tree.ShowLocks, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
	sql := "select 1 where 0"
	return returnByRewriteSQL(ctx, sql, ddlType)
}

func buildShowNodeList(stmt *tree.ShowNodeList, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
	sql := "select 1 where 0"
	return returnByRewriteSQL(ctx, sql, ddlType)
}

func buildShowFunctionOrProcedureStatus(stmt *tree.ShowFunctionOrProcedureStatus, ctx CompilerContext) (*plan.Plan, error) {
	var sql string
...
func buildShowTriggers(stmt *tree.ShowTarget, ctx CompilerContext) (*plan.Plan, error) {
	if stmt.Like != nil && stmt.Where != nil {
		return nil, moerr.NewSyntaxError(ctx.GetContext(), "like clause and where clause cannot exist at the same time")
	}
...
func buildShowGrants(stmt *tree.ShowGrants, ctx CompilerContext) (*plan.Plan, error) {
...
func buildShowRoles(stmt *tree.ShowRolesStmt, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
...
func buildShowStages(stmt *tree.ShowStages, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
...
func buildShowSnapShots(stmt *tree.ShowSnapShots, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
...
func buildShowPitr(stmt *tree.ShowPitr, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
...
func buildShowAccountUpgrade(stmt *tree.ShowAccountUpgrade, ctx CompilerContext) (*plan.Plan, error) {
...
func buildShowProcessList(ctx CompilerContext) (*plan.Plan, error) {
...
func buildShowCreatePublications(stmt *tree.ShowCreatePublications, ctx CompilerContext) (*plan.Plan, error) {
	ddlType := plan.DataDefinition_SHOW_TARGET
	accountId, err := ctx.GetAccountId()
	if err != nil {
		return nil, err
...
func returnByRewriteSQL(ctx CompilerContext, sql string,
	ddlType plan.DataDefinition_DdlType) (*plan.Plan, error) {
...
func returnByWhereAndBaseSQL(ctx CompilerContext, baseSQL string,
	where *tree.Where, ddlType plan.DataDefinition_DdlType) (*plan.Plan, error) {
