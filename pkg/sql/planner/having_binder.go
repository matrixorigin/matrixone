...
func (b *HavingBinder) remapAggToTimeWindowCacheAgg(expr *plan.Expr) (*plan.Expr, error) {
...
func (b *HavingBinder) remapAggToTimeWindowResultAgg(expr *plan.Expr) (*plan.Expr, error) {
...
func (b *HavingBinder) BindTimeWindowFunc(funcName string, astExpr *tree.FuncExpr, depth int32, isRoot bool) (*plan.Expr, error) {
	...
	expr := plan.DeepCopyExpr(b.ctx.aggregates[aggColPos])
