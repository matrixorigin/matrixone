...
func init() {
	...
	gob.Register(types.Decimal64(0))
...
func EncodeRing(r ring.Ring, buf *bytes.Buffer) error {
	...
	case *avg.AvgRing:
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *avg.DecimalRing:
		buf.WriteByte(AvgDecimalRing)
		// Ns
		n := len(v.Ns)
		buf.Write(encoding.EncodeUint32(uint32(n)))
		if n > 0 {
		...
		// Vs
		da := encoding.EncodeDecimal128Slice(v.Vs)
		n = len(da)
		buf.Write(encoding.EncodeUint32(uint32(n)))
		if n > 0 {
			buf.Write(da)
	...
	case *max.DatetimeRing:
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *max.TimestampRing:
		buf.WriteByte(MaxTimestampRing)
		// Ns
		n := len(v.Ns)
		buf.Write(encoding.EncodeUint32(uint32(n)))
		if n > 0 {
		...
		// Vs
		da := encoding.EncodeTimestampSlice(v.Vs)
		n = len(da)
		buf.Write(encoding.EncodeUint32(uint32(n)))
		if n > 0 {
			buf.Write(da)
	...
	case *max.Decimal64Ring:
		...
		*/
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *max.Decimal128Ring:
		buf.WriteByte(MaxDecimal128Ring)
		// IsE
		/*
			var isE uint8
			if v.IsE {
	...
	case *min.DatetimeRing:
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *min.TimestampRing:
		buf.WriteByte(MinTimestampRing)
		// Ns
		n := len(v.Ns)
		buf.Write(encoding.EncodeUint32(uint32(n)))
		if n > 0 {
	...
	case *min.Float64Ring:
		...
		*/
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *min.Decimal64Ring:
		buf.WriteByte(MinDecimal64Ring)
		// IsE
		/*
			var isE uint8
			if v.IsE {
		...
		*/
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *min.Decimal128Ring:
		buf.WriteByte(MinDecimal128Ring)
		// IsE
		/*
			var isE uint8
			if v.IsE {
	...
	case *sum.FloatRing:
		...
		*/
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *sum.Decimal64Ring:
		buf.WriteByte(SumDecimal64Ring)
		// IsE
		/*
			var isE uint8
			if v.IsE {
		...
		*/
		...
		buf.Write(encoding.EncodeType(v.Typ))
		return nil
	case *sum.Decimal128Ring:
		buf.WriteByte(SumDecimal128Ring)
		// IsE
		/*
			var isE uint8
			if v.IsE {
...
func DecodeRing(data []byte) (ring.Ring, []byte, error) {
	...
	case AvgDecimalRing:
		...
		// Vs
		r.Vs = encoding.DecodeDecimal128Slice(r.Da)
		// Typ
		typ := encoding.DecodeType(data[:encoding.TypeSize])
		data = data[encoding.TypeSize:]
		r.Typ = typ
	...
	case MaxDecimal64Ring:
		...
		*/
		...
		r.Typ = typ
		return r, data, nil
	case MaxDecimal128Ring:
		r := new(max.Decimal128Ring)
		data = data[1:]
		// IsE
		/*
			isE := encoding.DecodeUint8(data[:1])
	...
	case MinFloat64Ring:
		...
		*/
		...
		r.Typ = typ
		return r, data, nil
	case MinDecimal64Ring:
		r := new(min.Decimal64Ring)
		data = data[1:]
		// IsE
		/*
			isE := encoding.DecodeUint8(data[:1])
		...
		*/
		...
		r.Typ = typ
		return r, data, nil
	case MinDecimal128Ring:
		r := new(min.Decimal128Ring)
		data = data[1:]
		// IsE
		/*
			isE := encoding.DecodeUint8(data[:1])
	...
	case SumFloatRing:
		...
		*/
		...
		r.Typ = typ
		return r, data, nil
	case SumDecimal64Ring:
		r := new(sum.Decimal64Ring)
		data = data[1:]
		// IsE
		/*
			isE := encoding.DecodeUint8(data[:1])
		...
		*/
		...
		r.Typ = typ
		return r, data, nil
	case SumDecimal128Ring:
		r := new(sum.Decimal128Ring)
		data = data[1:]
		// IsE
		/*
			isE := encoding.DecodeUint8(data[:1])
