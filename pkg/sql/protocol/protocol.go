...
func DecodeRing(data []byte) (ring.Ring, []byte, error) {
	...
	case VarianceRing:
		...
		// return
		return r, data, nil
	case Bit_orFloatRing:
		r := new(bit_or.FloatRing)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
	...
	case Bit_orInt8Ring:
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orInt16Ring:
		r := new(bit_or.Int16Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orInt32Ring:
		r := new(bit_or.Int32Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orInt64Ring:
		r := new(bit_or.Int64Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orUInt8Ring:
		r := new(bit_or.UInt8Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orUInt16Ring:
		r := new(bit_or.UInt16Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orUInt32Ring:
		r := new(bit_or.UInt32Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
		...
		r.Typ = typ
		return r, data, nil
	case Bit_orUInt64Ring:
		r := new(bit_or.UInt64Ring)
		data = data[1:]
		// NullCounts
		n := encoding.DecodeUint32(data[:4])
		data = data[4:]
