...
func Test_makeAutoIncrBatch(t *testing.T) {
	...
	convey.Convey("Test makeAutoIncrBatch succ", t, func() {
		...
		convey.So(bat.Attrs, convey.ShouldResemble, AUTO_INCR_TABLE_COLNAME[1:])
		convey.So(len(bat.Vecs), convey.ShouldEqual, 3)
		convey.So(vector.MustTCols[uint64](bat.Vecs[1]), convey.ShouldResemble, []uint64{uint64(num)})
		convey.So(vector.MustTCols[uint64](bat.Vecs[2]), convey.ShouldResemble, []uint64{uint64(step)})
	})
}
...
func Test_getAutoIncrTableDef(t *testing.T) {
	convey.Convey("Test getAutoIncrTableDef succ", t, func() {
		...
		convey.So(nameAttr.Attr.Name, convey.ShouldEqual, AUTO_INCR_TABLE_COLNAME[1])
		...
		convey.So(ok, convey.ShouldBeTrue)
		convey.So(numAttr.Attr.Name, convey.ShouldEqual, AUTO_INCR_TABLE_COLNAME[2])
		...
		convey.So(ok, convey.ShouldBeTrue)
		convey.So(stepAttr.Attr.Name, convey.ShouldEqual, AUTO_INCR_TABLE_COLNAME[3])
