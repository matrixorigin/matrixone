...
func New[T1, T2 any]() *BitAnd[T1, T2] {
	return &BitAnd[T1, T2]{}
}

func (c *BitAnd[T1, T2]) Grows(_ int) {
}

func (c *BitAnd[T1, T2]) Eval(vs []T2) []T2 {
	return vs
}

func (c *BitAnd[T1, T2]) Merge(x, y T2, IsEmpty1 bool, IsEmpty2 bool) (T2, bool) {
...
func (c *BitAnd[T1, T2]) Fill(v1 T1, v2 T2, z int64, IsEmpty bool, hasNull bool) (T2, bool) {
	if hasNull {
		return v2, IsEmpty
	} else if IsEmpty {
