...
func TestEvalAndShuffleConst(t *testing.T) {
	...
	cases := []constCase{
		...
		{"range_int64_minmax", plan.ShuffleType_Range, mkInt64(50), types.T_int64.ToType(), 8, 1, 1000000, []int64{}, nil},
		...
		{"range_uint64_minmax", plan.ShuffleType_Range, mkU64(50), types.T_uint64.ToType(), 8, 1, 1000000, nil, []uint64{}},
