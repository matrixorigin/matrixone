...
func (r *ReceiverOperator) selectFrom50Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom51Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom52Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom53Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom54Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom55Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom56Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom57Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom58Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom59Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom60Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom61Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom62Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
...
func (r *ReceiverOperator) selectFrom63Reg() (int, *batch.Batch, bool) {
	idx := 0
	ok := true
	var bat *batch.Batch
	select {
