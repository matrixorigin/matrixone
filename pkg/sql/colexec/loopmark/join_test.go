...
func init() {
	tcs = []joinTestCase{
		newTestCase([]bool{false}, []types.Type{types.T_int32.ToType()}, []int32{0, -1}),
		newTestCase([]bool{true}, []types.Type{types.T_int32.ToType()}, []int32{0, -1}),
	}
}
...
func resetChildren(arg *LoopMark) {
	bat := colexec.MakeMockBatchs()
