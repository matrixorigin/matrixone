...
import (
	"fmt"
	"matrixbase/pkg/sql/colexec/hashbag/natural"
...
func TestBagNaturalJoin(t *testing.T) {
	...
	{
		ins = append(ins, vm.Instruction{vm.BagNaturalJoin, &natural.Argument{R: "R", S: "S", Attrs: []string{"uid"}}})
