...
import (
	"fmt"
	"matrixbase/pkg/sql/colexec/bag/differenceR"
...
func TestBagDifferenceR(t *testing.T) {
	...
	{
		ins = append(ins, vm.Instruction{vm.BagDifferenceR, &differenceR.Argument{R: "S", S: "R"}})
