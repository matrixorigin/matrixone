...
func init() {
	...
	replaceMethods[types.T_bit] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[uint64](toVec, row1, vector.GetFixedAtNoTypeCheck[uint64](fromVec, row2))
	}
	replaceMethods[types.T_int8] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[int8](toVec, row1, vector.GetFixedAtNoTypeCheck[int8](fromVec, row2))
	}
	replaceMethods[types.T_int16] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[int16](toVec, row1, vector.GetFixedAtNoTypeCheck[int16](fromVec, row2))
	}
	replaceMethods[types.T_int32] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[int32](toVec, row1, vector.GetFixedAtNoTypeCheck[int32](fromVec, row2))
	}
	replaceMethods[types.T_int64] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[int64](toVec, row1, vector.GetFixedAtNoTypeCheck[int64](fromVec, row2))
	}
	replaceMethods[types.T_uint8] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[uint8](toVec, row1, vector.GetFixedAtNoTypeCheck[uint8](fromVec, row2))
	}
	replaceMethods[types.T_uint16] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[uint16](toVec, row1, vector.GetFixedAtNoTypeCheck[uint16](fromVec, row2))
	}
	replaceMethods[types.T_uint32] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[uint32](toVec, row1, vector.GetFixedAtNoTypeCheck[uint32](fromVec, row2))
	}
	...
	replaceMethods[types.T_float32] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[float32](toVec, row1, vector.GetFixedAtNoTypeCheck[float32](fromVec, row2))
	}
	replaceMethods[types.T_float64] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[float64](toVec, row1, vector.GetFixedAtNoTypeCheck[float64](fromVec, row2))
	}
	replaceMethods[types.T_date] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Date](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Date](fromVec, row2))
	}
	replaceMethods[types.T_datetime] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Datetime](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Datetime](fromVec, row2))
	}
	replaceMethods[types.T_timestamp] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Timestamp](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Timestamp](fromVec, row2))
	}
	replaceMethods[types.T_time] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Time](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Time](fromVec, row2))
	}
	replaceMethods[types.T_enum] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Enum](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Enum](fromVec, row2))
	}
	replaceMethods[types.T_decimal64] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Decimal64](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Decimal64](fromVec, row2))
	}
	replaceMethods[types.T_decimal128] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Decimal128](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Decimal128](fromVec, row2))
	}
	replaceMethods[types.T_TS] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.TS](toVec, row1, vector.GetFixedAtNoTypeCheck[types.TS](fromVec, row2))
	}
	replaceMethods[types.T_Rowid] = func(toVec, fromVec *vector.Vector, row1, row2 int, mp *mpool.MPool) error {
		return vector.SetFixedAt[types.Rowid](toVec, row1, vector.GetFixedAtNoTypeCheck[types.Rowid](fromVec, row2))
	}
