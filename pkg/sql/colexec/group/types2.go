...
type container struct {
	...
	// legacyCanonicalHLLAddState keeps vector, JSON, and CHAR HLL_ADD_AGG on
	// the raw v2 hash domain while a pre-v88 peer may consume that state.
	legacyCanonicalHLLAddState bool
