...
func TestValueWindowExec_BasicOperations(t *testing.T) {
	...
	t.Run("LAG_basic", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_int64.ToType()})
	...
	t.Run("LEAD_basic", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLead, false, []types.Type{types.T_int64.ToType()})
		require.NoError(t, err)
		require.NotNil(t, exec)
		exec.Free()
	})
	...
	t.Run("FIRST_VALUE_basic", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfFirstValue, false, []types.Type{types.T_int64.ToType()})
		require.NoError(t, err)
		require.NotNil(t, exec)
		exec.Free()
	})
	...
	t.Run("LAST_VALUE_basic", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLastValue, false, []types.Type{types.T_int64.ToType()})
		require.NoError(t, err)
		require.NotNil(t, exec)
		exec.Free()
	})
	...
	t.Run("NTH_VALUE_basic", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfNthValue, false, []types.Type{types.T_int64.ToType()})
		require.NoError(t, err)
		require.NotNil(t, exec)
		exec.Free()
	})
	...
	t.Run("distinct_not_supported", func(t *testing.T) {
		_, err := makeValueWindowExec(mg, WinIdOfLag, true, []types.Type{types.T_int64.ToType()})
		require.Error(t, err)
	})
}
...
func TestValueWindowExec_VarlenTypes(t *testing.T) {
	...
	t.Run("LAG_varchar", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_varchar.ToType()})
		require.NoError(t, err)
...
func TestValueWindowExec_VariousTypes(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{tc.typ})
			require.NoError(t, err)
...
func TestValueWindowExec_LEADVariousTypes(t *testing.T) {
	...
	t.Run("LEAD_varchar", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLead, false, []types.Type{types.T_varchar.ToType()})
		require.NoError(t, err)
...
func TestValueWindowExec_EmptyFrameAllFunctions(t *testing.T) {
	...
	for _, f := range funcs {
		t.Run(f.name+"_empty_frame", func(t *testing.T) {
			exec, err := makeValueWindowExec(mg, f.id, false, []types.Type{types.T_int64.ToType()})
			require.NoError(t, err)
...
func TestValueWindowExec_MoreTypes(t *testing.T) {
	...
	t.Run("bit", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_bit.ToType()})
		require.NoError(t, err)
	...
	t.Run("time", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_time.ToType()})
		require.NoError(t, err)
	...
	t.Run("timestamp", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_timestamp.ToType()})
		require.NoError(t, err)
	...
	t.Run("decimal128", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_decimal128.ToType()})
		require.NoError(t, err)
	...
	t.Run("uuid", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_uuid.ToType()})
		require.NoError(t, err)
	...
	t.Run("enum", func(t *testing.T) {
		exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_enum.ToType()})
		require.NoError(t, err)
...
func TestValueWindowExec_RowidType(t *testing.T) {
	...
	exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_Rowid.ToType()})
	require.NoError(t, err)
...
func TestValueWindowExec_BlockidType(t *testing.T) {
	...
	exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_Blockid.ToType()})
	require.NoError(t, err)
...
func TestValueWindowExec_TSType(t *testing.T) {
	...
	exec, err := makeValueWindowExec(mg, WinIdOfLag, false, []types.Type{types.T_TS.ToType()})
	require.NoError(t, err)
