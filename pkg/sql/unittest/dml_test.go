...
func TestInsertAndSelectFunction(t *testing.T) {
	testCases := []testCase{
		...
		{sql: "insert into cha1 values ('1');", err: "Data too long for column 'a' at row 1"},
		{sql: "insert into cha2 values ('21');", err: "Data too long for column 'a' at row 1"},
		{sql: "insert into iis (i1) values (128);", err: "Out of range value for column 'i1' at row 1"},
		{sql: "insert into iis (i1) values (-129);", err: "Out of range value for column 'i1' at row 1"},
		{sql: "insert into iis (i1) values (1), (128);", err: "Out of range value for column 'i1' at row 2"},
		{sql: "insert into iis (i2) values (32768);", err: "Out of range value for column 'i2' at row 1"},
		{sql: "insert into iis (i2) values (-32769);", err: "Out of range value for column 'i2' at row 1"},
		{sql: "insert into iis (i3) values (2147483648);", err: "Out of range value for column 'i3' at row 1"},
		{sql: "insert into iis (i3) values (-2147483649);", err: "Out of range value for column 'i3' at row 1"},
		{sql: "insert into uus (u1) values (-1);", err: "constant value out of range"},
		{sql: "insert into uus (u1) values (256);", err: "Out of range value for column 'u1' at row 1"},
		{sql: "insert into uus (u2) values (65536);", err: "Out of range value for column 'u2' at row 1"},
		{sql: "insert into uus (u3) values (4294967296);", err: "Out of range value for column 'u3' at row 1"},
	}
	test(t, testCases)
}
