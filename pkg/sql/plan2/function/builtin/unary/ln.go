...
const negativeNumberError string = "Invalid argument for logarithm"

// ln function's evaluation for arguments: [int64]
func FdsLnInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// ln function's evaluation for arguments: [uint64]
func FdsLnUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// ln function's evaluation for arguments: [float64]
func FdsLnFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
