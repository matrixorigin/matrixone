...
func FdsAcosInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
func FdsAcosUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
func FdsAcosFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
