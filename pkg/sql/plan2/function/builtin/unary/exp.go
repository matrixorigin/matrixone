...
// exp function's evaluation for arguments: [int64]
func FdsExpInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// exp function's evaluation for arguments: [uint64]
func FdsExpUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// exp function's evaluation for arguments: [float64]
func FdsExpFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
