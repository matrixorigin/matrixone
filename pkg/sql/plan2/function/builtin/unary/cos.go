...
// cos function's evaluation for arguments: [int64]
func FdsCostInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// cos function's evaluation for arguments: [uint64]
func FdsCostUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// cos function's evaluation for arguments: [float64]
func FdsCostFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
