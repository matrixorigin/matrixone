...
// log function's evaluation for arguments: [int64]
func FdsLogInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// log function's evaluation for arguments: [uint64]
func FdsLogUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// log function's evaluation for arguments: [float64]
func FdsLogFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
