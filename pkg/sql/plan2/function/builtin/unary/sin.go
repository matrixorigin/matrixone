...
// sin function's evaluation for arguments: [int64]
func FdsSinInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// sin function's evaluation for arguments: [uint64]
func FdsSinUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// sin function's evaluation for arguments: [float64]
func FdsSinFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
