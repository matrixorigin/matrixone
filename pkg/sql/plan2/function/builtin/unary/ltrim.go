...
// ltrim function's evaluation for arguments: [varchar]
func FdsLTrimVarchar(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// ltrim function's evaluation for arguments: [char]
func FdsLTrimChar(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
	origVecCol := vs[0].Col.(*types.Bytes)
