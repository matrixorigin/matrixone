...
// dayofyear function's evaluation for arguments: [date]
func FdsDayOfYear(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
	inputVecCol := vs[0].Col.([]types.Date)
