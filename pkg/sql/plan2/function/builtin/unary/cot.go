...
// cot function's evaluation for arguments: [int64]
func FdsCotInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// cot function's evaluation for arguments: [uint64]
func FdsCotUInt64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
...
// cot function's evaluation for arguments: [float64]
func FdsCotFloat64(vs []*vector.Vector, proc *process.Process) (*vector.Vector, error) {
