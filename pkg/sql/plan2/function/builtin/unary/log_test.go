...
func TestLog(t *testing.T) {
	logIntAndFloat[int8](t, types.T_int8, 1, 0)
	logIntAndFloat[int16](t, types.T_int16, 2, 0.6931471805599453)
	logIntAndFloat[int32](t, types.T_int32, 3, 1.0986122886681096)
	logIntAndFloat[int64](t, types.T_int64, 4, 1.3862943611198906)

	logIntAndFloat[uint8](t, types.T_uint8, 5, 1.6094379124341003)
	logIntAndFloat[uint16](t, types.T_uint16, 6, 1.791759469228055)
	logIntAndFloat[uint32](t, types.T_uint32, 7, 1.9459101490553132)
	logIntAndFloat[uint64](t, types.T_uint64, 8, 2.0794415416798357)
...
func makeLogVectors[T constraints.Integer | constraints.Float](src T, srcScalar bool, t types.T) []*vector.Vector {
