...
// notifySharedHolderChange wakes only merge waiters that need to retry after
// one of several compatible Shared holders leaves. Ordinary lock waiters still
// wait for the normal admission condition, avoiding spurious wakeups.
